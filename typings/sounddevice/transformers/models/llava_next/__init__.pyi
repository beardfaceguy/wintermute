...
class LlavaNextProcessor(ProcessorMixin):
    ...
    tokenizer_class = ...
    def __init__(self, image_processor=..., tokenizer=..., patch_size=..., vision_feature_select_strategy=..., chat_template=..., image_token=..., num_additional_image_tokens=..., **kwargs) -> None:
        ...
    
    def __call__(self, images: ImageInput = ..., text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = ..., audio=..., videos=..., **kwargs: Unpack[LlavaNextProcessorKwargs]) -> BatchFeature:
        """
