...
def parse_cache_control_header(
    value: str | None, on_update: t.Callable[[ds.cache_control._CacheControl], None] | None = ...
) -> ds.RequestCacheControl: ...
@t.overload
def parse_cache_control_header(
    value: str | None,
    on_update: t.Callable[[ds.cache_control._CacheControl], None] | None = ...,
    cls: type[_TAnyCC] = ...,
) -> _TAnyCC: ...
def parse_cache_control_header(
    value: str | None,
    on_update: t.Callable[[ds.cache_control._CacheControl], None] | None = ...,
    cls: type[_TAnyCC] | None = ...,
) -> _TAnyCC:
...
def parse_csp_header(
    value: str | None, on_update: t.Callable[[ds.ContentSecurityPolicy], None] | None = ...
) -> ds.ContentSecurityPolicy: ...
@t.overload
def parse_csp_header(
    value: str | None,
    on_update: t.Callable[[ds.ContentSecurityPolicy], None] | None = ...,
    cls: type[_TAnyCSP] = ...,
) -> _TAnyCSP: ...
def parse_csp_header(
    value: str | None,
    on_update: t.Callable[[ds.ContentSecurityPolicy], None] | None = ...,
    cls: type[_TAnyCSP] | None = ...,
) -> _TAnyCSP:
...
def parse_set_header(
    value: str | None, on_update: t.Callable[[ds.HeaderSet], None] | None = ...
) -> ds.HeaderSet:
...
def parse_content_range_header(
    value: str | None, on_update: t.Callable[[ds.ContentRange], None] | None = ...
...
def remove_entity_headers(
    headers: ds.Headers | list[tuple[str, str]], allowed: t.Iterable[str] = ...
) -> None:
...
def parse_cookie(
    header: WSGIEnvironment | str | None, cls: type[ds.MultiDict[str, str]] | None = ...
