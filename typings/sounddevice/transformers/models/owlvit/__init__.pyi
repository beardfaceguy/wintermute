...
from ...processing_utils import ImagesKwargs, ProcessingKwargs, ProcessorMixin, Unpack, _validate_images_text_input_order
...
class OwlViTProcessor(ProcessorMixin):
    ...
    def __call__(self, images: Optional[ImageInput] = ..., text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = ..., *args, audio=..., videos=..., **kwargs: Unpack[OwlViTProcessorKwargs]) -> BatchFeature:
        """
    ...
    def post_process_grounded_object_detection(self, outputs: OwlViTObjectDetectionOutput, threshold: float = ..., target_sizes: Optional[Union[TensorType, List[Tuple]]] = ..., text_labels: Optional[List[List[str]]] = ...):
        """
    ...
    def post_process_image_guided_detection(self, outputs: OwlViTImageGuidedObjectDetectionOutput, threshold: float = ..., nms_threshold: float = ..., target_sizes: Optional[Union[TensorType, List[Tuple]]] = ...):
        """
