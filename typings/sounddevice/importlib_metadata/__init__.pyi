...
for more detail.
"""
__all__ = ['Distribution', 'DistributionFinder', 'PackageMetadata', 'PackageNotFoundError', 'SimplePath', 'distribution', 'distributions', 'entry_points', 'files', 'metadata', 'packages_distributions', 'requires', 'version']
...
class Distribution(metaclass=abc.ABCMeta):
    ...
    @classmethod
    def discover(cls, *, context: Optional[DistributionFinder.Context] = ..., **kwargs) -> Iterable[Distribution]:
