...
class UserDefinedObjectVariable(UserDefinedVariable):
    ...
    def method_setattr_standard(self, tx: InstructionTranslator, name, value): # -> ConstantVariable:
        ...
    ...
    def var_getattr(self, tx: InstructionTranslator, name): # -> VariableTracker | GetAttrVariable | UserDefinedClassVariable | UnspecializedNNModuleVariable | NNModuleVariable | SkipFunctionVariable | TorchInGraphFunctionVariable | UserFunctionVariable | UserMethodVariable | Any | CondHigherOrderVariable | WhileLoopHigherOrderVariable | MapHigherOrderVariable | ExecutorchCallDelegateHigherOrderVariable | OutDtypeHigherOrderVariable | WrapHigherOrderVariable | HintsWrapperHigherOrderVariable | FlexAttentionHigherOrderVariable | CheckpointHigherOrderVariable | ExportTracepointHigherOrderVariable | TraceWrappedHigherOrderOperatorVariable | StrictModeHigherOrderVariable | RunWithRNGStateHigherOrderVariable | AssociativeScanHigherOrderVariable | ScanHigherOrderVariable | CallTorchbindHigherOrderVariable | WrapWithSetGradEnabledHigherOrderVariable | WrapWithAutocastHigherOrderVariable | AutoFunctionalizeHigherOrderVariable | InvokeSubgraphHigherOrderVariable | BaseHOPVariable | CustomFunctionHigherOrderOperatorVariable | LazyVariableTracker:
        ...
...
class UserDefinedTupleVariable(UserDefinedObjectVariable):
    ...
    def set_underlying_tuple_vt(self, tuple_vt): # -> None:
        ...
    
    @staticmethod
    def create(value, tuple_vt, **kwargs): # -> UserDefinedTupleVariable:
        ...
