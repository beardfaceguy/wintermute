...
class AsyncDBChatStore(BaseModel):
    ...
    @abstractmethod
    async def count_messages(self, key: str, status: MessageStatus | None = ...) -> int:
        """Count messages for a key with the specified status (async)."""
        ...

    @abstractmethod
    async def add_message(
        self, key: str, message: ChatMessage, status: MessageStatus = ...
    ) -> None:
    ...
    async def add_messages(
        self, key: str, messages: list[ChatMessage], status: MessageStatus = ...
    ) -> None:
    ...
    @abstractmethod
    async def delete_message(self, key: str, idx: int) -> ChatMessage | None:
        """Delete a specific message by ID and return it (async)."""
        ...

    @abstractmethod
    async def delete_messages(self, key: str, status: MessageStatus | None = ...) -> None:
