...
class TimeSeriesSinusoidalPositionalEmbedding(nn.Embedding):
    ...
    @torch.no_grad()
    def forward(self, input_ids_shape: torch.Size, past_key_values_length: int = ..., position_ids: Optional[torch.Tensor] = ...) -> torch.Tensor:
...
class TimeSeriesTransformerAttention(nn.Module):
    ...
    def __init__(self, embed_dim: int, num_heads: int, dropout: float = ..., is_decoder: bool = ..., bias: bool = ..., is_causal: bool = ..., config: Optional[TimeSeriesTransformerConfig] = ..., layer_idx: Optional[int] = ...) -> None:
        ...
