...
## Summary
- 5403 nodes · 10007 edges · 346 communities (283 shown, 63 thin omitted)
...
## Communities (346 total, 63 thin omitted)
...
Cohesion: 0.05
Nodes (64): cs_CZ-jirka-medium, key, language, name, num_speakers, speaker_id_map, language, de_DE-pavoque-low (+56 more)
...
Cohesion: 0.07
Nodes (39): DistributedSampler, DataLoader, bool, device, float, int, Path, str (+31 more)
...
Cohesion: 0.06
Nodes (28): AnthropicBackend, HFLocalBackend, make_backend(), OpenAICompatBackend, str, Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID (+20 more)
...
Cohesion: 0.05
Nodes (25): ServeBackend, build_modelfile(), _ollama_create(), _ollama_rm(), OllamaBackend, ServingHandle, Build Modelfile text pointing at a GGUF file or importable model dir., build_serving_env() (+17 more)
...
Cohesion: 0.08
Nodes (26): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, en_GB-alan-medium, aliases (+18 more)
...
Cohesion: 0.09
Nodes (23): md5_digest, size_bytes, md5_digest, size_bytes, da_DK-talesyntese-medium, aliases, key, name (+15 more)
...
Cohesion: 0.12
Nodes (17): arith_stabilizer_train_added, base_train, source, train_total, val_total, arith_stabilizer_train_added, base_train, microstory_train_added (+9 more)
...
Cohesion: 0.10
Nodes (20): size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, el_GR-rapunzelina-low (+12 more)
...
Cohesion: 0.13
Nodes (18): Any, async_session(), mock_piper_voice(), Create a temporary audio file for testing., Sample text for testing., Sample phonemes for testing., Create an async database session bound to the temp test DB.      The module-leve, Mock PiperVoice for testing. (+10 more)
...
Cohesion: 0.11
Nodes (18): md5_digest, md5_digest, size_bytes, md5_digest, size_bytes, ca_ES-upc_ona-x_low, aliases, files (+10 more)
...
Cohesion: 0.17
Nodes (18): max_assistant_chars, oasst_max_fails_task, reject_role_markers, filters, allow_http, max_digit_ratio, max_user_chars, oasst_best_only (+10 more)
...
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, en_GB-alan-low, aliases, files (+9 more)
...
Cohesion: 0.15
Nodes (15): mcp_memory, default_db_url, port, rag, device, embed_model, live_data_dir, storage_dir (+7 more)
...
Cohesion: 0.25
Nodes (14): bool, str, Run pytest with the given pattern., run_specific_test(), run_unit_tests(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments. (+6 more)
...
Cohesion: 0.18
Nodes (11): seed, output_format, paths, train, val, base_train, source, story_train_added (+3 more)

### Community 150 - "Module Cluster 150"
Cohesion: 0.15
Nodes (12): arith_boosters_path, arith_train_added, base_train, base_train_path, base_val, base_val_path, intro_boosters_path, intro_train_added (+4 more)
...
Cohesion: 0.17
Nodes (12): counts, logic_train_used, oasst_train_used, openhermes_train_used, openhermes_val_used, slimorca_train_used, slimorca_val_used, train_total (+4 more)
...
- **Why does `AsyncMock` connect `Module Cluster 27` to `Module Cluster 33`, `Module Cluster 162`, `Module Cluster 37`, `DAG Query Retrieval`, `Module Cluster 80`, `Module Cluster 52`, `Model Training Data`, `Module Cluster 55`, `Module Cluster 62`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 41` to `Module Cluster 42`, `C++ JSON Library (json.hpp)`, `Module Cluster 46`, `talkingHead FastAPI Backend`, `PostgreSQL MCP Server`, `talkingHead WebSocket & TTS`, `Module Cluster 122`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `VoiceNotFoundError` connect `Module Cluster 70` to `TTS Voice Subsystem`?**
