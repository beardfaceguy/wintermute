...
from torch.testing._comparison import BooleanPair, NonePair, NumberPair, Pair, TensorLikePair, not_close_error_metas
...
if TEST_WITH_TV:
    ...
def disable_translation_validation_if_dynamic_shapes(fn): # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
    ...
...
def to_gpu(obj, type_map=...): # -> Tensor | list[Tensor | Any | list[Any] | tuple[Tensor | Any | list[Any] | tuple[Any, ...], ...]] | tuple[Tensor | Any | list[Any] | tuple[Any, ...], ...]:
    ...
...
class TestCase(expecttest.TestCase):
    ...
    def genSparseTensor(self, size, sparse_dim, nnz, is_uncoalesced, device, dtype): # -> tuple[Tensor, Tensor, Tensor]:
        ...
