...
class Idefics3Processor(ProcessorMixin):
    ...
    tokenizer_class = ...
    def __init__(self, image_processor, tokenizer=..., image_seq_len: int = ..., chat_template: Optional[str] = ..., **kwargs) -> None:
        ...
    
    def __call__(self, images: Union[ImageInput, List[ImageInput], List[List[ImageInput]]] = ..., text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = ..., audio=..., videos=..., image_seq_len: Optional[int] = ..., **kwargs: Unpack[Idefics3ProcessorKwargs]) -> BatchEncoding:
        """
