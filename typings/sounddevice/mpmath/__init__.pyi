...
class _mpf(mpnumeric):
    ...
    def mpf_convert_arg(
        cls, x, prec, rounding
    ):  # -> tuple[Literal[0], int | Any, Literal[-123], Literal[-1]] | tuple[Literal[0], int | Any, Literal[-456], Literal[-2]] | tuple[Literal[1], int | Any, Literal[-789], Literal[-3]] | tuple[Literal[0], int | Any, Literal[0], Literal[0]] | tuple[Any, Any, Any, Any]:
        ...
    @classmethod
    def mpf_convert_rhs(
        cls, x
    ):  # -> tuple[Literal[0], int | Any, Literal[-123], Literal[-1]] | tuple[Literal[0], int | Any, Literal[-456], Literal[-2]] | tuple[Literal[1], int | Any, Literal[-789], Literal[-3]] | tuple[Literal[0], int | Any, Literal[0], Literal[0]] | _NotImplementedType:
        ...
    @classmethod
    def mpf_convert_lhs(
        cls, x
