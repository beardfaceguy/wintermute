...
class DacResidualVectorQuantize(nn.Module):
    ...
    def forward(self, hidden_state, n_quantizers: Optional[int] = ...): # -> tuple[Any | Literal[0], Tensor, Tensor, Any | Literal[0], Any | Literal[0]]:
        """
...
class DacModel(DacPreTrainedModel):
    ...
    @auto_docstring
    def encode(self, input_values: torch.Tensor, n_quantizers: Optional[int] = ..., return_dict: Optional[bool] = ...): # -> tuple[Any, Any, Any, Any] | DacEncoderOutput:
        r"""
    ...
    @auto_docstring
    def forward(self, input_values: torch.Tensor, n_quantizers: Optional[int] = ..., return_dict: Optional[bool] = ...): # -> tuple[Any, Any, Any, Any, Any] | DacOutput:
        r"""
        input_values (`torch.Tensor` of shape `(batch_size, 1, time_steps)`):
