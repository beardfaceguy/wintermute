...
@deprecated(
    "`is_namedtuple` is deprecated, please use the python checks instead", category=FutureWarning
)
...
):  # -> Any | list[Any] | list[tuple[Any, ...]] | list[list[Any]] | list[dict[Any, Any]] | list[Any | tuple[()] | list[Any] | dict[Any, Any]] | None:
