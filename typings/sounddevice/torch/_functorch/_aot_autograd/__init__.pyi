...
class FunctionalizedRngRuntimeWrapper(CompilerWrapper):
    ...
    def pre_compile(
        self, flat_fn, flat_args, aot_config, *, fw_metadata
    ) -> tuple[Callable, list[Tensor], ViewAndMutationMeta]: ...
    def post_compile(
        self, compiled_fn, aot_config: AOTConfig, *, runtime_metadata: ViewAndMutationMeta
...
class FakifiedOutWrapper(CompilerWrapper):
    ...
    def pre_compile(
        self, fw_module, flat_args, aot_config, *, fw_metadata
    ) -> tuple[Callable, list[Tensor], ViewAndMutationMeta]: ...
    def set_fwd_output_strides(self, fwd_output_strides):  # -> None:
        ...
    def post_compile(
        self, compiled_fn, aot_config: AOTConfig, *, runtime_metadata: ViewAndMutationMeta
    ):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], list[Tensor] | Any]:
        ...
...
class AOTDispatchSubclassWrapper(CompilerWrapper):
    ...
    def pre_compile(
        ...
        *,
        fw_metadata: ViewAndMutationMeta,
    ):  # -> tuple[Any, Any, ViewAndMutationMeta]:
        ...
    def post_compile(
        self, compiled_fn, _aot_config: AOTConfig, *, runtime_metadata: ViewAndMutationMeta
    ):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], tuple[Any, ...]]:
        ...
...
class EffectTokensWrapper(CompilerWrapper):
    ...
    ):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any | None]:
        ...
...
class AOTDispatchAutograd:
    ...
    ):  # -> tuple[Any, list[Any]] | tuple[Tensor | FakeTensor, list[Tensor | FakeTensor]] | tuple[TensorWithFlatten, list[Any]]:
        ...
    @staticmethod
    def post_compile(
        compiled_fw_func,
