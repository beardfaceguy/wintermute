...
class TimesFmPositionalEmbedding(nn.Module):
    ...
    def forward(self, seq_length=..., position=...): # -> Tensor:
...
class TimesFmAttention(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, attention_mask: Optional[torch.Tensor] = ..., **kwargs: Unpack[FlashAttentionKwargs]) -> tuple[torch.Tensor, Optional[torch.Tensor]]:
        ...
...
class TimesFmDecoderLayer(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, attention_mask: torch.Tensor, paddings: torch.Tensor, output_attentions: bool = ...) -> tuple[Optional[torch.Tensor], torch.Tensor]:
        ...
...
class TimesFmModel(TimesFmPreTrainedModel):
    ...
    @can_return_tuple
    @auto_docstring
    def forward(self, past_values: torch.Tensor, past_values_padding: torch.LongTensor, freq: torch.Tensor, output_attentions: bool = ..., output_hidden_states: bool = ...) -> TimesFmOutput:
        r"""
...
class TimesFmModelForPrediction(TimesFmPreTrainedModel):
    ...
    @can_return_tuple
    @auto_docstring
    def forward(self, past_values: Sequence[torch.Tensor], freq: Optional[Sequence[Union[torch.Tensor, int]]] = ..., window_size: Optional[int] = ..., future_values: Optional[torch.Tensor] = ..., forecast_context_len: Optional[int] = ..., return_forecast_on_context: bool = ..., truncate_negative: bool = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ...) -> TimesFmOutputForPrediction:
        r"""
