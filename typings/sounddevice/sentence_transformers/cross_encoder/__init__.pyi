...
from transformers import AutoConfig, AutoModelForSequenceClassification, AutoTokenizer, PreTrainedModel, PreTrainedTokenizer, PretrainedConfig
...
from sentence_transformers.cross_encoder.util import cross_encoder_init_args_decorator, cross_encoder_predict_rank_args_decorator
...
class CrossEncoder(nn.Module, PushToHubMixin, FitMixin):
    ...
    def __init__(self, model_name_or_path: str, num_labels: int = ..., max_length: int = ..., activation_fn: Callable | None = ..., device: str | None = ..., cache_folder: str = ..., trust_remote_code: bool = ..., revision: str | None = ..., local_files_only: bool = ..., token: bool | str | None = ..., model_kwargs: dict = ..., tokenizer_kwargs: dict = ..., config_kwargs: dict = ..., model_card_data: CrossEncoderModelCardData | None = ..., backend: Literal["torch", "onnx", "openvino"] = ...) -> None:
        ...
    
    def set_activation_fn(self, activation_fn: Callable | None, set_default: bool = ...) -> None:
        ...
    ...
    @property
    @deprecated("The `default_activation_function` property was renamed and is now deprecated. " "Please use `activation_fn` instead.")
    ...
    @overload
    def predict(self, sentences: tuple[str, str] | list[str], batch_size: int = ..., show_progress_bar: bool | None = ..., activation_fn: Callable | None = ..., apply_softmax: bool | None = ..., convert_to_numpy: Literal[False] = ..., convert_to_tensor: Literal[False] = ...) -> torch.Tensor:
        ...
    
    @overload
    def predict(self, sentences: list[tuple[str, str]] | list[list[str]] | tuple[str, str] | list[str], batch_size: int = ..., show_progress_bar: bool | None = ..., activation_fn: Callable | None = ..., apply_softmax: bool | None = ..., convert_to_numpy: Literal[True] = ..., convert_to_tensor: Literal[False] = ...) -> np.ndarray:
        ...
    
    @overload
    def predict(self, sentences: list[tuple[str, str]] | list[list[str]] | tuple[str, str] | list[str], batch_size: int = ..., show_progress_bar: bool | None = ..., activation_fn: Callable | None = ..., apply_softmax: bool | None = ..., convert_to_numpy: bool = ..., convert_to_tensor: Literal[True] = ...) -> torch.Tensor:
        ...
    
    @overload
    def predict(self, sentences: list[tuple[str, str]] | list[list[str]], batch_size: int = ..., show_progress_bar: bool | None = ..., activation_fn: Callable | None = ..., apply_softmax: bool | None = ..., convert_to_numpy: Literal[False] = ..., convert_to_tensor: Literal[False] = ...) -> list[torch.Tensor]:
        ...
    
    @torch.inference_mode()
    @cross_encoder_predict_rank_args_decorator
    def predict(self, sentences: list[tuple[str, str]] | list[list[str]] | tuple[str, str] | list[str], batch_size: int = ..., show_progress_bar: bool | None = ..., activation_fn: Callable | None = ..., apply_softmax: bool | None = ..., convert_to_numpy: bool = ..., convert_to_tensor: bool = ...) -> list[torch.Tensor] | np.ndarray | torch.Tensor:
        """
    ...
    @cross_encoder_predict_rank_args_decorator
    def rank(self, query: str, documents: list[str], top_k: int | None = ..., return_documents: bool = ..., batch_size: int = ..., show_progress_bar: bool = ..., activation_fn: Callable | None = ..., apply_softmax=..., convert_to_numpy: bool = ..., convert_to_tensor: bool = ...) -> list[dict[Literal["corpus_id", "score", "text"], int | float | str]]:
        """
    ...
    def push_to_hub(self, repo_id: str, *, token: str | None = ..., private: bool | None = ..., safe_serialization: bool = ..., commit_message: str | None = ..., exist_ok: bool = ..., revision: str | None = ..., create_pr: bool = ..., tags: list[str] | None = ...) -> str:
        """
