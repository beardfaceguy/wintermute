...
def interpret_sents(
    inputs, grammar, semkey=..., trace=...
):  # -> list[list[tuple[Any, Any | FeatStructNonterminal]]]:
    """
...
def evaluate_sents(
    inputs, grammar, model, assignment, trace=...
):  # -> list[list[tuple[Any, Any | FeatStructNonterminal, Any]]]:
    """
