...
class Qwen2_5OmniProcessor(ProcessorMixin):
    ...
    tokenizer_class = ...
    valid_kwargs = ...
    def __init__(self, image_processor=..., video_processor=..., feature_extractor=..., tokenizer=..., chat_template=...) -> None:
        ...
    
    def __call__(self, text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = ..., images: ImageInput = ..., videos: VideoInput = ..., audio: AudioInput = ..., **kwargs: Unpack[Qwen2_5OmniProcessorKwargs]) -> BatchFeature:
        """
    ...
    def replace_multimodal_special_tokens(self, text, audio_lengths, image_grid_thw, video_grid_thw, video_second_per_grid, use_audio_in_video, position_id_per_seconds, seconds_per_chunk): # -> list[Any]:
        ...
