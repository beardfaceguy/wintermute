...
## Summary
- 5375 nodes · 9958 edges · 343 communities (281 shown, 62 thin omitted)
...
Cohesion: 0.05
Nodes (63): BaseBenchmark, _answer_matches(), Loose match: expected answer appears in response (case-insensitive)., _parse_answer(), MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac, subjects:         list of MMLU subject names, or None for all 57         max_per, _is_refusal(), BenchmarkResult (+55 more)

### Community 3 - "MCP Agent Runner"
Cohesion: 0.04
Nodes (83): __pyx_array___getattr__(), __pyx_array___getitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_10__getitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_12__setitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_8__getattr__(), __pyx_array___setitem__(), __Pyx_GetAttr(), __Pyx_GetAttr3() (+75 more)
...
Cohesion: 0.05
Nodes (65): ca_ES-upc_ona-medium, aliases, key, language, name, num_speakers, quality, speaker_id_map (+57 more)
...
Cohesion: 0.06
Nodes (59): CYTHON_INLINE, CYTHON_NCP_UNUSED, _copy_strided_to_strided(), PyThread_tss_alloc(), PyThread_tss_create(), PyThread_tss_delete(), PyThread_tss_free(), PyThread_tss_get() (+51 more)
...
Cohesion: 0.06
Nodes (30): AnthropicBackend, HFLocalBackend, make_backend(), OpenAICompatBackend, str, Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID (+22 more)
...
Cohesion: 0.04
Nodes (19): _parse(), _parse(), _extract_answer(), _normalize(), GSM8K — Grade School Math Dataset: openai/gsm8k Metric:  accuracy (exact final n, Pull the final numeric answer out of a model response., _parse(), str (+11 more)
...
Cohesion: 0.11
Nodes (44): CYTHON_UNUSED, assert_direct_dimensions(), __Pyx_AddTraceback(), __pyx_array_get_memview(), __pyx_array_new(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_2__getbuffer__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array___cinit__(), __Pyx_decode_c_string() (+36 more)
...
Cohesion: 0.10
Nodes (38): abs_py_ssize_t(), __pyx_f_11piper_train_4vits_15monotonic_align_4core_maximum_path_c(), __pyx_f_11piper_train_4vits_15monotonic_align_4core_maximum_path_each(), __pyx_fatalerror(), __pyx_fill_contig_strides_array(), __pyx_get_array_memory_extents(), __pyx_get_best_slice_order(), __Pyx_INC_MEMVIEW() (+30 more)
...
Cohesion: 0.06
Nodes (36): md5_digest, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, ca_ES-upc_ona-x_low (+28 more)

### Community 34 - "Module Cluster 34"
Cohesion: 0.09
Nodes (19): _build_test(), LiveCodeBench — Code Generation (Lite) Dataset: livecodebench/code_generation_li, Build a simple assertion block from public test cases., MBPP — Mostly Basic Python Problems Dataset: google-research-datasets/mbpp (sani, BenchmarkResult, GenerateConfig, ModelBackend, str (+11 more)
...
Cohesion: 0.07
Nodes (26): str, Shared fixtures for titanProject tests., Trivial tokenizer that maps each character to its ordinal., async_session(), dummy_tokenizer(), DummyTokenizer, mock_piper_voice(), Create a small on-disk token cache with 3 shards for testing. (+18 more)
...
Cohesion: 0.07
Nodes (29): aliases, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, en_GB-aru-medium (+21 more)
...
Cohesion: 0.08
Nodes (27): AbstractEventLoop, bytes, MagicMock, str, TestClient, Pytest configuration and fixtures for talkingHead backend tests., client(), event_loop() (+19 more)
...
Cohesion: 0.09
Nodes (22): account_id, ami, ckpt_s3, code_bundle_s3, ecr_image, gpu_memory_utilization, hf_export_s3, instance_profile (+14 more)
...
Cohesion: 0.13
Nodes (20): __pyx_align_pointer(), __Pyx__ArgTypeTest(), __pyx_array___cinit__(), __Pyx_InBases(), __Pyx_IsSubtype(), __pyx_memoryview___cinit__(), __pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview___cinit__(), __pyx_MemviewEnum___init__() (+12 more)
...
Cohesion: 0.13
Nodes (16): max_user_chars, oasst_max_fails_task, oasst_max_spam, oasst_min_quality, reject_role_markers, paths, seed, filters (+8 more)
...
Cohesion: 0.18
Nodes (18): __pyx_array_getbuffer(), __Pyx_BufFmt_Init(), __pyx_check_strides(), __pyx_check_suboffsets(), __Pyx_GetBuffer(), __pyx_memoryview_check(), __pyx_memoryview_getbuffer(), __pyx_memoryview_new() (+10 more)
...
Cohesion: 0.11
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-thorsten-low, aliases (+9 more)
...
Cohesion: 0.15
Nodes (13): int, add_timing_signal_1d(), cat_timing_signal_1d(), generate_path(), get_timing_signal_1d(), init_weights(), rand_gumbel(), rand_gumbel_like() (+5 more)
...
Cohesion: 0.17
Nodes (8): Dataset, FlatWindows, load_tinystories_ids(), main(), Stage-A training: recall-aware, long-context Titan (local, gaming-pc).  Blends T, Contiguous LM windows over a flat token stream (TinyStories)., One recall doc per window, padded to seq_len. COMPLETION-ONLY loss:     supervis, RecallWindows
...
Cohesion: 0.17
Nodes (15): __Pyx_CLineForTraceback(), __Pyx_ErrFetchInState(), __Pyx_ErrRestoreInState(), __Pyx__ExceptionReset(), __Pyx__ExceptionSave(), __Pyx__ExceptionSwap(), __Pyx_inner_PyErr_GivenExceptionMatches2(), __Pyx_PyErr_ExceptionMatchesInState() (+7 more)

### Community 130 - "Module Cluster 130"
Cohesion: 0.25
Nodes (14): bool, int, str, main(), Run pytest with the given pattern., run_specific_test(), run_unit_tests(), Run integration tests only. (+6 more)
...
Cohesion: 0.18
Nodes (12): arith_stabilizer_train_added, base_train, self_intro_train_added, source, train_total, val_copied_from, base_train, microstory_train_added (+4 more)
...
Cohesion: 0.15
Nodes (12): base_val, story_train_added, arith_stabilizer_train_added, base_train, broader_story_train_added, source, train_total, val_copied_from (+4 more)
...
Cohesion: 0.17
Nodes (11): base_train_path, base_val_path, arith_boosters_path, arith_train_added, base_train, intro_boosters_path, intro_train_added, source (+3 more)

### Community 160 - "Module Cluster 160"
Cohesion: 0.17
Nodes (12): counts, logic_train_used, oasst_val_used, openhermes_val_used, slimorca_train_used, val_total, logic_val_used, oasst_train_used (+4 more)
...
Cohesion: 0.20
Nodes (11): codereview, host, paths, port, scheme, batch, health, review (+3 more)
...
Cohesion: 0.22
Nodes (9): md5_digest, size_bytes, md5_digest, size_bytes, size_bytes, files, ca/ca_ES/upc_ona/medium/ca_ES-upc_ona-medium.onnx, ca/ca_ES/upc_ona/medium/ca_ES-upc_ona-medium.onnx.json (+1 more)
...
Cohesion: 0.43
Nodes (6): main(), make_example(), make_example_split(), _make_names(), Synthetic recall TRAINING data generator for Stage A.  Emits self-contained need, Return (prefix, answer). prefix ends '...The secret code for <TARGET> is';     a
...
- **Why does `PiperVoice` connect `Module Cluster 77` to `Module Cluster 36`, `Module Cluster 71`, `Module Cluster 136`, `Module Cluster 55`, `Module Cluster 123`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `AsyncMock` connect `talkingHead WebSocket & TTS` to `Module Cluster 64`, `Cython C Extensions`, `Module Cluster 39`, `Module Cluster 82`, `Model Training Data`, `Module Cluster 55`, `Module Cluster 56`, `Module Cluster 157`, `Module Cluster 30`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 45` to `Piper TTS Tests`, `Module Cluster 46`, `SFT Fine-Tuning Pipeline`, `Module Cluster 49`, `PostgreSQL MCP Server`, `Module Cluster 116`, `SQL Agent & Test Harness`?**
