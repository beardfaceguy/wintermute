...
def reduce_array_memmap_backward(
    a,
):  # -> tuple[Callable[..., memmap[Any, Any] | NDArray[Any]], tuple[str | None, Any, str, int | Any, str, Any, Any | None, Any | None, bool]] | tuple[Callable[..., Any], tuple[bytes]]:
...
class ArrayMemmapForwardReducer:
    ...
    def __reduce__(
        self,
    ):  # -> tuple[type[ArrayMemmapForwardReducer], tuple[Any, None, Any, Any], dict[str, Any]]:
        ...
    def __call__(
        self, a
    ):  # -> tuple[Callable[..., memmap[Any, Any] | NDArray[Any]], tuple[str | None, Any, str, int | Any, str, Any, Any | None, Any | None, bool]] | tuple[Callable[..., Any], tuple[str, Any, Any]] | tuple[Callable[..., Any], tuple[bytes]]:
        ...
...
def get_memmapping_reducers(
    ...
    unlink_on_gc_collect=...,
    **kwargs,
):  # -> tuple[dict[Any, Any] | Any, dict[Any, Any] | Any]:
