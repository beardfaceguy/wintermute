...
class MoonshineConfig(PretrainedConfig):
    ...
    attribute_map = ...
    def __init__(self, vocab_size=..., hidden_size=..., intermediate_size=..., encoder_num_hidden_layers=..., decoder_num_hidden_layers=..., encoder_num_attention_heads=..., decoder_num_attention_heads=..., encoder_num_key_value_heads=..., decoder_num_key_value_heads=..., pad_head_dim_to_multiple_of=..., encoder_hidden_act=..., decoder_hidden_act=..., max_position_embeddings=..., initializer_range=..., decoder_start_token_id=..., use_cache=..., rope_theta=..., rope_scaling=..., partial_rotary_factor=..., is_encoder_decoder=..., attention_bias=..., attention_dropout=..., bos_token_id=..., eos_token_id=..., **kwargs) -> None:
        ...
...
class MoonshineAttention(GlmAttention):
    def __init__(self, config: MoonshineConfig, layer_idx: int, is_causal: bool, num_attention_heads: int, num_key_value_heads: int) -> None:
        ...
    
    def forward(self, hidden_states: torch.Tensor, position_embeddings: Optional[Tuple[torch.Tensor, torch.Tensor]] = ..., attention_mask: Optional[torch.Tensor] = ..., past_key_value: Optional[Cache] = ..., cache_position: Optional[torch.LongTensor] = ..., key_value_states: Optional[torch.Tensor] = ..., **kwargs: Unpack[FlashAttentionKwargs]) -> Tuple[torch.Tensor, Optional[torch.Tensor], Optional[Tuple[torch.Tensor]]]:
        ...
...
class MoonshineDecoderLayer(GradientCheckpointingLayer):
    ...
    def forward(self, hidden_states: torch.Tensor, attention_mask: Optional[torch.Tensor] = ..., encoder_hidden_states: Optional[torch.Tensor] = ..., encoder_attention_mask: Optional[torch.Tensor] = ..., position_ids: Optional[torch.LongTensor] = ..., encoder_position_ids: Optional[torch.LongTensor] = ..., past_key_value: Optional[Cache] = ..., output_attentions: Optional[bool] = ..., use_cache: Optional[bool] = ..., cache_position: Optional[torch.LongTensor] = ..., position_embeddings: Optional[Tuple[torch.Tensor, torch.Tensor]] = ..., encoder_position_embeddings: Optional[Tuple[torch.Tensor, torch.Tensor]] = ..., **kwargs) -> Tuple[torch.FloatTensor, Optional[Tuple[torch.FloatTensor, torch.FloatTensor]]]:
        ...
...
class MoonshineEncoder(MoonshinePreTrainedModel):
    ...
    @can_return_tuple
    def forward(self, input_values: Optional[torch.FloatTensor] = ..., attention_mask: Optional[torch.Tensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., **flash_attn_kwargs: Unpack[FlashAttentionKwargs]) -> BaseModelOutputWithPast:
        r"""
        Args:
...
class MoonshineModel(WhisperModel):
    @can_return_tuple
    @auto_docstring
    def forward(self, input_values: Optional[torch.FloatTensor] = ..., attention_mask: Optional[torch.LongTensor] = ..., decoder_input_ids: Optional[torch.LongTensor] = ..., decoder_attention_mask: Optional[torch.LongTensor] = ..., encoder_outputs: Optional[Tuple[Tuple[torch.FloatTensor]]] = ..., past_key_values: Optional[Union[EncoderDecoderCache, Tuple[torch.FloatTensor]]] = ..., decoder_inputs_embeds: Optional[Tuple[torch.FloatTensor]] = ..., decoder_position_ids: Optional[Tuple[torch.LongTensor]] = ..., use_cache: Optional[bool] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., cache_position: Optional[torch.LongTensor] = ...) -> Seq2SeqModelOutput:
        r"""
        input_values (`torch.FloatTensor` of shape `(batch_size, audio_length)`):
            Float values of the raw speech waveform. Raw speech waveform can be
            obtained by loading a `.flac` or `.wav` audio file into an array of type `List[float]` or a
...
class MoonshineForConditionalGeneration(MoonshinePreTrainedModel, GenerationMixin):
    ...
    @can_return_tuple
    @auto_docstring
    def forward(self, input_values: Optional[torch.FloatTensor] = ..., attention_mask: Optional[torch.LongTensor] = ..., decoder_input_ids: Optional[torch.LongTensor] = ..., decoder_attention_mask: Optional[torch.LongTensor] = ..., encoder_outputs: Optional[Tuple[Tuple[torch.FloatTensor]]] = ..., past_key_values: Optional[Union[EncoderDecoderCache, Tuple[torch.FloatTensor]]] = ..., decoder_inputs_embeds: Optional[Tuple[torch.FloatTensor]] = ..., decoder_position_ids: Optional[Tuple[torch.LongTensor]] = ..., use_cache: Optional[bool] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., cache_position: Optional[torch.LongTensor] = ..., labels: Optional[torch.LongTensor] = ...) -> Seq2SeqLMOutput:
        r"""
        input_values (`torch.FloatTensor` of shape `(batch_size, audio_length)`):
            Float values of the raw speech waveform. Raw speech waveform can be
            obtained by loading a `.flac` or `.wav` audio file into an array of type `List[float]` or a
