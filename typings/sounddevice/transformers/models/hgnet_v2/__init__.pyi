...
class HGNetV2Config(BackboneConfigMixin, PretrainedConfig):
    ...
    """
    model_type = ...
    def __init__(self, num_channels=..., embedding_size=..., depths=..., hidden_sizes=..., hidden_act=..., out_features=..., out_indices=..., stem_channels=..., stage_in_channels=..., stage_mid_channels=..., stage_out_channels=..., stage_num_blocks=..., stage_downsample=..., stage_light_block=..., stage_kernel_size=..., stage_numb_of_layers=..., use_learnable_affine_block=..., initializer_range=..., **kwargs) -> None:
        ...
...
class HGNetV2ConvLayer(RTDetrResNetConvLayer):
    def __init__(self, in_channels: int, out_channels: int, kernel_size: int, stride: int = ..., groups: int = ..., activation: str = ..., use_learnable_affine_block: bool = ...) -> None:
        ...
...
class HGNetV2ConvLayerLight(nn.Module):
    def __init__(self, in_channels: int, out_channels: int, kernel_size: int, use_learnable_affine_block: bool = ...) -> None:
        ...
...
class HGNetV2BasicLayer(nn.Module):
    def __init__(self, in_channels: int, middle_channels: int, out_channels: int, layer_num: int, kernel_size: int = ..., residual: bool = ..., light_block: bool = ..., drop_path: float = ..., use_learnable_affine_block: bool = ...) -> None:
        ...
