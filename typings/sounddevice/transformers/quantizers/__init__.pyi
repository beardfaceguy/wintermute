...
class HfQuantizer(ABC):
    ...
    @staticmethod
    def get_modules_to_not_convert(model: PreTrainedModel, skip_modules: Optional[List[str]] = ..., keep_in_fp32_modules: Optional[List[str]] = ..., add_default_skips: bool = ...): # -> list[Any]:
        ...
