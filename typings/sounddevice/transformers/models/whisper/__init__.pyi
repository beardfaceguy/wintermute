...
class WhisperTokenizerFast(PreTrainedTokenizerFast):
    ...
    def decode(self, token_ids, skip_special_tokens: bool = ..., clean_up_tokenization_spaces: Optional[bool] = ..., output_offsets: bool = ..., time_precision: float = ..., decode_with_timestamps: bool = ..., normalize: bool = ..., basic_normalize: bool = ..., remove_diacritics: bool = ..., **kwargs) -> str:
        """
    ...
    def set_prefix_tokens(self, language: Optional[str] = ..., task: Optional[str] = ..., predict_timestamps: Optional[bool] = ...): # -> None:
        """
