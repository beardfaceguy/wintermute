...
## Corpus Check
- Large corpus: 711 files · ~1,873,312 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder.

## Summary
- 5493 nodes · 10014 edges · 369 communities (304 shown, 65 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1102 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_Piper TTS Phoneme Data|Piper TTS Phoneme Data]]
- [[_COMMUNITY_Piper TTS Character Mappings|Piper TTS Character Mappings]]
- [[_COMMUNITY_GPT-2 Pretraining Pipeline|GPT-2 Pretraining Pipeline]]
- [[_COMMUNITY_MCP Agent Runner|MCP Agent Runner]]
- [[_COMMUNITY_HuggingFace Model Utilities|HuggingFace Model Utilities]]
- [[_COMMUNITY_DAG Query Retrieval|DAG Query Retrieval]]
- [[_COMMUNITY_Cython C Extensions|Cython C Extensions]]
- [[_COMMUNITY_Freud Memory Auditor|Freud Memory Auditor]]
- [[_COMMUNITY_Cython Core Runtime|Cython Core Runtime]]
- [[_COMMUNITY_Piper TTS Tests|Piper TTS Tests]]
- [[_COMMUNITY_Eval Harness Tests|Eval Harness Tests]]
- [[_COMMUNITY_C++ JSON Library (json.hpp)|C++ JSON Library (json.hpp)]]
- [[_COMMUNITY_RAG Query Layer|RAG Query Layer]]
- [[_COMMUNITY_JSON C++ Type System|JSON C++ Type System]]
- [[_COMMUNITY_Intelligence Benchmarks|Intelligence Benchmarks]]
- [[_COMMUNITY_Cython Threading|Cython Threading]]
- [[_COMMUNITY_MCP Memory Server|MCP Memory Server]]
- [[_COMMUNITY_SFT Fine-Tuning Pipeline|SFT Fine-Tuning Pipeline]]
- [[_COMMUNITY_talkingHead FastAPI Backend|talkingHead FastAPI Backend]]
- [[_COMMUNITY_PostgreSQL MCP Server|PostgreSQL MCP Server]]
- [[_COMMUNITY_SQL Agent & Test Harness|SQL Agent & Test Harness]]
- [[_COMMUNITY_Model Training Data|Model Training Data]]
- [[_COMMUNITY_TTS Voice Subsystem|TTS Voice Subsystem]]
- [[_COMMUNITY_Shared Config & Utilities|Shared Config & Utilities]]
- [[_COMMUNITY_Eval Benchmark Adapters|Eval Benchmark Adapters]]
- [[_COMMUNITY_talkingHead WebSocket & TTS|talkingHead WebSocket & TTS]]
...
- [[_COMMUNITY_Module Cluster 316|Module Cluster 316]]
...
- [[_COMMUNITY_Module Cluster 320|Module Cluster 320]]
...
- [[_COMMUNITY_Module Cluster 362|Module Cluster 362]]
- [[_COMMUNITY_Module Cluster 363|Module Cluster 363]]
- [[_COMMUNITY_Module Cluster 364|Module Cluster 364]]
- [[_COMMUNITY_Module Cluster 365|Module Cluster 365]]
- [[_COMMUNITY_Module Cluster 366|Module Cluster 366]]
- [[_COMMUNITY_Module Cluster 367|Module Cluster 367]]
- [[_COMMUNITY_Module Cluster 368|Module Cluster 368]]

## God Nodes (most connected - your core abstractions)
1. `PyObject` - 203 edges
2. `phoneme_id_map` - 128 edges
3. `BenchmarkResult` - 123 edges
4. `BaseBenchmark` - 116 edges
5. `phoneme_id_map` - 115 edges
6. `CYTHON_INLINE` - 76 edges
7. `__Pyx_AddTraceback()` - 74 edges
8. `ModelConfig` - 72 edges
9. `AsyncMock` - 64 edges
10. `DataLoader` - 42 edges

## Surprising Connections (you probably didn't know these)
- `bool` --uses--> `PiperVoice`  [INFERRED]
  talkingHead/backend/app/api/tts.py → thVoice/piper/src/python_run/piper/voice.py
- `str` --uses--> `PiperVoice`  [INFERRED]
  talkingHead/backend/app/api/tts.py → thVoice/piper/src/python_run/piper/voice.py
- `Response` --uses--> `PiperVoice`  [INFERRED]
  talkingHead/backend/app/api/tts.py → thVoice/piper/src/python_run/piper/voice.py
- `Detached Training Probe Config` --configures--> `AWS EC2 Training Infrastructure`  [INFERRED]
  config/detached_training_probe.json → model_training/titanProject/todo.md
- `Temporal Agentic System: Production Distributed Agents` --conceptually_related_to--> `MCP Tool Server Pattern (FastMCP/Flask/FastAPI)`  [INFERRED]
  .cursor/docs/online_docs/temporal_agentic_system.md → mcp_servers/mcp_postgres/server.py

## Communities (369 total, 65 thin omitted)

### Community 0 - "Piper TTS Phoneme Data"
Cohesion: 0.02
Nodes (128): phoneme_id_map, 0, 1, 2, 3, 4, 5, 6 (+120 more)

### Community 1 - "Piper TTS Character Mappings"
Cohesion: 0.02
Nodes (115): phoneme_id_map, a, b, c, d, e, f, h (+107 more)

### Community 2 - "GPT-2 Pretraining Pipeline"
Cohesion: 0.04
Nodes (74): _parse(), ARC Challenge — AI2 Reasoning Challenge (hard subset) Dataset: allenai/ARC (ARC-, BaseBenchmark, _parse(), GPQA Diamond — Graduate-level Google-Proof Q&A Dataset: google-deepmind/gpqa (gp, _build_test(), Build a simple assertion block from public test cases., _answer_matches() (+66 more)

### Community 3 - "MCP Agent Runner"
Cohesion: 0.04
Nodes (71): AgentResult, AgentRunner, _mcp_tool_to_openai(), Any, float, int, str, Lightweight agent runner that connects to MCP servers and dispatches tool calls (+63 more)
...
Cohesion: 0.07
Nodes (46): AuditFinding, AuditReport, check_contradictions_ann(), check_near_duplicates_ann(), FreudAuditor, main(), _neighbors_query(), _print_report() (+38 more)

### Community 8 - "Cython Core Runtime"
Cohesion: 0.06
Nodes (50): CYTHON_SMALL_CODE, PyInit_core(), __pyx_array___dealloc__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_4__dealloc__(), __pyx_bisect_code_objects(), __Pyx_BufFmt_CheckString(), __Pyx_BufFmt_DescribeTypeChar(), __Pyx_BufFmt_ExpectNumber() (+42 more)

### Community 9 - "Piper TTS Tests"
Cohesion: 0.05
Nodes (34): Unit tests for Piper text-to-speech functionality., Test streaming synthesis with multiple sentences., Test synthesis to WAV file., Test PiperVoice configuration attributes., Test cases for Piper text-to-speech voice., Test synthesis with different parameters., Test PiperVoice initialization., Test error handling with invalid text. (+26 more)

### Community 10 - "Eval Harness Tests"
Cohesion: 0.06
Nodes (26): ABC, Base class all benchmark adapters inherit from., MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac, SWE-bench Verified Dataset: princeton-nlp/SWE-bench_Verified Metric:  resolve_ra, AnthropicBackend, GenerateConfig, HFLocalBackend, make_backend() (+18 more)

### Community 11 - "C++ JSON Library (json.hpp)"
Cohesion: 0.11
Nodes (56): byte_container_with_subtype, const_iterator, const_reference, at(), begin(), cbegin(), cend(), compares_unordered() (+48 more)
...
Cohesion: 0.06
Nodes (47): Allocator, array_t, binary_t, boolean_t, compares_unordered, adl_serializer, binary(), clear() (+39 more)

### Community 14 - "Intelligence Benchmarks"
Cohesion: 0.06
Nodes (53): language, ca_ES-upc_ona-x_low, aliases, key, language, name, num_speakers, quality (+45 more)

### Community 15 - "Cython Threading"
Cohesion: 0.06
Nodes (53): CYTHON_INLINE, PyThread_tss_alloc(), PyThread_tss_create(), PyThread_tss_delete(), PyThread_tss_free(), PyThread_tss_get(), PyThread_tss_is_created(), PyThread_tss_set() (+45 more)

### Community 16 - "MCP Memory Server"
Cohesion: 0.07
Nodes (28): bool, Path, str, Module, Tests for model.py: model factory, forward pass shapes, config validation., ModelConfig dataclass defaults and construction., HFGPT2LM forward pass shape checks., Sanity check that model parameter counts scale as expected. (+20 more)

### Community 17 - "SFT Fine-Tuning Pipeline"
Cohesion: 0.08
Nodes (52): abs_py_ssize_t(), __Pyx_AddTraceback(), __pyx_array_new(), __Pyx_CLineForTraceback(), __Pyx_decode_c_string(), __Pyx_div_long(), __Pyx_ErrFetchInState(), __Pyx_ErrRestoreInState() (+44 more)

### Community 18 - "talkingHead FastAPI Backend"
Cohesion: 0.07
Nodes (31): AsyncMock, WebSocket, Any, MagicMock, str, _make_mock_ws(), Extended tests for chat WebSocket endpoint — covers DAG deep search integration,, Verify the assistant-message-complete sentinel is sent after each turn.      The (+23 more)

### Community 19 - "PostgreSQL MCP Server"
Cohesion: 0.05
Nodes (48): check_near_duplicates(), _cosine_sim(), _is_pair_owner(), Any, Detect near-duplicate entries via embedding cosine similarity.      O(n^2) but f, Return True iff `entry` should own the pair (entry, neighbor) finding.      Olde, Tests for agents/freud.py — pure-logic audit checks and data structures.  Only t, Opposite direction vectors should have similarity -1.0. (+40 more)

### Community 20 - "SQL Agent & Test Harness"
Cohesion: 0.05
Nodes (43): FFmpeg System Dependency, talkingHead Backend run.sh, Database Operations Tests, LLM Chat Processor Tests, Memory Leak Regression Tests, TalkingHead Backend Test Suite, Voice Chat API Tests, WebSocket Tests (+35 more)
...
Cohesion: 0.09
Nodes (33): back(), boolean(), dump_float(), get_number_float(), get_token_string(), handle_value(), json_sax_dom_callback_parser, allow_exceptions (+25 more)

### Community 23 - "Shared Config & Utilities"
Cohesion: 0.05
Nodes (15): _extract_answer(), _normalize(), GSM8K — Grade School Math Dataset: openai/gsm8k Metric:  accuracy (exact final n, Pull the final numeric answer out of a model response., BenchmarkResult, GenerateConfig, ModelBackend, str (+7 more)
...
Cohesion: 0.15
Nodes (17): Batch, DataLoader, load_state_dict(), main(), bool, float, int, Path (+9 more)
...
Cohesion: 0.09
Nodes (28): bool, str, WebSocket, object, str, Wave_write, _make_mock_ws(), Lifecycle / resource-leak tests inspired by daimonos memory-leak prevention rule (+20 more)
...
Cohesion: 0.11
Nodes (18): ChatProcessor, MagicMock, _async_iter(), Unit tests for LLM chat processor., Test streaming response with JSON parse error., Helper to turn a list into an async iterator for mocking aiter_lines()., Test streaming response with missing delta/content field., Test that empty lines and control lines are skipped. (+10 more)
...
Cohesion: 0.13
Nodes (25): bool, int, Path, str, TestIsMain, _hf_tokenizer_to_adapter(), main(), Wrap a raw HuggingFace tokenizer into a TokenizerAdapter for the SFT data pipeli (+17 more)

### Community 41 - "Module Cluster 41"
Cohesion: 0.10
Nodes (31): CYTHON_NCP_UNUSED, _copy_strided_to_strided(), __pyx_array___cinit__(), __pyx_array___len__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_6__len__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array___cinit__(), __Pyx_div_Py_ssize_t(), __pyx_fill_contig_strides_array() (+23 more)
...
Cohesion: 0.11
Nodes (14): HumanEval Dataset: openai_humaneval Metric:  pass@1 (fraction of problems where, LiveCodeBench — Code Generation (Lite) Dataset: livecodebench/code_generation_li, MBPP — Mostly Basic Python Problems Dataset: google-research-datasets/mbpp (sani, ExecResult, extract_code_block(), int, str, Code execution for coding benchmarks.  Runs generated code in a subprocess with (+6 more)

### Community 44 - "Module Cluster 44"
Cohesion: 0.10
Nodes (21): format_memory_context(), Store a conversation exchange in mcp-memory as a 'live' entry.      Tags the ent, Format retrieved memories into a prompt-injectable context block.      Returns a, Semantic search over mcp-memory for context relevant to the query.      Args:, search_relevant_memories(), store_conversation(), Any, bool (+13 more)

### Community 45 - "Module Cluster 45"
Cohesion: 0.12
Nodes (27): Snapshot, int, _net_allocation_bytes_under(), _net_app_allocation_bytes(), _net_memory_pkg_allocation_bytes(), Stress + allocation regression tests for leaks in talkingHead/backend code paths, Broadcast that always drops failing sockets must not accumulate app allocations., Repeated STT routing with mocks should not accumulate under ``voice_chat.py``. (+19 more)

### Community 46 - "Module Cluster 46"
Cohesion: 0.28
Nodes (28): ARCChallengeBenchmark, GPQADiamondBenchmark, GSM8KBenchmark, HellaSwagBenchmark, HumanEvalBenchmark, IFEvalBenchmark, LiveCodeBenchmark, LoCoMoBenchmark (+20 more)

### Community 47 - "Module Cluster 47"
Cohesion: 0.13
Nodes (28): _minimal_config(), Path, Tests for shared/config_loader.py — config loading, caching, env-var substitutio, URL should be scheme://host:port/path., ${VLLM_HOST} in host field should be replaced by the env var value., RuntimeError when the referenced env var is unset., The second element of the tuple should be the model name., Should return the 'aws' dict nested under 'vllm'. (+20 more)

### Community 48 - "Module Cluster 48"
Cohesion: 0.07
Nodes (27): aws, ec2_describe_instance_query, profile, region, default_probe_check_pid, default_layout, default_probe_check_pid, default_work_dir (+19 more)

### Community 49 - "Module Cluster 49"
Cohesion: 0.11
Nodes (28): BasicJsonType, CompatibleType, basic_json(), decode(), flatten(), from_json(), get_impl(), json_sax_dom_parser() (+20 more)

### Community 50 - "Module Cluster 50"
Cohesion: 0.07
Nodes (27): counts, logic_train_used, logic_val_used, oasst_train_used, oasst_val_used, openhermes_train_used, openhermes_val_used, slimorca_train_used (+19 more)
...
Cohesion: 0.08
Nodes (27): AbstractEventLoop, Any, bytes, MagicMock, str, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests. (+19 more)

### Community 53 - "Module Cluster 53"
Cohesion: 0.10
Nodes (15): DistributedSampler, DataLoader, Tests for training utilities: LR schedules, path resolution, hashing, checkpoint, TokenizerAdapter encode/decode contract., S3 tokenizer downloads must not collide when only the basename matches., Two S3 URIs with the same filename but different prefixes must         download, Path resolution logic., TestGetTokenizerS3PathCollision (+7 more)
...
Cohesion: 0.07
Nodes (26): base_train, base_train_path, base_val, base_val_path, filters, max_input_chars, max_instruction_chars, max_response_chars (+18 more)
...
Cohesion: 0.13
Nodes (22): main(), main(), denoise(), inverse(), istft(), main(), Compute and return the STFT of the supplied time domain signal x.     Args:, Invert a STFT into a time domain signal.     Args:         X (2-dim Numpy array) (+14 more)

### Community 59 - "Module Cluster 59"
Cohesion: 0.08
Nodes (5): _MockColumn, _MockExpr, str, Lightweight stand-in for a SQLAlchemy InstrumentedAttribute.      Supports the o, Expression-like stand-in for ``column.cosine_distance(vec).label('d')``.      Co

### Community 60 - "Module Cluster 60"
Cohesion: 0.19
Nodes (26): char_int_type, accept(), add(), array(), from_bjdata(), from_bson(), from_cbor(), from_msgpack() (+18 more)
...
Cohesion: 0.08
Nodes (24): dag_retrieval, llm_timeout, max_tokens, temperature, mcp_memory, default_db_url, embed_model, port (+16 more)
...
Cohesion: 0.16
Nodes (20): _default_db_url(), str, get_rag_config(), load_agents_config(), _load_config(), load_inference_config(), load_mcp_memory_config(), load_mcp_servers_config() (+12 more)
...
Cohesion: 0.10
Nodes (23): mock_piper_voice(), Create a temporary audio file for testing., Sample text for testing., Sample phonemes for testing., Sample phoneme IDs for testing., Create sample audio data for testing., Mock Whisper model for testing., Mock PiperVoice for testing. (+15 more)

### Community 70 - "Module Cluster 70"
Cohesion: 0.16
Nodes (9): str, Cache key generation and helper functions., TestCacheUtilities, build_cache_key(), get_cache_root(), get_shard_size_tokens(), get_source_fingerprint(), _iter_lines() (+1 more)

### Community 71 - "Module Cluster 71"
Cohesion: 0.16
Nodes (22): _default_postgres_url(), _get_conn(), _is_read_only(), Wintermute mcp-postgres — MCP server for read-only SQL access to PostgreSQL.  Pr, List all user-created tables in the database.      Returns:         List of tabl, Describe a table's columns, types, nullability, and constraints.      Args:, Execute a read-only SQL query and return results.      Only SELECT, WITH, and EX, Run EXPLAIN ANALYZE on a query and return the execution plan.      Args: (+14 more)

### Community 72 - "Module Cluster 72"
Cohesion: 0.14
Nodes (11): hex_bytes(), json_sax_acceptor, namespace(), NLOHMANN_JSON_NAMESPACE_BEGIN(), parse_error(), string(), string_t_helper(), NLOHMANN_BASIC_JSON_TPL_DECLARATION (+3 more)
...
Cohesion: 0.18
Nodes (18): ensure_voice_exists(), find_voice(), get_voices(), Utility for downloading Piper voices., Loads available voices from downloaded or embedded JSON file., VoiceNotFoundError, get_file_hash(), main() (+10 more)

### Community 76 - "Module Cluster 76"
Cohesion: 0.14
Nodes (8): memmap, int, Path, Tensor, Token cache shard-based slicing., A shard with num_tokens=0 must raise an error, not spin forever., TestTokenCache, TokenCache
...
Cohesion: 0.13
Nodes (11): CausalLMOutputWithCrossAttentions, bool, int, str, Tensor, PretrainedConfig, PreTrainedModel, ModelConfig (+3 more)

### Community 79 - "Module Cluster 79"
Cohesion: 0.13
Nodes (11): bool, device, Tests for data.py: TokenCache, TextWindowDataset, cache utilities., Dataset indexing and window construction., Building the dataset twice with same params should reuse cache., Dataloader construction., TestBuildDataloader, TestTextWindowDataset (+3 more)
...
Cohesion: 0.21
Nodes (14): PiperConfig, PiperVoice, Synthesize raw audio per sentence from text., Synthesize raw audio from phoneme ids., Load an ONNX model and config., Text to phonemes grouped by sentence., Synthesize WAV audio from text., bool (+6 more)
...
Cohesion: 0.13
Nodes (15): int, x: decoder input         h: encoder output, add_timing_signal_1d(), cat_timing_signal_1d(), generate_path(), get_timing_signal_1d(), init_weights(), rand_gumbel() (+7 more)

### Community 88 - "Module Cluster 88"
Cohesion: 0.12
Nodes (8): bool, int, str, MelAudioConfig, ModelAudioConfig, ModelConfig, Configuration classes, TrainingConfig
...
Cohesion: 0.17
Nodes (12): Enum, PhonemeType, ExcludeReason, main(), ProcessUtterance, Uses ffmpeg to get audio duration., Utterance, PhonemeType (+4 more)
...
Cohesion: 0.11
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, ca_ES-upc_ona-medium, aliases (+9 more)
...
Cohesion: 0.11
Nodes (18): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-eva_k-x_low, aliases (+10 more)

### Community 102 - "Module Cluster 102"
Cohesion: 0.11
Nodes (18): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-karlsson-low, aliases (+10 more)
...
Cohesion: 0.11
Nodes (18): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, el_GR-rapunzelina-low, aliases (+10 more)
...
Cohesion: 0.11
Nodes (18): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, en_GB-alba-medium, aliases (+10 more)

### Community 110 - "Module Cluster 110"
Cohesion: 0.15
Nodes (15): UseChatSocketOptions, APIConfig, buildChatWSUrl(), buildURLAndConnectToChatWS(), config, connectToChatWS(), OnAssistantComplete, OnClose (+7 more)

### Community 111 - "Module Cluster 111"
Cohesion: 0.16
Nodes (8): TestClient, Unit tests for the Piper TTS endpoint (Design A, whole-response REST)., Force the lazy loader to re-evaluate between tests., Stand-in for PiperVoice.synthesize: writes a tiny silent WAV., reset_tts_module(), TestTTSHealth, TestTTSSynthesize, _writes_minimal_wav()
...
Cohesion: 0.27
Nodes (13): device, float, int, object, str, build_review_prompt(), CodeReviewService, extract_review() (+5 more)

### Community 114 - "Module Cluster 114"
Cohesion: 0.26
Nodes (8): bool, float, int, str, Decoder, Encoder, FFN, LayerNorm
...
Cohesion: 0.12
Nodes (16): AllocatorWithDefaultOptions, ModelSession, allocator, env, onnx, options, Voice, configRoot (+8 more)
...
Cohesion: 0.17
Nodes (17): account_id, ami, ckpt_s3, code_bundle_s3, ecr_image, gpu_memory_utilization, hf_export_s3, instance_profile (+9 more)
...
Cohesion: 0.19
Nodes (16): IntEnum, UserWarning, _handle_pad_byte(), _raise_bad_format(), Module to read / write wav files using NumPy arrays  Functions --------- `read`:, WAVE form wFormatTag IDs      Complete list is in mmreg.h in Windows 10 SDK.  AL, Returns     -------     size : int         size of format subchunk in bytes (min, Notes     -----     Assumes file pointer is immediately after the 'data' id (+8 more)
...
Cohesion: 0.24
Nodes (14): JoinableQueue, make_silence_detector(), batched(), get_text_casing(), ljspeech_dataset(), main(), mycroft_dataset(), PathEncoder (+6 more)
...
Cohesion: 0.16
Nodes (9): fused_add_tanh_sigmoid_multiply(), ConvFlow, ConvReluNorm, ElementwiseAffine, ResidualCouplingLayer, piecewise_rational_quadratic_transform(), rational_quadratic_spline(), searchsorted() (+1 more)
...
Cohesion: 0.24
Nodes (13): empty(), end_array(), end_object(), is_array(), is_discarded(), is_structured(), NLOHMANN_BASIC_JSON_TPL_DECLARATION(), parent_pointer() (+5 more)
...
Cohesion: 0.13
Nodes (8): Tests for the sql_query tool function., Non-read-only SQL returns an error dict with rejected_sql., max_rows below 1 is clamped to 1., max_rows above 1000 is clamped to 1000., Successful query returns columns, rows, row_count, and truncated., truncated is True when row count equals max_rows., Exceptions from _run_query are caught and returned as error dicts., TestSqlQuery
...
Cohesion: 0.16
Nodes (14): check_contradictions(), Detect potential contradictions: entries that are semantically similar     but c, Create two embeddings with a specific cosine similarity in the contradiction ran, Entry A without negation + Entry B with negation should flag contradiction., If both entries contain negations, no contradiction is flagged., If neither entry has negation markers, no contradiction is flagged., Entries with similarity outside [0.65, 0.90] should not be checked., Entries without embeddings should be silently skipped. (+6 more)

### Community 140 - "Module Cluster 140"
Cohesion: 0.14
Nodes (13): arith_boosters_path, arith_train_added, base_train, base_train_path, base_val, base_val_path, intro_boosters_path, intro_train_added (+5 more)
...
Cohesion: 0.22
Nodes (4): Tests for the memory_update_trust tool., Tests for limit clamping and embed call in memory_search., TestMemorySearch, TestMemoryUpdateTrust

### Community 143 - "Module Cluster 143"
Cohesion: 0.26
Nodes (9): bool, float, int, object, str, ChatService, main(), make_handler() (+1 more)
...
Cohesion: 0.19
Nodes (8): Each rank should see a mostly-disjoint shard of the dataset.          Distribute, Union of all rank indices should cover the full dataset (with possible padding)., DistributedSampler.set_epoch changes shuffling order., build_distributed_dataloader with world_size=1 and simulated multi-rank., TestBuildDistributedDataloader, TestDistributedSamplerEpoch, build_distributed_dataloader(), Build dataset + distributed-aware dataloader. Returns (loader, sampler).

### Community 146 - "Module Cluster 146"
Cohesion: 0.22
Nodes (6): MultiHeadAttention, x: [b, h, l, m]         y: [h or 1, m, d]         ret: [b, h, l, d], x: [b, h, l, d]         y: [h or 1, m, d]         ret: [b, h, l, m], x: [b, h, l, 2*l-1]         ret: [b, h, l, l], x: [b, h, l, l]         ret: [b, h, l, 2*l-1], Bias for self-attention to encourage attention to close positions.         Args:
...
Cohesion: 0.18
Nodes (10): .pre-commit-config.yaml (ruff, detect-secrets, shellcheck, pip-audit), Pre-commit Hook: detect-secrets (v1.5.0), Pre-commit Hook: pip-audit (v2.9.0), Pre-commit Hook: ruff lint+format (v0.11.13), Pre-commit Hook: shellcheck (v0.10.0.1), mcp_toolchain_test.py (vLLM+MCP tool call integration test), map_list MCP Tool (list files in directory), Mistral-7B-Instruct-AWQ Model (+2 more)
...
Cohesion: 0.17
Nodes (7): Tests for the _entry_to_dict helper (pure function, no mocking needed)., All fields are present and correctly typed., None tags become an empty dict., None trust_score becomes 0.0., None created_at becomes None in the dict., Zero trust_score (falsy but valid) is preserved as 0.0., TestEntryToDict

### Community 162 - "Module Cluster 162"
Cohesion: 0.35
Nodes (11): Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments., int, str, main(), Run tests with the specified pattern., run_integration_tests() (+3 more)

### Community 163 - "Module Cluster 163"
Cohesion: 0.26
Nodes (11): bool, float, int, Path, str, generate(), load_config(), load_tokenizer() (+3 more)
...
Cohesion: 0.18
Nodes (11): frequency_penalty, max_tokens, temperature, top_p, vllm, host, inference, model (+3 more)

### Community 169 - "Module Cluster 169"
Cohesion: 0.36
Nodes (10): bool, int, str, main(), Run pytest with the given pattern., run_integration_tests(), run_specific_test(), run_tests() (+2 more)
...
Cohesion: 0.18
Nodes (6): Tests for the sql_explain tool., Mutating SQL is blocked before running EXPLAIN., Valid explain returns the execution plan., Empty result set returns plan=None., Exceptions from _run_query produce error dicts., TestSqlExplain

### Community 174 - "Module Cluster 174"
Cohesion: 0.18
Nodes (6): Tests for the sql_sample_rows tool., Limit below 1 is clamped to 1., Limit above 20 is clamped to 20., Successful call returns columns, rows, and row_count., Database errors are caught and returned as error dicts., TestSqlSampleRows
...
Cohesion: 0.20
Nodes (10): en-us, amy_medium (fine-tuned), arctic_medium (fine-tuned), joe_medium (fine-tuned), kusal_medium (fine-tuned), l2arctic_medium (fine-tuned), lessac-high, lessac-low (+2 more)
...
Cohesion: 0.20
Nodes (10): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, files, de/de_DE/thorsten_emotional/medium/de_DE-thorsten_emotional-medium.onnx (+2 more)
...
Cohesion: 0.20
Nodes (8): start_vllm_nous-hermes-2-mistal.sh script, CUDA_VISIBLE_DEVICES, PYTORCH_CUDA_ALLOC_CONF, RAY_disable_usage_stats, RAY_memory_usage_threshold, RAY_object_store_memory, RAY_preallocate_plasma, RAY_USE_MULTIPROCESSING_CPU_COUNT

### Community 190 - "Module Cluster 190"
Cohesion: 0.20
Nodes (9): isolate_config_cache(), mock_embed(), mock_embed_unique(), Root-level conftest.py for the Wintermute platform test suite.  Provides shared, Reset the shared config cache between tests so mutations don't leak., Write a minimal shared_api_config.json and patch config_loader to use it., Return a deterministic fake embedding function (384-dim zeros)., Return a fake embedding function that produces unique vectors per input. (+1 more)

### Community 191 - "Module Cluster 191"
Cohesion: 0.29
Nodes (9): _import_fresh(), Tests for db.session_async — async engine and session factory., Force-reimport session_async so module-level code re-executes., AsyncSessionLocal() should yield an AsyncSession context manager., test_async_session_local_is_session_maker(), test_database_url_env_override(), test_default_database_url_is_sqlite(), test_engine_is_created() (+1 more)

### Community 192 - "Module Cluster 192"
Cohesion: 0.20
Nodes (3): The auto-scaling math: grad_accum_steps // world_size., Effective batch should be the same before and after scaling., TestGradAccumScaling

### Community 193 - "Module Cluster 193"
Cohesion: 0.31
Nodes (5): export_decoder(), export_encoder(), main(), VitsDecoder, VitsEncoder

### Community 194 - "Module Cluster 194"
Cohesion: 0.22
Nodes (9): IMPLEMENTATION_AWS_titan_llm_model_training.md, beardface (Vikunja user), CURSOR_README.md Project Overview, IMPLEMENTATION_MCP_CORE.md, Wintermute_Master_Spec.md Architecture Spec, Vikunja Project Tracker, Wintermute Project (Agent Bootstrap), Compliance Eval Prompt Set (+1 more)

### Community 195 - "Module Cluster 195"
Cohesion: 0.50
Nodes (7): get_embed_device(), get_embed_model_name(), get_live_data_dir(), get_llm_model_name(), get_storage_dir(), get_vllm_url(), verify_config()

### Community 196 - "Module Cluster 196"
Cohesion: 0.25
Nodes (5): PcapGenerator, Constructor for the PcapGenerator class.          :param filename: The name of t, Generates a sample PCAP file with dummy packets.          :param packet_count: T, Creates a dummy packet for testing.          :param index: The index of the pack, Class to generate PCAP files for testing purposes.

### Community 197 - "Module Cluster 197"
Cohesion: 0.33
Nodes (9): TitanProject Config: combo_all (MAC variant, persist+longterm memory), TitanProject Config: decay_slow (MAC variant, higher lr_min floor), TitanProject Config: dim384 (MAC variant, dim=384), TitanProject Config: lrmin (MAC variant, lr_min=0.00005), TitanProject Config: seq512 (MAC variant, seq_len=512), TinyStories Sampled Training Data, Titan Memory Test (needle-in-haystack color recall, 142 questions), Titan Memory Test Answer Key (142 color answers) (+1 more)

### Community 198 - "Module Cluster 198"
Cohesion: 0.25
Nodes (6): add_entry(), recent_entries(), float, int, Session, str

### Community 199 - "Module Cluster 199"
Cohesion: 0.22
Nodes (8): arith_stabilizer_train_added, base_train, microstory_train_added, self_intro_train_added, source, train_total, val_copied_from, val_total
...
Cohesion: 0.25
Nodes (9): __pyx_array_get_memview(), __Pyx_GetException(), __pyx_getprop___pyx_memoryview_ndim(), __pyx_memoryview_err_extents(), __pyx_memoryview_is_slice(), __pyx_pf_15View_dot_MemoryView_10memoryview_4ndim___get__(), __pyx_pw_15View_dot_MemoryView_10memoryview_4ndim_1__get__(), __Pyx_PyBool_FromLong() (+1 more)
...
Cohesion: 0.31
Nodes (6): VoiceToggleButton(), VoiceToggleButtonProps, useVoiceRecorder(), UseVoiceRecorderProps, voiceUrl, debugLog()

### Community 206 - "Module Cluster 206"
Cohesion: 0.28
Nodes (4): _make_entry(), Tests for the memory_flag tool., Build a mock MemoryEntry with sensible defaults., TestMemoryFlag
...
Cohesion: 0.39
Nodes (8): device, int, str, build_prompt(), main(), pick_device(), postprocess_completion(), Simple interactive chat-style REPL for Titans checkpoints.  This is a convenienc

### Community 210 - "Module Cluster 210"
Cohesion: 0.22
Nodes (9): Detached Training Probe Config, dixie_sft Layout, titan_detached Layout, AWS EC2 Training Infrastructure, chat_http.py HTTP Chat Endpoint, chat_repl.py Interactive Qualitative Interface, inference_smoke.py Checkpoint Harness, OASST1 + Dolly SFT Pilot Training (+1 more)

### Community 211 - "Module Cluster 211"
Cohesion: 0.25
Nodes (8): PiperConfig, eSpeakDataPath, tashkeelModelPath, tashkeelState, useESpeak, useTashkeel, State, unique_ptr
...
### Community 213 - "Module Cluster 213"
Cohesion: 0.25
Nodes (7): base_train, base_val, curated_train_added, curated_val_added, source, train_total, val_total

### Community 214 - "Module Cluster 214"
Cohesion: 0.25
Nodes (7): arith_stabilizer_train_added, base_train, broader_story_train_added, source, train_total, val_copied_from, val_total

### Community 215 - "Module Cluster 215"
Cohesion: 0.25
Nodes (7): base_train, base_val, source, story_train_added, story_val_added, train_total, val_total

### Community 216 - "Module Cluster 216"
Cohesion: 0.25
Nodes (8): en-gb, alan-medium (fine-tuned), alba-medium (fine-tuned), aru-medium (fine-tuned), jenny_dioco-medium (fine-tuned), northern_english_male-medium (fine-tuned), semaine-medium (fine-tuned), vctk-medium (fine-tuned)
...
Cohesion: 0.25
Nodes (8): codereview, host, paths, port, scheme, batch, health, review

### Community 219 - "Module Cluster 219"
Cohesion: 0.25
Nodes (5): memory_add creates a MemoryEntry with the provided text, tags, and zone., Omitting tags defaults to an empty dict., memory_add calls _embed with the entry text., Tests for the memory_add tool., TestMemoryAdd

### Community 220 - "Module Cluster 220"
Cohesion: 0.25
Nodes (7): Tests for shared/setup_path.py — sys.path extension utility., extend_path should insert the wintermute repo root into sys.path., Calling extend_path twice should not produce duplicate entries., The repo root should be inserted at position 0 for import priority., test_extend_path_adds_wintermute_root(), test_extend_path_inserts_at_front(), test_extend_path_is_idempotent()
...
### Community 232 - "Module Cluster 232"
Cohesion: 0.43
...
Cohesion: 0.33
Nodes (4): audio_float_to_int16(), Normalize audio and convert to int16 range, float, ndarray
...
Cohesion: 0.38
Nodes (4): float, TestReduceScalar, All-reduce a scalar value (mean) across ranks., reduce_scalar()
...
Cohesion: 0.50
Nodes (3): Stream response from the LLM to the provided send_token_callback function., Convert a formatted prompt string into chat messages.          The prompt follow, str
...
Cohesion: 0.40
Nodes (5): agents, default_llm_port, default_model, max_iterations, temperature
...
Cohesion: 0.40
Nodes (3): Tests for the sql_describe_table tool., sql_describe_table returns schema, table, row_count, columns, pk, fk., TestSqlDescribeTable

### Community 251 - "Module Cluster 251"
Cohesion: 0.60
Nodes (4): Path, load_config(), main(), Export a Titans checkpoint to a Hugging Face-style folder.  Notes: - This writes

### Community 252 - "Module Cluster 252"
Cohesion: 0.40
Nodes (3): setup_distributed() fallback behavior without torchrun., cleanup should not raise when no process group is initialized., TestSetupDistributed

### Community 253 - "Module Cluster 253"
Cohesion: 0.50
Nodes (3): bool, Tensor, Flip

### Community 254 - "Module Cluster 254"
Cohesion: 0.50
Nodes (4): SynthesisResult, audioSeconds, inferSeconds, realTimeFactor

### Community 256 - "Module Cluster 256"
Cohesion: 0.67
Nodes (3): Language, main(), Voice

### Community 258 - "Module Cluster 258"
Cohesion: 0.50
...
### Community 259 - "Module Cluster 259"
Cohesion: 0.50
Nodes (3): _patch_server(), Tests for mcp_memory/server.py — MCP strategic memory server.  All database and, Return a dict of patches for all server-module DB/embed dependencies.

### Community 260 - "Module Cluster 260"
Cohesion: 0.67
Nodes (3): main(), synthesize(), float

### Community 261 - "Module Cluster 261"
Cohesion: 0.67
Nodes (3): main(), synthesize(), float

### Community 262 - "Module Cluster 262"
Cohesion: 0.67
Nodes (3): main(), synthesize(), float

### Community 263 - "Module Cluster 263"
Cohesion: 0.50
...
### Community 264 - "Module Cluster 264"
Cohesion: 0.50
Nodes (3): cmake.sourceDirectory, python.analysis.extraPaths, python.defaultInterpreterPath

### Community 265 - "Module Cluster 265"
Cohesion: 0.67
Nodes (3): Memory Zone Architecture: live/cold zones, Async SQLAlchemy Session (talkingHead), Strategic Memory Async Bridge (talkingHead)

### Community 267 - "Module Cluster 267"
Cohesion: 0.67
Nodes (3): Wintermute Tech Stack v0.4, Wintermute Design Decisions, DEC-02: Keep CUDA Stack, Evaluate WebGPU for Visualizations Only

### Community 273 - "Module Cluster 273"
Cohesion: 0.67
Nodes (3): ar, qasr-high, qasr-low

### Community 274 - "Module Cluster 274"
Cohesion: 0.67
Nodes (3): de, thorsten_emotional (fine-tuned), thorsten-medium (fine-tuned)

### Community 275 - "Module Cluster 275"
Cohesion: 0.67
Nodes (3): es, davefx-medium (fine-tuned), sharvard-medium (fine-tuned)

### Community 276 - "Module Cluster 276"
Cohesion: 0.67
Nodes (3): fr, siwis-medium (fine-tuned), upmc-medium (fine-tuned)

### Community 277 - "Module Cluster 277"
Cohesion: 0.67
Nodes (3): kk, iseke-low, raya-low

### Community 278 - "Module Cluster 278"
Cohesion: 0.67
Nodes (3): pl, darkman-medium (fine-tuned), gosia-medium (fine-tuned)

### Community 284 - "Module Cluster 284"
Cohesion: 0.67
...
## Knowledge Gaps
- **1366 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1361 more)
...
- **Why does `datetime` connect `Module Cluster 36` to `Module Cluster 259`, `Module Cluster 37`, `Freud Memory Auditor`, `Module Cluster 40`, `PostgreSQL MCP Server`, `Module Cluster 122`, `Module Cluster 31`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `PiperVoice` connect `Module Cluster 83` to `Module Cluster 69`, `Module Cluster 134`, `Module Cluster 233`, `Module Cluster 75`, `Module Cluster 91`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `VoiceNotFoundError` connect `Module Cluster 75` to `Module Cluster 72`?**
