...
def get_relations_data(
    word, synset
):  # -> tuple[tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, list[tuple[Any, list[tuple[Any, list[Any]]]]]], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, list[Any] | Any], tuple[int, str, list[Any] | Any]] | tuple[tuple[int, str, list[Any] | Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, list[tuple[Any, list[tuple[Any, list[Any]]]]]], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, Any], tuple[int, str, list[Any] | Any]] | tuple[tuple[int, str, list[Any] | Any], tuple[int, str, Any], tuple[int, str, list[Any] | Any], tuple[int, str, Any], tuple[int, str, Any]] | tuple[tuple[int, str, list[Any] | Any]]:
    """
...
def page_from_word(
    word,
):  # -> tuple[Literal[''], Literal['Please specify a word to search for.']] | tuple[Any | LiteralString | str, Any]:
    """
