...
from compressed_tensors.quantization.quant_args import FP8_DTYPE, QuantizationArgs, QuantizationStrategy, QuantizationType
from compressed_tensors.quantization.quant_scheme import QuantizationScheme
from torch import FloatTensor, IntTensor, Tensor
from torch.nn import Module
from tqdm import tqdm

__all__ = ["infer_quantization_status", "is_module_quantized", "is_model_quantized", "module_type", "calculate_compression_ratio", "get_torch_bit_depth", "can_quantize", "parse_out_kv_cache_args", "KV_CACHE_TARGETS", "is_kv_cache_quant_scheme", "iter_named_leaf_modules", "iter_named_quantizable_modules", "compute_dynamic_scales_and_zp", "calculate_range", "calculate_qparams"]
KV_CACHE_TARGETS = ...
_LOGGER: logging.Logger = ...
def calculate_qparams(min_vals: Tensor, max_vals: Tensor, quantization_args: QuantizationArgs) -> Tuple[FloatTensor, IntTensor]:
    """
...
def compute_dynamic_scales_and_zp(value: Tensor, args: QuantizationArgs): # -> Tuple[FloatTensor, IntTensor]:
    """
...
def iter_named_quantizable_modules(model: Module, include_children: bool = ..., include_attn: bool = ...) -> Generator[Tuple[str, Module], None, None]:
    """
...
def parse_out_kv_cache_args(quant_scheme_to_layers: List[QuantizationScheme]) -> Tuple[Optional[QuantizationArgs], List[QuantizationScheme]]:
    """
