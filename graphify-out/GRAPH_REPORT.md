...
## Summary
- 5377 nodes · 9953 edges · 354 communities (289 shown, 65 thin omitted)
...
## Communities (354 total, 65 thin omitted)
...
Cohesion: 0.05
Nodes (63): BaseBenchmark, _parse(), _answer_matches(), Loose match: expected answer appears in response (case-insensitive)., _parse_answer(), MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac, subjects:         list of MMLU subject names, or None for all 57         max_per, _parse() (+55 more)
...
Cohesion: 0.05
Nodes (65): ca_ES-upc_ona-x_low, aliases, key, language, name, num_speakers, quality, speaker_id_map (+57 more)

### Community 8 - "Cython Core Runtime"
Cohesion: 0.06
Nodes (54): CYTHON_SMALL_CODE, PyInit_core(), __pyx_array___dealloc__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_4__dealloc__(), __pyx_bisect_code_objects(), __Pyx_BufFmt_CheckString(), __Pyx_BufFmt_DescribeTypeChar(), __Pyx_BufFmt_ExpectNumber() (+46 more)
...
Cohesion: 0.06
Nodes (57): __pyx_array___getattr__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_12__setitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_8__getattr__(), __pyx_array___setitem__(), __Pyx_GetAttr(), __Pyx_GetAttr3(), __Pyx_GetAttr3Default(), __pyx_getprop___pyx_array_memview() (+49 more)
...
Cohesion: 0.11
Nodes (55): byte_container_with_subtype, const_iterator, const_reference, at(), begin(), cbegin(), cend(), compares_unordered() (+47 more)
...
Cohesion: 0.05
Nodes (49): Allocator, compares_unordered, const_reverse_iterator, adl_serializer, boolean(), clear(), crbegin(), crend() (+41 more)

### Community 16 - "MCP Memory Server"
Cohesion: 0.05
Nodes (25): _parse(), _extract_answer(), _normalize(), GSM8K — Grade School Math Dataset: openai/gsm8k Metric:  accuracy (exact final n, Pull the final numeric answer out of a model response., _extract(), _normalize(), MATH — Competition Math Benchmark Dataset: TIGER-Lab/MATH-plus (train split, cap (+17 more)

### Community 17 - "SFT Fine-Tuning Pipeline"
Cohesion: 0.11
Nodes (37): back(), empty(), end_array(), end_object(), get_token_string(), handle_value(), hex_bytes(), json_sax_acceptor (+29 more)
...
Cohesion: 0.09
Nodes (44): abs_py_ssize_t(), __pyx_array_new(), __Pyx_decode_c_string(), __Pyx_div_long(), __pyx_f_11piper_train_4vits_15monotonic_align_4core_maximum_path_c(), __pyx_f_11piper_train_4vits_15monotonic_align_4core_maximum_path_each(), __pyx_fatalerror(), __pyx_fill_contig_strides_array() (+36 more)
...
Cohesion: 0.09
Nodes (18): Tests for model.py: model factory, forward pass shapes, config validation., ModelConfig dataclass defaults and construction., HFGPT2LM forward pass shape checks., Sanity check that model parameter counts scale as expected., build_model factory function., GPTLM forward pass shape and behavior checks., TestBuildModel, TestGPTLMForward (+10 more)
...
Cohesion: 0.11
Nodes (34): __Pyx_AddTraceback(), __pyx_array_get_memview(), __pyx_array___getitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_10__getitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array___cinit__(), __Pyx_CLineForTraceback(), __Pyx_ErrFetchInState(), __Pyx_ErrRestoreInState() (+26 more)
...
Cohesion: 0.07
Nodes (27): AbstractEventLoop, Shared fixtures for titanProject tests., MagicMock, str, TestClient, Pytest configuration and fixtures for talkingHead backend tests., client(), event_loop() (+19 more)
...
Cohesion: 0.25
Nodes (29): ARCChallengeBenchmark, GPQADiamondBenchmark, GSM8KBenchmark, HellaSwagBenchmark, HumanEvalBenchmark, IFEvalBenchmark, LiveCodeBenchmark, LoCoMoBenchmark (+21 more)

### Community 46 - "Module Cluster 46"
Cohesion: 0.07
Nodes (29): counts, logic_train_used, logic_val_used, openhermes_train_used, openhermes_val_used, slimorca_val_used, train_total, val_total (+21 more)
...
Cohesion: 0.10
Nodes (30): CYTHON_NCP_UNUSED, _copy_strided_to_strided(), __pyx_array___len__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_6__len__(), __Pyx_div_Py_ssize_t(), __Pyx_GetItemInt_Fast(), __Pyx_GetItemInt_Generic(), __Pyx_GetItemInt_List_Fast() (+22 more)
...
Cohesion: 0.07
Nodes (28): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, files, md5_digest (+20 more)
...
Cohesion: 0.15
Nodes (8): Batch, UtteranceCollate, VitsModel, discriminator_loss(), feature_loss(), generator_loss(), kl_loss(), z_p, logs_q: [b, h, t_t]     m_p, logs_p: [b, h, t_t]

### Community 64 - "Module Cluster 64"
Cohesion: 0.10
Nodes (21): str, Trivial tokenizer that maps each character to its ordinal., Any, async_session(), dummy_tokenizer(), DummyTokenizer, mock_piper_voice(), Create a temporary audio file for testing. (+13 more)

### Community 65 - "Module Cluster 65"
Cohesion: 0.12
Nodes (14): ABC, ARC Challenge — AI2 Reasoning Challenge (hard subset) Dataset: allenai/ARC (ARC-, Base class all benchmark adapters inherit from., GPQA Diamond — Graduate-level Google-Proof Q&A Dataset: google-deepmind/gpqa (gp, LoCoMo — Long-Context Conversation Memory Dataset: snap-research/LoCoMo Metric:, OR-Bench — Over-Refusal Benchmark Dataset: bench-llm/or-bench Metric:  complianc, SWE-bench Verified Dataset: princeton-nlp/SWE-bench_Verified Metric:  resolve_ra, WinoGrande — Large-Scale Winograd Schema Challenge Dataset: allenai/winogrande M (+6 more)
...
Cohesion: 0.20
Nodes (14): LongTensor, DataLoader, bool, float, int, Path, str, Batch (+6 more)
...
Cohesion: 0.13
Nodes (22): array_t, binary_t, boolean_t, binary(), get_impl_ptr(), get_ptr(), is_array(), is_binary() (+14 more)
...
Cohesion: 0.10
Nodes (21): de_DE-thorsten-high, aliases, key, language, name, num_speakers, quality, de_DE-thorsten-low (+13 more)
...
Cohesion: 0.15
Nodes (14): int, add_timing_signal_1d(), cat_timing_signal_1d(), generate_path(), get_timing_signal_1d(), init_weights(), rand_gumbel(), rand_gumbel_like() (+6 more)
...
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-eva_k-x_low, files (+9 more)
...
Cohesion: 0.12
Nodes (16): agents, default_llm_port, default_model, max_iterations, temperature, dag_retrieval, llm_timeout, frequency_penalty (+8 more)
...
Cohesion: 0.14
Nodes (13): arith_stabilizer_train_added, base_train, microstory_train_added, source, train_total, val_total, train_total, self_intro_train_added (+5 more)
...
Cohesion: 0.25
Nodes (14): bool, Run pytest with the given pattern., run_integration_tests(), run_specific_test(), run_tests(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments. (+6 more)

### Community 131 - "Module Cluster 131"
Cohesion: 0.28
Nodes (6): float, int, get_padding(), DDSConv, Dialted and Depth-Separable Convolution, WN
...
Cohesion: 0.15
Nodes (12): base_val, base_val_path, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview (+4 more)

### Community 144 - "Module Cluster 144"
Cohesion: 0.15
Nodes (12): arith_stabilizer_train_added, base_train, train_total, val_copied_from, val_total, arith_boosters_path, arith_train_added, intro_boosters_path (+4 more)
...
Cohesion: 0.20
Nodes (11): codereview, paths, port, batch, health, review, web_interface, host (+3 more)
...
Cohesion: 0.25
Nodes (8): mcp_memory, default_db_url, embed_model, rag, device, live_data_dir, storage_dir, port
...
Cohesion: 0.29
Nodes (5): bool, int, Path, str, Utterance
...
Cohesion: 0.40
Nodes (3): PY, SCRIPTS, bootstrap.sh script

### Community 231 - "Module Cluster 231"
Cohesion: 0.50
Nodes (4): ensure_instance_profile(), main(), Launch (or dry-run/wire-up) the self-terminating Titan recall scale run on EC2 (, Idempotently create role + instance profile granting ONLY S3 to the     titan-ec
...
Cohesion: 0.67
Nodes (3): PYTORCH_CUDA_ALLOC_CONF, run(), run_sweep.sh script
...
## Knowledge Gaps
- **1296 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1291 more)
...
- **Why does `AsyncMock` connect `Module Cluster 26` to `Module Cluster 66`, `Module Cluster 35`, `HuggingFace Model Utilities`, `Cython C Extensions`, `Module Cluster 39`, `Model Training Data`, `Module Cluster 53`, `Eval Benchmark Adapters`, `Module Cluster 157`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `ModelConfig` connect `Module Cluster 37` to `Module Cluster 134`, `Module Cluster 137`, `PostgreSQL MCP Server`, `Module Cluster 29`, `Module Cluster 158`, `Module Cluster 167`, `Module Cluster 43`, `Module Cluster 44`, `Module Cluster 174`, `Module Cluster 54`, `Module Cluster 187`, `Module Cluster 64`, `Module Cluster 194`, `Module Cluster 195`, `Module Cluster 75`, `Module Cluster 76`, `Module Cluster 86`, `Module Cluster 218`, `Module Cluster 95`, `Module Cluster 233`, `Module Cluster 239`, `Module Cluster 114`, `Module Cluster 123`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 40` to `Module Cluster 41`, `Module Cluster 44`, `Module Cluster 47`, `talkingHead FastAPI Backend`, `Module Cluster 115`, `SQL Agent & Test Harness`, `TTS Voice Subsystem`?**
