...
class AyaVisionProcessor(ProcessorMixin):
    ...
    tokenizer_class = ...
    def __init__(self, image_processor=..., tokenizer=..., patch_size: int = ..., img_size: int = ..., image_token=..., downsample_factor: int = ..., start_of_img_token=..., end_of_img_token=..., img_patch_token=..., img_line_break_token=..., tile_token=..., tile_global_token=..., chat_template=..., **kwargs) -> None:
        ...
    
    def __call__(self, images: Optional[ImageInput] = ..., text: Optional[Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]]] = ..., audio=..., videos=..., **kwargs: Unpack[AyaVisionProcessorKwargs]) -> BatchFeature:
        """
