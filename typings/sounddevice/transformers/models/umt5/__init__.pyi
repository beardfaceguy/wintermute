...
class UMT5Attention(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, encoder_hidden_states: Optional[torch.Tensor] = ..., past_key_value: Optional[Tuple[torch.Tensor]] = ..., attention_mask: Optional[torch.Tensor] = ..., layer_head_mask: Optional[torch.Tensor] = ..., cache_position: Optional[torch.Tensor] = ...): # -> tuple[Any, Tensor, Tuple[Tensor] | None]:
        ...
...
class UMT5LayerSelfAttention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask=..., layer_head_mask=..., past_key_value=..., cache_position=...): # -> Any:
        ...
...
class UMT5LayerCrossAttention(nn.Module):
    ...
    def forward(self, hidden_states, encoder_hidden_states=..., attention_mask=..., layer_head_mask=..., past_key_value=..., cache_position=...): # -> Any:
        ...
...
class UMT5Block(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask=..., encoder_hidden_states=..., encoder_attention_mask=..., layer_head_mask=..., cross_attn_layer_head_mask=..., past_key_value=..., use_cache=..., output_attentions=..., cache_position=...): # -> tuple[Tensor | Any, Any, Any, Any | None] | tuple[Tensor | Any, Any]:
        ...
...
__all__ = ["UMT5EncoderModel", "UMT5ForConditionalGeneration", "UMT5ForQuestionAnswering", "UMT5ForSequenceClassification", "UMT5ForTokenClassification", "UMT5Model", "UMT5PreTrainedModel"]
