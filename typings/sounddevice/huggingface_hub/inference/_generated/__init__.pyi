...
import warnings
import numpy as np
from typing import Any, AsyncIterable, Dict, List, Literal, Optional, Set, TYPE_CHECKING, Union, overload
from huggingface_hub import constants
from huggingface_hub.errors import InferenceTimeoutError
from huggingface_hub.inference._common import ContentT, ModelStatus, RequestParameters, TASKS_EXPECTING_IMAGES, _async_stream_chat_completion_response, _async_stream_text_generation_response, _b64_encode, _b64_to_image, _bytes_to_dict, _bytes_to_image, _bytes_to_list, _get_unsupported_text_generation_kwargs, _import_numpy, _open_as_binary, _set_unsupported_text_generation_kwargs, raise_text_generation_error
...
class AsyncInferenceClient:
    ...
    @overload
    async def text_generation(self, prompt: str, *, details: Literal[True] = ..., stream: bool = ..., model: Optional[str] = ..., adapter_id: Optional[str] = ..., best_of: Optional[int] = ..., decoder_input_details: Optional[bool] = ..., do_sample: Optional[bool] = ..., frequency_penalty: Optional[float] = ..., grammar: Optional[TextGenerationInputGrammarType] = ..., max_new_tokens: Optional[int] = ..., repetition_penalty: Optional[float] = ..., return_full_text: Optional[bool] = ..., seed: Optional[int] = ..., stop: Optional[List[str]] = ..., stop_sequences: Optional[List[str]] = ..., temperature: Optional[float] = ..., top_k: Optional[int] = ..., top_n_tokens: Optional[int] = ..., top_p: Optional[float] = ..., truncate: Optional[int] = ..., typical_p: Optional[float] = ..., watermark: Optional[bool] = ...) -> Union[TextGenerationOutput, AsyncIterable[TextGenerationStreamOutput]]:
        ...
    
    async def text_generation(self, prompt: str, *, details: bool = ..., stream: bool = ..., model: Optional[str] = ..., adapter_id: Optional[str] = ..., best_of: Optional[int] = ..., decoder_input_details: Optional[bool] = ..., do_sample: Optional[bool] = ..., frequency_penalty: Optional[float] = ..., grammar: Optional[TextGenerationInputGrammarType] = ..., max_new_tokens: Optional[int] = ..., repetition_penalty: Optional[float] = ..., return_full_text: Optional[bool] = ..., seed: Optional[int] = ..., stop: Optional[List[str]] = ..., stop_sequences: Optional[List[str]] = ..., temperature: Optional[float] = ..., top_k: Optional[int] = ..., top_n_tokens: Optional[int] = ..., top_p: Optional[float] = ..., truncate: Optional[int] = ..., typical_p: Optional[float] = ..., watermark: Optional[bool] = ...) -> Union[str, TextGenerationOutput, AsyncIterable[str], AsyncIterable[TextGenerationStreamOutput]]:
        """
    ...
    async def list_deployed_models(self, frameworks: Union[None, str, Literal["all"], List[str]] = ...) -> Dict[str, List[str]]:
        """
    ...
    async def get_model_status(self, model: Optional[str] = ...) -> ModelStatus:
        """
