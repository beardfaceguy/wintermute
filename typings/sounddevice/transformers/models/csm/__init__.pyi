...
class CsmProcessor(ProcessorMixin):
    ...
    def save_audio(self, audio: AudioInput, saving_path: Union[str, Path, List[Union[str, Path]]], **kwargs: Unpack[CsmProcessorKwargs]): # -> None:
        ...
    
    def __call__(self, text: Optional[Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]]], audio: Optional[AudioInput] = ..., output_labels: Optional[bool] = ..., depth_decoder_labels_ratio: Optional[float] = ..., **kwargs: Unpack[CsmProcessorKwargs]): # -> BatchFeature:
        r"""
