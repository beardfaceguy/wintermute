...
## Summary
- 5363 nodes · 9957 edges · 344 communities (281 shown, 63 thin omitted)
...
## Communities (344 total, 63 thin omitted)
...
Cohesion: 0.04
Nodes (63): _parse(), BaseBenchmark, Run the benchmark against model and return a BenchmarkResult., _parse(), _answer_matches(), Loose match: expected answer appears in response (case-insensitive)., _parse_answer(), MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac (+55 more)
...
Cohesion: 0.05
Nodes (73): __pyx_array___getattr__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_12__setitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_8__getattr__(), __pyx_array___setitem__(), __Pyx_GetAttr(), __Pyx_GetAttr3(), __Pyx_GetAttr3Default(), __pyx_getprop___pyx_array_memview() (+65 more)
...
Cohesion: 0.05
Nodes (64): ca_ES-upc_ona-x_low, aliases, key, language, name, num_speakers, quality, speaker_id_map (+56 more)
...
Cohesion: 0.08
Nodes (21): _build_test(), LiveCodeBench — Code Generation (Lite) Dataset: livecodebench/code_generation_li, Build a simple assertion block from public test cases., BenchmarkResult, GenerateConfig, ModelBackend, BenchmarkResult, GenerateConfig (+13 more)
...
Cohesion: 0.11
Nodes (27): CYTHON_NCP_UNUSED, _copy_strided_to_strided(), __pyx_array___getitem__(), __pyx_array___len__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_10__getitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_6__len__(), __Pyx_GetItemInt_Fast(), __Pyx_GetItemInt_Generic() (+19 more)
...
Cohesion: 0.10
Nodes (22): AbstractEventLoop, str, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests., client(), event_loop(), mock_chat_processor() (+14 more)
...
Cohesion: 0.09
Nodes (23): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-karlsson-low, aliases (+15 more)
...
Cohesion: 0.10
Nodes (20): base_train, source, train_total, val_copied_from, val_total, arith_stabilizer_train_added, base_train, microstory_train_added (+12 more)
...
Cohesion: 0.12
Nodes (18): logic_val_used, oasst_train_used, oasst_val_used, openhermes_train_used, slimorca_val_used, train_total, val_total, output_format (+10 more)
...
Cohesion: 0.11
Nodes (18): md5_digest, size_bytes, md5_digest, size_bytes, size_bytes, de_DE-eva_k-x_low, aliases, files (+10 more)

### Community 101 - "Module Cluster 101"
Cohesion: 0.11
Nodes (18): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-kerstin-low, files (+10 more)
...
Cohesion: 0.17
Nodes (18): filters, allow_http, max_assistant_chars, max_digit_ratio, max_user_chars, oasst_min_quality, reject_role_markers, filters (+10 more)
...
Cohesion: 0.12
Nodes (17): quality, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, en_GB-aru-medium (+9 more)
...
Cohesion: 0.25
Nodes (14): bool, str, Run pytest with the given pattern., run_integration_tests(), run_specific_test(), run_tests(), run_unit_tests(), Run integration tests only. (+6 more)
...
Cohesion: 0.14
Nodes (12): base_train, curated_train_added, curated_val_added, source, train_total, val_total, arith_stabilizer_train_added, base_train (+4 more)
...
Cohesion: 0.15
Nodes (12): base_train, base_val, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview (+4 more)
...
- **Why does `PiperVoice` connect `Module Cluster 75` to `Module Cluster 129`, `Module Cluster 68`, `Module Cluster 69`, `Module Cluster 230`, `Module Cluster 139`, `Module Cluster 59`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `AsyncMock` connect `Module Cluster 30` to `Module Cluster 160`, `Module Cluster 37`, `Module Cluster 69`, `Freud Memory Auditor`, `DAG Query Retrieval`, `Module Cluster 50`, `Module Cluster 87`, `Shared Config & Utilities`, `Module Cluster 27`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 40` to `Module Cluster 41`, `Module Cluster 43`, `SQL Agent & Test Harness`, `Model Training Data`, `Module Cluster 118`, `TTS Voice Subsystem`, `Module Cluster 26`?**
