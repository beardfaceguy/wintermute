...
class MaskFormerSwinLayer(nn.Module):
    def __init__(
        self, config, dim, input_resolution, num_heads, drop_path_rate=..., shift_size=...
    ) -> None: ...
    def get_attn_mask(self, input_resolution):  # -> None:
        ...
    def maybe_pad(
...
class MaskFormerSwinEncoder(nn.Module):
    ...
    def forward(
        ...
        output_hidden_states=...,
        return_dict=...,
    ):  # -> tuple[Any, ...] | MaskFormerSwinBaseModelOutput:
        ...
