...
## Summary
- 5395 nodes · 9995 edges · 346 communities (283 shown, 63 thin omitted)
...
Cohesion: 0.06
Nodes (57): ca_ES-upc_ona-x_low, aliases, key, language, name, num_speakers, quality, speaker_id_map (+49 more)
...
Cohesion: 0.08
Nodes (35): device, int, str, str, Tests for model_training/titanProject/prompt_formats.py — prompt rendering and e, If ### Response: is missing, the function should not raise ValueError., If ### Input: is present but ### Response: is missing, should not crash., test_default_prompts_chat() (+27 more)
...
Cohesion: 0.07
Nodes (40): eSpeakConfig, voice, ModelConfig, numSpeakers, speakerIdMap, PhonemizeConfig, eSpeak, idBos (+32 more)
...
Cohesion: 0.10
Nodes (10): _make_args(), _make_iam(), Tests for deploy_qwen3.py  Run: pytest infra/sagemaker/test_deploy_qwen3.py -v, Run deploy() with all AWS calls mocked. Returns (mock_model, predictor)., Return a mock IAM client. NoSuchEntityException mirrors botocore., TestDelete, TestDeploy, TestGetHfToken (+2 more)
...
Cohesion: 0.12
Nodes (30): getCodepoint(), getVersion(), initialize(), isSingleCodepoint(), loadModel(), loadVoice(), parseModelConfig(), parsePhonemizeConfig() (+22 more)
...
Cohesion: 0.07
Nodes (29): logic_train_used, logic_val_used, oasst_val_used, slimorca_train_used, slimorca_val_used, train_total, val_total, filters (+21 more)
...
Cohesion: 0.09
Nodes (29): condition_variable, ensureArg(), main(), parseArgs(), printUsage(), rawOutputProc(), RunConfig, eSpeakDataPath (+21 more)
...
Cohesion: 0.11
Nodes (22): Any, str, async_session(), mock_piper_voice(), Create a temporary audio file for testing., Sample text for testing., Sample message data for WebSocket tests., Sample phonemes for testing. (+14 more)
...
Cohesion: 0.10
Nodes (21): ca_ES-upc_ona-medium, aliases, key, language, name, num_speakers, quality, speaker_id_map (+13 more)
...
Cohesion: 0.13
Nodes (17): AbstractEventLoop, MagicMock, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests., client(), event_loop(), mock_chat_processor() (+9 more)
...
Cohesion: 0.14
Nodes (9): ConvFlow, ConvReluNorm, ResBlock1, ResBlock2, ResidualCouplingLayer, piecewise_rational_quadratic_transform(), rational_quadratic_spline(), searchsorted() (+1 more)
...
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, cs_CZ-jirka-medium, aliases (+9 more)
...
Cohesion: 0.12
Nodes (15): base_val, curated_train_added, curated_val_added, source, train_total, val_total, base_train, hf_added (+7 more)
...
Cohesion: 0.15
Nodes (15): codereview, host, paths, port, batch, health, review, vllm (+7 more)
...
Cohesion: 0.25
Nodes (14): bool, main(), Run pytest with the given pattern., run_specific_test(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments., Run integration tests. (+6 more)
...
Cohesion: 0.16
Nodes (12): base_train, microstory_train_added, source, train_total, val_copied_from, val_total, arith_stabilizer_train_added, base_train (+4 more)
...
Cohesion: 0.17
Nodes (11): base_train_path, base_val, arith_boosters_path, arith_train_added, base_train, base_val_path, intro_boosters_path, intro_train_added (+3 more)
...
Cohesion: 0.25
Nodes (7): val_copied_from, arith_stabilizer_train_added, base_train, broader_story_train_added, source, val_total, train_total
...
Cohesion: 0.29
Nodes (6): base_train, base_val, source, story_train_added, story_val_added, val_total
...
Cohesion: 0.60
Nodes (5): delete(), deploy(), get_hf_token(), get_or_create_role(), main()
...
Cohesion: 0.40
Nodes (4): bool, Tensor, ElementwiseAffine, Flip
...
- **Why does `PiperVoice` connect `Module Cluster 74` to `Module Cluster 128`, `Module Cluster 75`, `Module Cluster 140`, `Module Cluster 235`, `Module Cluster 117`, `Module Cluster 91`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 43` to `Module Cluster 44`, `Module Cluster 47`, `Module Cluster 115`, `PostgreSQL MCP Server`, `SQL Agent & Test Harness`, `Model Training Data`, `talkingHead WebSocket & TTS`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `VitsModel` connect `Module Cluster 35` to `Module Cluster 64`, `Cython Core Runtime`, `Module Cluster 200`, `Module Cluster 49`, `Module Cluster 117`?**
