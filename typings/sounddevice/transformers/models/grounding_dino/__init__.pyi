...
class GroundingDinoProcessor(ProcessorMixin):
    ...
    def post_process_grounded_object_detection(self, outputs: GroundingDinoObjectDetectionOutput, input_ids: Optional[TensorType] = ..., threshold: float = ..., text_threshold: float = ..., target_sizes: Optional[Union[TensorType, List[Tuple]]] = ..., text_labels: Optional[List[List[str]]] = ...): # -> list[Any]:
        """
