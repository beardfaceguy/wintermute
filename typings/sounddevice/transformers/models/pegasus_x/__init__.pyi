...
class PegasusXSinusoidalPositionalEmbedding(nn.Module):
    ...
    @torch.no_grad()
    def forward(self, input_embeds: torch.Tensor, past_key_values_length: int = ..., position_ids: Optional[torch.Tensor] = ...) -> torch.Tensor:
...
class PegasusXAttention(nn.Module):
    ...
    def __init__(self, embed_dim: int, num_heads: int, dropout: float = ..., is_decoder: bool = ..., bias: bool = ..., is_causal: bool = ..., config: Optional[PegasusXConfig] = ..., layer_idx: Optional[int] = ...) -> None:
        ...
...
class PegasusXDecoder(PegasusXPreTrainedModel):
    ...
    def forward(self, input_ids=..., attention_mask=..., encoder_hidden_states=..., encoder_attention_mask=..., past_key_values=..., inputs_embeds=..., use_cache=..., output_attentions=..., output_hidden_states=..., return_dict=..., cache_position=...):
        r"""
        Args:
            input_ids (`torch.LongTensor` of shape `(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
