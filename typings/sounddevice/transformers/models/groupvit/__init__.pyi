...
class TFGroupViTModelOutput(ModelOutput):
    ...
    """
    loss: tf.Tensor | None = ...
    logits_per_image: Optional[tf.Tensor] = ...
    logits_per_text: Optional[tf.Tensor] = ...
    segmentation_logits: Optional[tf.Tensor] = ...
    text_embeds: Optional[tf.Tensor] = ...
...
class TFGroupViTTextEmbeddings(keras.layers.Layer):
    ...
    def call(self, input_ids: Optional[tf.Tensor] = ..., position_ids: Optional[tf.Tensor] = ..., inputs_embeds: Optional[tf.Tensor] = ...) -> tf.Tensor:
        """
...
class TFGroupViTAttention(keras.layers.Layer):
    ...
    def call(self, hidden_states: tf.Tensor, attention_mask: Optional[tf.Tensor] = ..., causal_attention_mask: Optional[tf.Tensor] = ..., output_attentions: Optional[bool] = ..., encoder_hidden_states: Optional[tf.Tensor] = ..., training: bool = ...) -> Tuple[tf.Tensor]:
