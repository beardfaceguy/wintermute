...
class Zamba2HybridDynamicCache(ZambaHybridDynamicCache):
    ...
    """
    def __init__(self, config: Zamba2Config, batch_size: int, dtype: torch.dtype = ..., device: Optional[str] = ...) -> None:
        ...
...
class Zamba2Attention(ZambaAttention):
    ...
    """
    def __init__(self, config: Zamba2Config, layer_idx: Optional[int] = ..., num_fwd_mem_blocks: Optional[int] = ..., block_id: Optional[int] = ...) -> None:
        ...
    
    def forward(self, hidden_states: torch.Tensor, layer_idx: int, attention_mask: Optional[torch.Tensor] = ..., past_key_value: Optional[Zamba2HybridDynamicCache] = ..., position_embeddings: Optional[Tuple[torch.Tensor, torch.Tensor]] = ..., **kwargs: Unpack[FlashAttentionKwargs]) -> Tuple[torch.Tensor, Optional[torch.Tensor], Optional[Tuple[torch.Tensor]]]:
        ...
...
class Zamba2MambaMixer(nn.Module):
    ...
    def cuda_kernels_forward(self, hidden_states: torch.Tensor, cache_params: Optional[Zamba2HybridDynamicCache] = ..., attention_mask: Optional[torch.Tensor] = ...): # -> Any:
        ...
    
    def torch_forward(self, input_states, cache_params: Optional[Zamba2HybridDynamicCache] = ..., attention_mask: Optional[torch.Tensor] = ...): # -> Any:
        ...
    
    def forward(self, hidden_states, cache_params: Optional[Zamba2HybridDynamicCache] = ..., attention_mask: Optional[torch.Tensor] = ...): # -> Any:
        ...
...
class Zamba2AttentionDecoderLayer(ZambaAttentionDecoderLayer):
    ...
    def forward(self, hidden_states: torch.Tensor, original_hidden_states: torch.Tensor, layer_idx: int, attention_mask: Optional[torch.Tensor] = ..., past_key_value: Optional[Zamba2HybridDynamicCache] = ..., output_attentions: Optional[bool] = ..., position_embeddings: Optional[torch.LongTensor] = ..., **kwargs: Unpack[FlashAttentionKwargs]) -> Tuple[torch.FloatTensor, Optional[Tuple[torch.FloatTensor, torch.FloatTensor]]]:
        """
        Args:
...
class Zamba2HybridLayer(ZambaHybridLayer):
    def __init__(self, shared_transformer: Zamba2AttentionDecoderLayer, linear: nn.Linear, mamba: Zamba2MambaDecoderLayer) -> None:
        ...
    
    def forward(self, hidden_states: torch.Tensor, original_hidden_states: Optional[torch.Tensor] = ..., layer_idx: Optional[int] = ..., attention_mask: Optional[torch.Tensor] = ..., causal_mask: Optional[torch.Tensor] = ..., past_key_value: Optional[Zamba2HybridDynamicCache] = ..., output_attentions: Optional[bool] = ..., use_cache: Optional[bool] = ..., position_embeddings: Optional[torch.LongTensor] = ...) -> Tuple[torch.FloatTensor, Optional[Tuple[torch.FloatTensor, torch.FloatTensor]]]:
        """
        Args:
