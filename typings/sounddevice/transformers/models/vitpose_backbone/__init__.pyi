...
class VitPoseBackboneLayer(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, dataset_index: Optional[torch.Tensor] = ..., head_mask: Optional[torch.Tensor] = ..., output_attentions: bool = ...) -> Union[Tuple[torch.Tensor, torch.Tensor], Tuple[torch.Tensor]]:
        ...
...
class VitPoseBackboneEncoder(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, dataset_index: Optional[torch.Tensor] = ..., head_mask: Optional[torch.Tensor] = ..., output_attentions: bool = ..., output_hidden_states: bool = ..., return_dict: bool = ...) -> Union[tuple, BaseModelOutput]:
        ...
...
class VitPoseBackbone(VitPoseBackbonePreTrainedModel, BackboneMixin):
    ...
    @auto_docstring
    def forward(self, pixel_values: torch.Tensor, dataset_index: Optional[torch.Tensor] = ..., head_mask: Optional[torch.Tensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...): # -> Any | BackboneOutput:
        r"""
