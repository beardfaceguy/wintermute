...
class Transformer(nn.Module):
    ...
    """
    save_in_root: bool = ...
    def __init__(self, model_name_or_path: str, max_seq_length: int | None = ..., model_args: dict[str, Any] | None = ..., tokenizer_args: dict[str, Any] | None = ..., config_args: dict[str, Any] | None = ..., cache_dir: str | None = ..., do_lower_case: bool = ..., tokenizer_name_or_path: str = ..., backend: str = ...) -> None:
        ...
    ...
    def tokenize(self, texts: list[str] | list[dict] | list[tuple[str, str]], padding: str | bool = ...) -> dict[str, torch.Tensor]:
