...
class Wav2Vec2PhonemeCTCTokenizer(PreTrainedTokenizer):
    ...
    def decode(self, token_ids: Union[int, List[int], np.ndarray, torch.Tensor, tf.Tensor], skip_special_tokens: bool = ..., clean_up_tokenization_spaces: Optional[bool] = ..., output_char_offsets: bool = ..., **kwargs) -> str:
        """
    ...
    def batch_decode(self, sequences: Union[List[int], List[List[int]], np.ndarray, torch.Tensor, tf.Tensor], skip_special_tokens: bool = ..., clean_up_tokenization_spaces: Optional[bool] = ..., output_char_offsets: bool = ..., **kwargs) -> List[str]:
        """
