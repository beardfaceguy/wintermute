...
## Summary
- 5436 nodes · 10087 edges · 353 communities (291 shown, 62 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1109 edges (avg confidence: 0.64)
...
## Communities (353 total, 62 thin omitted)
...
Cohesion: 0.04
Nodes (69): Run the SFT job and return a path/URI to the resulting checkpoint., _parse(), BaseBenchmark, Run the benchmark against model and return a BenchmarkResult., _parse(), _build_test(), Build a simple assertion block from public test cases., _answer_matches() (+61 more)

### Community 3 - "MCP Agent Runner"
Cohesion: 0.06
Nodes (29): bool, float, int, Path, str, _make_mock_model(), _make_mock_tokenizer(), Tests for hf_utils.py — HuggingFace model loading, LoRA, checkpointing, and toke (+21 more)
...
Cohesion: 0.05
Nodes (63): ca_ES-upc_ona-x_low, aliases, key, language, name, num_speakers, quality, speaker_id_map (+55 more)
...
Cohesion: 0.06
Nodes (46): Training-compute backends: where an SFT job actually runs., Enum, JoinableQueue, cache_norm_audio(), make_silence_detector(), # NOTE: audio is already in [-1, 1] coming from librosa, Returns the offset/duration of trimmed audio in seconds, trim_silence() (+38 more)
...
Cohesion: 0.07
Nodes (38): bool, device, float, int, Path, str, main(), Each rank should see a mostly-disjoint shard of the dataset.          Distribute (+30 more)
...
Cohesion: 0.09
Nodes (29): AbstractEventLoop, MagicMock, str, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests., async_session(), client() (+21 more)
...
Cohesion: 0.10
Nodes (24): mcp_servers, map_echo_port, map_list_port, postgres_default_url, talkingHead, port, vllm, model (+16 more)
...
Cohesion: 0.12
Nodes (17): arith_stabilizer_train_added, base_train, self_intro_train_added, source, val_copied_from, val_total, arith_stabilizer_train_added, base_train (+9 more)
...
Cohesion: 0.11
Nodes (19): size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest (+11 more)
...
Cohesion: 0.17
Nodes (18): filters, max_assistant_chars, max_digit_ratio, max_user_chars, oasst_best_only, oasst_max_spam, oasst_min_quality, allow_http (+10 more)
...
Cohesion: 0.14
Nodes (11): bool, Tensor, fused_add_tanh_sigmoid_multiply(), ConvFlow, ConvReluNorm, ElementwiseAffine, Flip, Log (+3 more)
...
Cohesion: 0.13
Nodes (15): train, seed, output_format, paths, val, arith_boosters_path, arith_train_added, base_train (+7 more)
...
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-pavoque-low, aliases (+9 more)

### Community 123 - "Module Cluster 123"
Cohesion: 0.12
Nodes (17): md5_digest, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-thorsten-low, aliases, files (+9 more)
...
Cohesion: 0.20
Nodes (15): dtype, Any, SFTConfig, build_lora_kwargs(), build_sft_kwargs(), _load_model_and_tokenizer(), _make_trainer(), TRL SFTTrainer entrypoint for the host-agnostic SFT pipeline.  Run locally or as (+7 more)
...
Cohesion: 0.25
Nodes (14): bool, str, Run pytest with the given pattern., run_integration_tests(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments., Run integration tests. (+6 more)

### Community 136 - "Module Cluster 136"
Cohesion: 0.20
Nodes (5): _cfg(), Tests for training-compute backends (base / local / sagemaker).  Wiring-only, mo, TestBuildEstimatorKwargs, TestLocalBackend, TestSagemakerRun

### Community 137 - "Module Cluster 137"
Cohesion: 0.19
Nodes (8): ABC, TrainBackend — the interface every training-compute backend implements.  A backe, TrainBackend, LocalBackend, LocalBackend — run the SFT job in-process on the local machine.  Thin wrapper ov, Base class all benchmark adapters inherit from., SFTConfig, TestBase
...
Cohesion: 0.22
Nodes (11): build_estimator_kwargs(), _job_name(), _make_estimator(), SageMakerBackend — run the SFT job as a SageMaker Training Job.  Submits a Huggi, DNS-safe SageMaker base job name derived from the model id., Build the HuggingFace estimator constructor kwargs from an SFTConfig., _repo_root(), _resolve_role() (+3 more)
...
Cohesion: 0.21
Nodes (5): _cfg(), Tests for train.py — wiring only (mock-and-defer).  The real fine-tune needs trl, TestBuildLoraKwargs, TestBuildSftKwargs, TestResolveDtype

### Community 145 - "Module Cluster 145"
Cohesion: 0.30
Nodes (5): float, int, get_padding(), DDSConv, Dialted and Depth-Separable Convolution
...
Cohesion: 0.15
Nodes (13): counts, logic_train_used, logic_val_used, oasst_val_used, openhermes_train_used, openhermes_val_used, train_total, val_total (+5 more)
...
Cohesion: 0.18
Nodes (10): base_val_path, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview, train_total (+2 more)
...
Cohesion: 0.83
Nodes (3): rational_quadratic_spline(), searchsorted(), unconstrained_rational_quadratic_spline()
...
- **Why does `datetime` connect `Module Cluster 38` to `Module Cluster 39`, `Freud Memory Auditor`, `Module Cluster 44`, `Cython Threading`, `Model Training Data`, `TTS Voice Subsystem`, `Module Cluster 119`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `PiperVoice` connect `Module Cluster 73` to `Module Cluster 131`, `Module Cluster 45`, `Module Cluster 142`, `Module Cluster 121`, `Module Cluster 63`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `VitsModel` connect `Module Cluster 36` to `Module Cluster 56`, `Module Cluster 121`, `Module Cluster 211`, `Piper TTS Tests`?**
