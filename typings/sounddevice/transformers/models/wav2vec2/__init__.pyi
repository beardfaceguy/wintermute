...
class Wav2Vec2CTCTokenizer(PreTrainedTokenizer):
    ...
    def batch_decode(self, sequences: Union[List[int], List[List[int]], np.ndarray, torch.Tensor, tf.Tensor], skip_special_tokens: bool = ..., clean_up_tokenization_spaces: Optional[bool] = ..., output_char_offsets: bool = ..., output_word_offsets: bool = ..., **kwargs) -> List[str]:
        """
    ...
    def decode(self, token_ids: Union[int, List[int], np.ndarray, torch.Tensor, tf.Tensor], skip_special_tokens: bool = ..., clean_up_tokenization_spaces: Optional[bool] = ..., output_char_offsets: bool = ..., output_word_offsets: bool = ..., **kwargs) -> str:
        """
...
class Wav2Vec2Tokenizer(PreTrainedTokenizer):
    ...
    def __call__(self, raw_speech: Union[np.ndarray, List[float], List[np.ndarray], List[List[float]]], padding: Union[bool, str, PaddingStrategy] = ..., max_length: Optional[int] = ..., pad_to_multiple_of: Optional[int] = ..., padding_side: Optional[str] = ..., return_tensors: Optional[Union[str, TensorType]] = ..., verbose: bool = ..., **kwargs) -> BatchEncoding:
        """
