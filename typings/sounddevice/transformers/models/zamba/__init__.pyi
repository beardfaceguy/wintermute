...
class ZambaAttention(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, layer_idx: int, attention_mask: Optional[torch.Tensor], past_key_value: Optional[ZambaHybridDynamicCache] = ..., **kwargs: Unpack[FlashAttentionKwargs]) -> Tuple[torch.Tensor, Optional[torch.Tensor], Optional[Tuple[torch.Tensor]]]:
        ...
...
class ZambaMambaMixer(nn.Module):
    ...
    def cuda_kernels_forward(self, hidden_states: torch.Tensor, cache_params: ZambaHybridDynamicCache = ..., attention_mask=...): # -> Any:
        ...
...
class ZambaAttentionDecoderLayer(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, original_hidden_states: torch.Tensor, layer_idx: int, attention_mask: Optional[torch.Tensor] = ..., past_key_value: Optional[ZambaHybridDynamicCache] = ..., output_attentions: Optional[bool] = ..., use_cache: Optional[bool] = ..., **kwargs: Unpack[FlashAttentionKwargs]) -> Tuple[torch.FloatTensor, Optional[Tuple[torch.FloatTensor, torch.FloatTensor]]]:
        """
        Args:
