...
from numpy._typing import NDArray, _ArrayLikeAnyString_co as UST_co, _ArrayLikeBytes_co as S_co, _ArrayLikeInt_co as i_co, _ArrayLikeStr_co as U_co, _ArrayLikeString_co as T_co, _Shape, _SupportsArray

__all__ = ["add", "capitalize", "center", "count", "decode", "encode", "endswith", "equal", "expandtabs", "find", "greater", "greater_equal", "index", "isalnum", "isalpha", "isdecimal", "isdigit", "islower", "isnumeric", "isspace", "istitle", "isupper", "less", "less_equal", "ljust", "lower", "lstrip", "mod", "multiply", "not_equal", "partition", "replace", "rfind", "rindex", "rjust", "rpartition", "rstrip", "startswith", "str_len", "strip", "swapcase", "title", "translate", "upper", "zfill"]
...
@overload
def startswith(a: T_co, prefix: T_co, start: i_co = ..., end: i_co | None = ...) -> NDArray[np.bool]:
    ...
...
@overload
def lstrip(a: _StringDTypeSupportsArray, chars: T_co | None = ...) -> _StringDTypeArray:
    ...
...
@overload
def rstrip(a: _StringDTypeSupportsArray, chars: T_co | None = ...) -> _StringDTypeArray:
    ...
...
@overload
def strip(a: _StringDTypeSupportsArray, chars: T_co | None = ...) -> _StringDTypeArray:
    ...
...
@overload
def replace(a: _StringDTypeSupportsArray, old: _StringDTypeSupportsArray, new: _StringDTypeSupportsArray, count: i_co = ...) -> _StringDTypeArray:
    ...
