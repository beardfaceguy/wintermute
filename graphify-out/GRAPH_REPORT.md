...
## Summary
- 5434 nodes · 10108 edges · 351 communities (289 shown, 62 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1125 edges (avg confidence: 0.64)
...
## Communities (351 total, 62 thin omitted)
...
Cohesion: 0.05
Nodes (64): language, ca_ES-upc_pau-x_low, aliases, key, language, name, num_speakers, quality (+56 more)
...
Cohesion: 0.07
Nodes (39): bool, device, float, int, Path, str, main(), Each rank should see a mostly-disjoint shard of the dataset.          Distribute (+31 more)
...
Cohesion: 0.07
Nodes (26): Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, Tests for model.py: model factory, forward pass shapes, config validation., ModelConfig dataclass defaults and construction., HFGPT2LM forward pass shape checks., Sanity check that model parameter counts scale as expected., build_model factory function., GPTLM forward pass shape and behavior checks., TestBuildModel (+18 more)
...
Cohesion: 0.07
Nodes (35): AbstractEventLoop, Any, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests., async_session(), client(), event_loop() (+27 more)
...
Cohesion: 0.07
Nodes (27): size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, files, num_speakers, md5_digest (+19 more)
...
Cohesion: 0.08
Nodes (24): md5_digest, size_bytes, md5_digest, size_bytes, files, md5_digest, size_bytes, md5_digest (+16 more)
...
Cohesion: 0.15
Nodes (4): _good_dict(), Minimal valid config: only the two required sections., TestFromDict, TestValidation
...
Cohesion: 0.10
Nodes (21): ca_ES-upc_ona-medium, aliases, key, num_speakers, quality, speaker_id_map, ca_ES-upc_ona-x_low, aliases (+13 more)
...
Cohesion: 0.23
Nodes (15): PhonemeType, PiperConfig, PiperVoice, Synthesize raw audio per sentence from text., Synthesize raw audio from phoneme ids., Load an ONNX model and config., Text to phonemes grouped by sentence., Synthesize WAV audio from text. (+7 more)

### Community 79 - "Module Cluster 79"
Cohesion: 0.15
Nodes (7): Raise ValueError on any out-of-range or missing field., SFTConfig, _cfg(), Tests for train.py — wiring only (mock-and-defer).  The real fine-tune needs trl, TestBuildLoraKwargs, TestBuildSftKwargs, TestResolveDtype
...
Cohesion: 0.17
Nodes (18): allow_http, max_digit_ratio, max_user_chars, oasst_min_quality, filters, max_assistant_chars, oasst_best_only, oasst_max_fails_task (+10 more)
...
Cohesion: 0.12
Nodes (17): codereview, paths, port, scheme, batch, health, review, talkingHead (+9 more)
...
Cohesion: 0.15
Nodes (10): DataConfig, LoraConfig, SFT pipeline configuration.  Plain dataclasses + YAML loading + validation. Deli, TrainingConfig, _make_trainer(), Tests for config.py — SFT configuration dataclasses, YAML loading, validation., TestFromYaml, MelAudioConfig (+2 more)
...
Cohesion: 0.13
Nodes (14): arith_stabilizer_train_added, base_train, microstory_train_added, source, train_total, val_copied_from, val_total, base_train (+6 more)
...
Cohesion: 0.25
Nodes (14): bool, int, str, Run pytest with the given pattern., run_integration_tests(), run_specific_test(), Run integration tests only., Run a specific test file. (+6 more)
...
Cohesion: 0.15
Nodes (12): base_train, curated_train_added, curated_val_added, source, train_total, val_total, val_total, base_train (+4 more)
...
Cohesion: 0.26
Nodes (12): Any, build_lora_kwargs(), build_sft_kwargs(), _load_model_and_tokenizer(), TRL SFTTrainer entrypoint for the host-agnostic SFT pipeline.  Run locally or as, Run the SFT job end to end. Returns the output checkpoint directory., Map our TrainingConfig → kwargs for TRL's SFTConfig (a TrainingArguments subclas, Map our LoraConfig → kwargs for peft's LoraConfig, or None for full fine-tune. (+4 more)
...
Cohesion: 0.20
Nodes (10): val, output_format, paths, train, seed, base_train, broader_story_train_added, source (+2 more)
...
Cohesion: 0.17
Nodes (12): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, md5_digest, size_bytes, files (+4 more)

### Community 163 - "Module Cluster 163"
Cohesion: 0.17
Nodes (12): logic_train_used, logic_val_used, openhermes_val_used, slimorca_val_used, train_total, val_total, counts, oasst_train_used (+4 more)
...
Cohesion: 0.27
Nodes (3): _FakeTokenizer, _FakeTrainer, TestTrainOrchestration
...
Cohesion: 0.18
Nodes (10): base_val, base_val_path, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview (+2 more)
...
Cohesion: 0.40
Nodes (4): Any, Path, _build(), Construct a dataclass from a mapping, rejecting unknown keys (typo guard).
...
## Knowledge Gaps
- **1280 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1275 more)
...
- **Why does `AsyncMock` connect `Module Cluster 27` to `Module Cluster 34`, `HuggingFace Model Utilities`, `Cython C Extensions`, `Module Cluster 48`, `Model Training Data`, `Module Cluster 86`, `talkingHead WebSocket & TTS`, `Module Cluster 62`, `Module Cluster 159`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 43` to `Module Cluster 44`, `JSON C++ Type System`, `SFT Fine-Tuning Pipeline`, `talkingHead FastAPI Backend`, `Module Cluster 50`, `Module Cluster 117`, `Shared Config & Utilities`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `VoiceNotFoundError` connect `Module Cluster 119` to `Module Cluster 28`?**
