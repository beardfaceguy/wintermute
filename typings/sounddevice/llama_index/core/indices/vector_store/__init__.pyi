...
from llama_index.core.schema import BaseNode, IndexNode, TransformComponent
...
class VectorStoreIndex(BaseIndex[IndexDict]):
    ...
    def __init__(
        ...
        embed_model: EmbedType | None = ...,
        insert_batch_size: int = ...,
        objects: Sequence[IndexNode] | None = ...,
        index_struct: IndexDict | None = ...,
    ...
    async def adelete_nodes(
        self, node_ids: list[str], delete_from_docstore: bool = ..., **delete_kwargs: Any
    ) -> None:
        """
    ...
    def delete_ref_doc(
        self, ref_doc_id: str, delete_from_docstore: bool = ..., **delete_kwargs: Any
    ) -> None:
