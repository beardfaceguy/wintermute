...
from typing import Any, NamedTuple, SupportsIndex, SupportsInt, TypeAlias, TypeVar, overload
...
@overload
def svd(
    a: _ArrayLikeInt_co, full_matrices: bool = ..., compute_uv: L[True] = ..., hermitian: bool = ...
) -> SVDResult: ...
@overload
def svd(
    a: _ArrayLikeFloat_co,
...
@overload
def norm(
    x: ArrayLike, ord: None | float | L["fro", "nuc"] = ..., axis: None = ..., keepdims: bool = ...
) -> floating[Any]: ...
@overload
def norm(
    x: ArrayLike,
