...
class ChameleonProcessor(ProcessorMixin):
    ...
    def __call__(self, images: Optional[ImageInput] = ..., text: Optional[Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]]] = ..., audio=..., videos=..., **kwargs: Unpack[ChameleonProcessorKwargs]) -> BatchFeature:
        """
