...
class RandomState:
    ...
    def __reduce__(
        self,
    ) -> tuple[Callable[[BitGenerator], RandomState], tuple[BitGenerator], dict[str, Any]]: ...
    ...
    @overload
    def randint(
        self, low: int, high: None | int = ..., size: None = ..., dtype: type[bool] = ...
    ) -> bool: ...
    @overload
    def randint(
        self, low: int, high: None | int = ..., size: None = ..., dtype: type[np.bool] = ...
    ) -> np.bool: ...
    @overload
    def randint(
    ...
    @overload
    def choice(
        self, a: int, size: None = ..., replace: bool = ..., p: None | _ArrayLikeFloat_co = ...
    ) -> int: ...
    @overload
    def choice(
        self,
