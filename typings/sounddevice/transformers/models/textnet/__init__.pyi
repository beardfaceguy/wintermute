...
class TextNetRepConvLayer(nn.Module):
    ...
    """
    def __init__(self, config: TextNetConfig, in_channels: int, out_channels: int, kernel_size: int, stride: int) -> None:
        ...
...
class TextNetEncoder(nn.Module):
    ...
    def forward(self, hidden_state: torch.Tensor, output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...) -> BaseModelOutputWithNoAttention:
        ...
...
class TextNetModel(TextNetPreTrainedModel):
    ...
    @auto_docstring
    def forward(self, pixel_values: Tensor, output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...) -> Union[Tuple[Any, List[Any]], Tuple[Any], BaseModelOutputWithPoolingAndNoAttention]:
        ...
...
class TextNetBackbone(TextNetPreTrainedModel, BackboneMixin):
    ...
    @auto_docstring
    def forward(self, pixel_values: Tensor, output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...) -> Union[Tuple[Tuple], BackboneOutput]:
        r"""
        Examples:
