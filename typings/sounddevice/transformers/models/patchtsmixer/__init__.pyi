...
class PatchTSMixerAttention(nn.Module):
    ...
    def __init__(self, embed_dim: int, num_heads: int, dropout: float = ..., is_decoder: bool = ..., bias: bool = ..., is_causal: bool = ..., config: Optional[PatchTSMixerConfig] = ..., layer_idx: Optional[int] = ...) -> None:
        ...
...
def random_masking(inputs: torch.Tensor, mask_ratio: float, unmasked_channel_indices: Optional[list] = ..., channel_consistent_masking: bool = ..., mask_value: int = ...): # -> tuple[Tensor, Tensor]:
...
def forecast_masking(inputs: torch.Tensor, num_forecast_mask_patches: Union[list, int], unmasked_channel_indices: Optional[list] = ..., mask_value: int = ...): # -> tuple[Tensor, Tensor]:
...
class PatchTSMixerNOPScaler(nn.Module):
    ...
    def forward(self, data: torch.Tensor, observed_indicator: Optional[torch.Tensor] = ...) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        """
        Parameters:
            data (`torch.Tensor` of shape `(batch_size, sequence_length, num_input_channels)`):
                input for Batch norm calculation
...
class PatchTSMixerForTimeSeriesClassification(PatchTSMixerPreTrainedModel):
    ...
    @auto_docstring
    def forward(self, past_values: torch.Tensor, target_values: Optional[torch.Tensor] = ..., output_hidden_states: Optional[bool] = ..., return_loss: bool = ..., return_dict: Optional[bool] = ...) -> PatchTSMixerForTimeSeriesClassificationOutput:
        r"""
        past_values (`torch.FloatTensor` of shape `(batch_size, seq_length, num_input_channels)`):
            Context values of the time series. For a pretraining task, this denotes the input time series to predict
            the masked portion. For a forecasting task, this denotes the history/past time series values. Similarly,
...
class PatchTSMixerForRegression(PatchTSMixerPreTrainedModel):
    ...
    @auto_docstring
    def forward(self, past_values: torch.Tensor, target_values: Optional[torch.Tensor] = ..., output_hidden_states: Optional[bool] = ..., return_loss: bool = ..., return_dict: Optional[bool] = ...) -> PatchTSMixerForRegressionOutput:
        r"""
        past_values (`torch.FloatTensor` of shape `(batch_size, seq_length, num_input_channels)`):
            Context values of the time series. For a pretraining task, this denotes the input time series to predict
            the masked portion. For a forecasting task, this denotes the history/past time series values. Similarly,
...
__all__ = ["PatchTSMixerPreTrainedModel", "PatchTSMixerModel", "PatchTSMixerForPretraining", "PatchTSMixerForPrediction", "PatchTSMixerForTimeSeriesClassification", "PatchTSMixerForRegression"]
