...
class ShieldGemma2Processor(Gemma3Processor):
    def __init__(self, image_processor, tokenizer, chat_template=..., image_seq_length=..., policy_definitions=..., **kwargs) -> None:
    ...
    def __call__(self, images: ImageInput = ..., text=..., videos=..., audio=..., **kwargs: Unpack[ShieldGemma2ProcessorKwargs]) -> BatchFeature:
