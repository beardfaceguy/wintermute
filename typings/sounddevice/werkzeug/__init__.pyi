...
def quote_header_value(value: t.Any, allow_token: bool = ...) -> str:
...
def parse_accept_header(value: str | None, cls: type[_TAnyAccept] | None = ...) -> _TAnyAccept:
...
@t.overload
def parse_cache_control_header(value: str | None, on_update: t.Callable[[ds.cache_control._CacheControl], None] | None = ...) -> ds.RequestCacheControl:
    ...

@t.overload
def parse_cache_control_header(value: str | None, on_update: t.Callable[[ds.cache_control._CacheControl], None] | None = ..., cls: type[_TAnyCC] = ...) -> _TAnyCC:
    ...

def parse_cache_control_header(value: str | None, on_update: t.Callable[[ds.cache_control._CacheControl], None] | None = ..., cls: type[_TAnyCC] | None = ...) -> _TAnyCC:
...
@t.overload
def parse_csp_header(value: str | None, on_update: t.Callable[[ds.ContentSecurityPolicy], None] | None = ...) -> ds.ContentSecurityPolicy:
    ...

@t.overload
def parse_csp_header(value: str | None, on_update: t.Callable[[ds.ContentSecurityPolicy], None] | None = ..., cls: type[_TAnyCSP] = ...) -> _TAnyCSP:
    ...

def parse_csp_header(value: str | None, on_update: t.Callable[[ds.ContentSecurityPolicy], None] | None = ..., cls: type[_TAnyCSP] | None = ...) -> _TAnyCSP:
...
def parse_set_header(value: str | None, on_update: t.Callable[[ds.HeaderSet], None] | None = ...) -> ds.HeaderSet:
...
def parse_range_header(value: str | None, make_inclusive: bool = ...) -> ds.Range | None:
...
def parse_content_range_header(value: str | None, on_update: t.Callable[[ds.ContentRange], None] | None = ...) -> ds.ContentRange | None:
...
def http_date(timestamp: datetime | date | int | float | struct_time | None = ...) -> str:
...
def dump_age(age: timedelta | int | None = ...) -> str | None:
...
def is_resource_modified(environ: WSGIEnvironment, etag: str | None = ..., data: bytes | None = ..., last_modified: datetime | str | None = ..., ignore_if_range: bool = ...) -> bool:
...
def parse_cookie(header: WSGIEnvironment | str | None, cls: type[ds.MultiDict[str, str]] | None = ...) -> ds.MultiDict[str, str]:
...
_cookie_slash_re = ...
_cookie_slash_map = ...
def dump_cookie(key: str, value: str = ..., max_age: timedelta | int | None = ..., expires: str | datetime | int | float | None = ..., path: str | None = ..., domain: str | None = ..., secure: bool = ..., httponly: bool = ..., sync_expires: bool = ..., max_size: int = ..., samesite: str | None = ..., partitioned: bool = ...) -> str:
