...
class TestEnvironment:
    ...
    @staticmethod
    def def_flag(
        name, env_var=..., default=..., include_in_repro=..., enabled_fn=..., implied_by_fn=...
    ):  # -> Literal[True]:
        ...
    @staticmethod
...
OPINFO_SAMPLE_INPUT_INDEX: int | None = ...
...
def compose_parametrize_fns(
    old_parametrize_fn, new_parametrize_fn
):  # -> Callable[..., Generator[tuple[Any, str, dict[Any, Any], Callable[..., list[Any]]], Any, None]]:
    """
...
def shell(command, cwd=..., env=..., stdout=..., stderr=..., timeout=...): ...
def retry_shell(
    command, cwd=..., env=..., stdout=..., stderr=..., timeout=..., retries=..., was_rerun=...
) -> tuple[int, bool]: ...
...
def skipIfTorchDynamo(
    msg=...,
):  # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], None] | type]:
    """
    Usage:
...
def unMarkDynamoStrictTest(cls=...):  # -> Callable[..., Any]:
    ...
def markDynamoStrictTest(
    cls_or_func=..., nopython=...
):  # -> Callable[..., type[Any] | _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]] | type[Any] | _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]:
    """
...
def skipIfLegacyJitExecutor(
    ...
    ...
def make_dynamo_test(fn: Callable[..., Any] | None = ...) -> Callable[..., Any]:
    """
...
def disable_translation_validation_if_dynamic_shapes(
    fn,
...
def numpy_to_torch_dtype(np_dtype):  # -> dtype:
    ...
...
def skipIfRocm(
    func=..., *, msg=...
):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any] | Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
    ...
def skipIfRocmArch(
    arch: tuple[str, ...],
...
def skipIfHpu(fn):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]:
    ...
def skipIfRocmVersionLessThan(
    version=...,
):  # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
    ...
def skipIfNotMiopenSuggestNHWC(
    fn,
):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]:
    ...
def skipIfWindows(
    func=..., *, msg=...
):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any] | Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
    ...
def setLinalgBackendsToDefaultFinally(
    fn,
):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]:
    ...
def setBlasBackendsToDefaultFinally(
    fn,
):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]:
    ...
...
def wrapDeterministicFlagAPITest(
    fn,
):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]:
    ...
def wrapSwapTensorsTest(
    swap=...,
):  # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]]:
    ...

class swap(_TestParametrizer):
    def __init__(self, swap_values) -> None: ...

def skipIfCompiledWithoutNumpy(
    fn,
):  # -> _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]:
    ...
...
def slowTestIf(
    condition,
):  # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]] | Callable[..., Any]:
    ...
...
def to_gpu(
    obj, type_map=...
):  # -> Tensor | list[Tensor | Any | list[Any] | tuple[Tensor | Any | list[Any] | tuple[Any, ...], ...]] | tuple[Tensor | Any | list[Any] | tuple[Any, ...], ...]:
    ...
...
class TensorOrArrayPair(TensorLikePair):
    ...
    """
    def __init__(
        self, actual, expected, *, rtol_override=..., atol_override=..., **other_parameters
    ) -> None: ...
...
class TestCase(expecttest.TestCase):
    ...
    def assertExpectedInline(
        self, actual, expect, skip=..., ignore_comments=..., ignore_empty_lines=...
    ): ...
    def assertExpectedInlineMunged(
        self, exc_type, callable, expect, *, skip=..., suppress_suffix=..., post_munge=...
    ):  # -> None:
        ...
    ...
    def genSparseCompressedTensor(
        self, size, nnz, *, layout, device, dtype, index_dtype, blocksize=..., dense_dims=...
    ):  # -> Tensor:
        ...
    def genSparseCSRTensor(
        self, size, nnz, *, device, dtype, index_dtype, dense_dims=...
    ):  # -> Tensor:
        ...
    ...
    def genSparseBSRTensor(
        self, size, blocksize, nnz, *, device, dtype, index_dtype, dense_dims=...
    ):  # -> Tensor:
        ...
    def genSparseBSCTensor(
        ...
        ...
    def genSparseTensor(
        self, size, sparse_dim, nnz, is_uncoalesced, device, dtype
    ...
    def generate_simple_inputs(
        ...
        enable_hybrid=...,
        enable_zero_sized=...,
        enable_non_contiguous_indices=...,
        enable_non_contiguous_values=...,
        enable_batch_variable_nse=...,
        output_tensor=...,
        patterns=...,
    ):
    ...
    def compare_with_numpy(
        self, torch_fn, np_fn, tensor_like, device=..., dtype=..., **kwargs
    ):  # -> None:
        ...
...
def retry_on_connect_failures(
    func=..., connect_errors=...
):  # -> partial[Any] | _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]:
    """Reruns a test if the test returns a RuntimeError and the exception
    contains one of the strings in connect_errors."""
    ...

def retry(
    ExceptionToCheck, tries=..., delay=..., skip_after_retries=...
):  # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], Any]]:
    ...
...
def random_symmetric_matrix(l, *batches, **kwargs):  # -> Tensor:
    ...
def make_symmetric_matrices(*shape, device, dtype):  # -> Tensor:
    ...
def random_hermitian_matrix(l, *batches, **kwargs):  # -> Tensor:
    ...
...
def random_symmetric_pd_matrix(matrix_size, *batch_dims, **kwargs):  # -> Tensor:
    ...
def make_symmetric_pd_matrices(*shape, device, dtype):  # -> Tensor:
    ...
def random_hermitian_pd_matrix(matrix_size, *batch_dims, dtype, device):  # -> Tensor:
    """
...
def random_lowrank_matrix(rank, rows, columns, *batch_dims, **kwargs):  # -> Tensor:
    """Return rectangular matrix or batches of rectangular matrices with
    given rank.
    """
    ...

def random_sparse_matrix(rows, columns, density=..., **kwargs):  # -> Tensor:
...
def skip_but_pass_in_sandcastle(
    reason,
):  # -> Callable[..., Any | _Wrapped[Callable[..., Any], Any, Callable[..., Any], None]]:
    """
...
def skip_but_pass_in_sandcastle_if(
    condition, reason
):  # -> Callable[..., _Wrapped[Callable[..., Any], Any, Callable[..., Any], None] | Any]:
    """
