...
class Owlv2Processor(ProcessorMixin):
    ...
    def __call__(self, images: Optional[ImageInput] = ..., text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = ..., *args, audio=..., videos=..., **kwargs: Unpack[Owlv2ProcessorKwargs]) -> BatchFeature:
        """
    ...
    def post_process_grounded_object_detection(self, outputs: Owlv2ObjectDetectionOutput, threshold: float = ..., target_sizes: Optional[Union[TensorType, List[Tuple]]] = ..., text_labels: Optional[List[List[str]]] = ...):
        """
    ...
    def post_process_image_guided_detection(self, outputs: Owlv2ImageGuidedObjectDetectionOutput, threshold: float = ..., nms_threshold: float = ..., target_sizes: Optional[Union[TensorType, List[Tuple]]] = ...):
        """
