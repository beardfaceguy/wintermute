...
class Wav2Vec2BertProcessor(ProcessorMixin):
    ...
    def __call__(self, audio: AudioInput = ..., text: Optional[Union[str, List[str], TextInput, PreTokenizedInput]] = ..., images=..., videos=..., **kwargs: Unpack[Wav2Vec2BertProcessorKwargs]):
        """
