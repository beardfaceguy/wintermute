...
class TimmWrapperModel(TimmWrapperPreTrainedModel):
    ...
    @auto_docstring
    def forward(self, pixel_values: torch.FloatTensor, output_attentions: Optional[bool] = ..., output_hidden_states: Optional[Union[bool, List[int]]] = ..., return_dict: Optional[bool] = ..., do_pooling: Optional[bool] = ..., **kwargs) -> Union[TimmWrapperModelOutput, Tuple[Tensor, ...]]:
        r"""
...
class TimmWrapperForImageClassification(TimmWrapperPreTrainedModel):
    ...
    @auto_docstring
    def forward(self, pixel_values: torch.FloatTensor, labels: Optional[torch.LongTensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[Union[bool, List[int]]] = ..., return_dict: Optional[bool] = ..., **kwargs) -> Union[ImageClassifierOutput, Tuple[Tensor, ...]]:
        r"""
