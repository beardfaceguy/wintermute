...
class OmDetTurboProcessor(ProcessorMixin):
    ...
    def __call__(self, images: ImageInput = ..., text: Optional[Union[List[str], List[List[str]]]] = ..., audio=..., videos=..., **kwargs: Unpack[OmDetTurboProcessorKwargs]) -> BatchFeature:
        """
    ...
    def post_process_grounded_object_detection(self, outputs: OmDetTurboObjectDetectionOutput, text_labels: Optional[Union[List[str], List[List[str]]]] = ..., threshold: float = ..., nms_threshold: float = ..., target_sizes: Optional[Union[TensorType, List[Tuple]]] = ..., max_num_det: Optional[int] = ...): # -> list[Any]:
        """
