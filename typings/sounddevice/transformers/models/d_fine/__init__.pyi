...
from ..rt_detr.modeling_rt_detr import RTDetrConvNormLayer, RTDetrDecoder, RTDetrDecoderLayer, RTDetrDecoderOutput, RTDetrEncoder, RTDetrForObjectDetection, RTDetrHybridEncoder, RTDetrMLPPredictionHead, RTDetrModel, RTDetrPreTrainedModel, RTDetrRepVggBlock, inverse_sigmoid
...
class DFineMultiscaleDeformableAttention(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, attention_mask: Optional[torch.Tensor] = ..., reference_points=..., encoder_hidden_states=..., spatial_shapes=..., spatial_shapes_list=...) -> tuple[torch.Tensor, torch.Tensor]:
        ...
...
class DFineDecoderLayer(RTDetrDecoderLayer):
    ...
    def forward(self, hidden_states: torch.Tensor, position_embeddings: Optional[torch.Tensor] = ..., reference_points=..., spatial_shapes=..., spatial_shapes_list=..., encoder_hidden_states: Optional[torch.Tensor] = ..., encoder_attention_mask: Optional[torch.Tensor] = ..., output_attentions: Optional[bool] = ...) -> tuple[torch.Tensor, Any, Any]:
        ...
...
class DFineDecoder(RTDetrDecoder):
    ...
    def forward(self, encoder_hidden_states: torch.Tensor, reference_points: torch.Tensor, inputs_embeds: torch.Tensor, spatial_shapes, level_start_index=..., spatial_shapes_list=..., output_hidden_states=..., encoder_attention_mask=..., memory_mask=..., output_attentions=..., return_dict=...) -> DFineDecoderOutput:
        ...
...
class DFineConvNormLayer(RTDetrConvNormLayer):
    def __init__(self, config: DFineConfig, in_channels: int, out_channels: int, kernel_size: int, stride: int, groups: int = ..., padding: Optional[int] = ..., activation: Optional[str] = ...) -> None:
        ...
...
class DFineCSPRepLayer(nn.Module):
    ...
    """
    def __init__(self, config: DFineConfig, in_channels: int, out_channels: int, num_blocks: int, expansion: float = ...) -> None:
        ...
