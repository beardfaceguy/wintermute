...
## Summary
- 5419 nodes · 10021 edges · 357 communities (294 shown, 63 thin omitted)
...
Cohesion: 0.06
Nodes (59): __pyx_array___pyx_pf_15View_dot_MemoryView_5array_12__setitem__(), __pyx_array___setitem__(), __Pyx_GetAttr3(), __Pyx_GetAttr3Default(), __pyx_getprop___pyx_array_memview(), __pyx_getprop___pyx_memoryview_base(), __pyx_getprop___pyx_memoryview_itemsize(), __pyx_getprop___pyx_memoryview_nbytes() (+51 more)
...
Cohesion: 0.07
Nodes (23): AnthropicBackend, HFLocalBackend, make_backend(), OpenAICompatBackend, str, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID, target shortcuts for frontier providers (format: <provider>:<model>):       open (+15 more)
...
Cohesion: 0.07
Nodes (21): ServeBackend, build_serving_env(), _default_endpoint_name(), _delete_endpoint(), _deploy_model(), get_hf_token(), main(), SageMaker serving backend — deploy a model to an LMI real-time endpoint.  Replac (+13 more)
...
Cohesion: 0.09
Nodes (35): CYTHON_NCP_UNUSED, _copy_strided_to_strided(), __pyx_array___cinit__(), __pyx_array___getitem__(), __pyx_array___len__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_10__getitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_6__len__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array___cinit__() (+27 more)
...
Cohesion: 0.08
Nodes (26): str, Trivial tokenizer that maps each character to its ordinal., bytes, async_session(), dummy_tokenizer(), DummyTokenizer, mock_piper_voice(), Create a temporary audio file for testing. (+18 more)
...
Cohesion: 0.07
Nodes (27): md5_digest, md5_digest, size_bytes, md5_digest, size_bytes, da_DK-talesyntese-medium, aliases, files (+19 more)
...
Cohesion: 0.10
Nodes (22): AbstractEventLoop, MagicMock, str, TestClient, Pytest configuration and fixtures for talkingHead backend tests., client(), event_loop(), mock_chat_processor() (+14 more)

### Community 69 - "Module Cluster 69"
Cohesion: 0.13
Nodes (15): CausalLMOutputWithCrossAttentions, Path, bool, int, str, Tensor, PretrainedConfig, PreTrainedModel (+7 more)
...
Cohesion: 0.18
Nodes (9): float, int, get_padding(), DDSConv, Dialted and Depth-Separable Convolution, ResBlock1, ResBlock2, ResidualCouplingLayer (+1 more)
...
Cohesion: 0.12
Nodes (17): base_train, source, train_total, val_total, arith_stabilizer_train_added, base_train, microstory_train_added, self_intro_train_added (+9 more)

### Community 92 - "Module Cluster 92"
Cohesion: 0.11
Nodes (14): Shared fixtures for titanProject tests., isolate_config_cache(), mock_embed(), mock_embed_unique(), Root-level conftest.py for the Wintermute platform test suite.  Provides shared, Create a small on-disk token cache with 3 shards for testing., Create a small text file with known content for dataset tests., Reset the shared config cache between tests so mutations don't leak. (+6 more)
...
Cohesion: 0.13
Nodes (16): oasst_best_only, oasst_max_fails_task, oasst_min_helpfulness, oasst_min_quality, reject_role_markers, filters, allow_http, max_assistant_chars (+8 more)
...
Cohesion: 0.11
Nodes (18): md5_digest, size_bytes, size_bytes, md5_digest, size_bytes, cs_CZ-jirka-medium, aliases, files (+10 more)
...
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-eva_k-x_low, aliases (+9 more)

### Community 122 - "Module Cluster 122"
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, size_bytes, md5_digest, size_bytes, en_GB-alan-low, aliases, files (+9 more)
...
Cohesion: 0.19
Nodes (15): Any, Comment, build_example(), convert_dataset(), is_bot(), is_generic_body(), is_reviewable_comment(), main() (+7 more)
...
Cohesion: 0.17
Nodes (9): fused_add_tanh_sigmoid_multiply(), init_weights(), ConvFlow, ConvReluNorm, ElementwiseAffine, piecewise_rational_quadratic_transform(), rational_quadratic_spline(), searchsorted() (+1 more)
...
Cohesion: 0.15
Nodes (13): counts, logic_val_used, oasst_train_used, oasst_val_used, openhermes_train_used, openhermes_val_used, slimorca_val_used, val_total (+5 more)
...
Cohesion: 0.18
Nodes (10): hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview, source, train_total (+2 more)

### Community 174 - "Module Cluster 174"
Cohesion: 0.18
Nodes (10): base_train_path, arith_boosters_path, arith_train_added, base_train, base_val, intro_boosters_path, intro_train_added, source (+2 more)
...
Cohesion: 0.29
Nodes (9): Path, _load_and_merge(), main(), merge_adapter(), Merge a LoRA adapter into its base model to produce a standalone HF model dir., Return base_model_name_or_path from an adapter's adapter_config.json., Heavy seam: load base + adapter, merge, return (model, tokenizer).      NOTE: lo, Merge a LoRA adapter into its base model and save to output_dir.      base_model (+1 more)
...
Cohesion: 0.25
Nodes (7): base_train, curated_train_added, curated_val_added, train_total, val_total, base_val, source
...
Cohesion: 0.25
Nodes (7): de_DE-karlsson-low, aliases, key, name, num_speakers, quality, speaker_id_map
...
Cohesion: 0.33
Nodes (7): dag_retrieval, llm_timeout, max_tokens, frequency_penalty, temperature, top_p, inference
...
## Knowledge Gaps
- **1294 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1289 more)
...
- **Why does `PiperVoice` connect `Module Cluster 75` to `Module Cluster 67`, `Module Cluster 68`, `Module Cluster 134`, `Module Cluster 42`, `Module Cluster 144`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `AsyncMock` connect `Module Cluster 27` to `Module Cluster 68`, `DAG Query Retrieval`, `Module Cluster 46`, `Module Cluster 80`, `Module Cluster 49`, `talkingHead FastAPI Backend`, `Module Cluster 29`, `Module Cluster 88`, `Module Cluster 61`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 37` to `Module Cluster 38`, `Module Cluster 41`, `Module Cluster 43`, `MCP Memory Server`, `SFT Fine-Tuning Pipeline`, `TTS Voice Subsystem`, `Module Cluster 120`?**
