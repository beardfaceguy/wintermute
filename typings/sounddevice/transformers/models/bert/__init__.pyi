...
from tensorflow_text import BertTokenizer as BertTokenizerLayer, FastBertTokenizer, ShrinkLongestTrimmer, case_fold_utf8, combine_segments, pad_model_inputs
...
class TFBertTokenizer(keras.layers.Layer):
    ...
    Args:
        ...
        use_fast_bert_tokenizer (`bool`, *optional*, defaults to `True`):
            ...
            TFLite.
    """
    def __init__(self, vocab_list: List, do_lower_case: bool, cls_token_id: Optional[int] = ..., sep_token_id: Optional[int] = ..., pad_token_id: Optional[int] = ..., padding: str = ..., truncation: bool = ..., max_length: int = ..., pad_to_multiple_of: Optional[int] = ..., return_token_type_ids: bool = ..., return_attention_mask: bool = ..., use_fast_bert_tokenizer: bool = ..., **tokenizer_kwargs) -> None:
        ...
