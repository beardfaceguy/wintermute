...
class Siglip2Processor(ProcessorMixin):
    ...
    def __call__(self, images: Optional[Union[ImageInput, List[ImageInput], List[List[ImageInput]]]] = ..., text: Optional[Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]]] = ..., audio=..., videos=..., **kwargs: Unpack[Siglip2ProcessorKwargs]) -> BatchFeature:
        """
