...
class SeamlessM4Tv2SinusoidalPositionalEmbedding(nn.Module):
    ...
    @torch.no_grad()
    def forward(self, input_ids: Optional[torch.Tensor] = ..., inputs_embeds: Optional[torch.Tensor] = ..., past_key_values_length: int = ...): # -> Tensor | Any:
        ...
...
class SeamlessM4Tv2Attention(nn.Module):
    ...
    def __init__(self, embed_dim: int, num_heads: int, dropout: float = ..., is_decoder: bool = ..., bias: bool = ..., is_causal: bool = ..., config: Optional[SeamlessM4Tv2Config] = ..., layer_idx: Optional[int] = ...) -> None:
        ...
...
class SeamlessM4Tv2Encoder(SeamlessM4Tv2PreTrainedModel):
    ...
    def forward(self, input_ids: Optional[torch.LongTensor] = ..., attention_mask: Optional[torch.Tensor] = ..., inputs_embeds: Optional[torch.FloatTensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., **kwargs) -> Union[Tuple, BaseModelOutput]:
        r"""
        Args:
...
class SeamlessM4Tv2TextToUnitDecoder(SeamlessM4Tv2PreTrainedModel):
    ...
    def forward(self, char_input_ids: Optional[torch.LongTensor] = ..., char_count_per_id: Optional[torch.LongTensor] = ..., encoder_hidden_states: Optional[torch.FloatTensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...) -> Union[Tuple, SeamlessM4Tv2TextToUnitDecoderOutput]:
        r"""
        Args:
...
__all__ = ["SeamlessM4Tv2ForTextToSpeech", "SeamlessM4Tv2ForSpeechToSpeech", "SeamlessM4Tv2ForTextToText", "SeamlessM4Tv2ForSpeechToText", "SeamlessM4Tv2Model", "SeamlessM4Tv2PreTrainedModel"]
