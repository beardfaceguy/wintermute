...
from typing import Any, Callable, Dict, Iterable, Iterator, List, Literal, Optional, Type, TypeVar, Union
...
class MapDataPipe(Dataset[_T_co], metaclass=_DataPipeMeta):
    ...
    def shuffle(self, *, indices: Optional[list] = ...) -> IterDataPipe:
        r"""
...
class IterDataPipe(IterableDataset[_T_co], metaclass=_IterDataPipeMeta):
    ...
    def collate(self, conversion: Union[Callable[..., Any], dict[Union[str, Any], Union[Callable, Any]], None] = ..., collate_fn: Optional[Callable] = ...) -> IterDataPipe:
        r"""
    ...
    def demux(self, num_instances: int, classifier_fn: Callable[[_T_co], Optional[int]], drop_none: bool = ..., buffer_size: int = ...) -> List[IterDataPipe]:
        r"""
    ...
    def fork(self, num_instances: int, buffer_size: int = ..., copy: Optional[Literal["shallow", "deep"]] = ...) -> List[IterDataPipe]:
        r"""
    ...
    def groupby(self, group_key_fn: Callable[[_T_co], Any], *, keep_key: bool = ..., buffer_size: int = ..., group_size: Optional[int] = ..., guaranteed_group_size: Optional[int] = ..., drop_remaining: bool = ...) -> IterDataPipe:
        r"""
    ...
    def list_files(self, masks: Union[str, list[str]] = ..., *, recursive: bool = ..., abspath: bool = ..., non_deterministic: bool = ..., length: int = ...) -> IterDataPipe:
        r"""
    ...
    def open_files(self, mode: str = ..., encoding: Optional[str] = ..., length: int = ...) -> IterDataPipe:
        r"""
    ...
    def read_from_stream(self, chunk: Optional[int] = ...) -> IterDataPipe:
        r"""
