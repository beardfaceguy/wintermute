...
class TransfoXLTokenizer(PreTrainedTokenizer):
    ...
    vocab_files_names = ...
    model_input_names = ...
    def __init__(self, special=..., min_freq=..., max_size=..., lower_case=..., delimiter=..., vocab_file=..., pretrained_vocab_file: Optional[str] = ..., never_split=..., unk_token=..., eos_token=..., additional_special_tokens=..., language=..., **kwargs) -> None:
        ...
