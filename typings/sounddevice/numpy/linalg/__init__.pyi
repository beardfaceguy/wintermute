...
from typing import Any, Literal as L, NamedTuple, SupportsIndex, SupportsInt, TypeAlias, TypeVar, overload
from numpy import complex128, complexfloating, float64, floating, int32, object_, signedinteger, timedelta64, unsignedinteger, vecdot
...
@overload
def cholesky(a: _ArrayLikeFloat_co, /, *, upper: bool = ...) -> NDArray[floating[Any]]:
    ...

@overload
def cholesky(a: _ArrayLikeComplex_co, /, *, upper: bool = ...) -> NDArray[complexfloating[Any, Any]]:
    ...
...
@overload
def cross(x1: _ArrayLikeUInt_co, x2: _ArrayLikeUInt_co, /, *, axis: int = ...) -> NDArray[unsignedinteger[Any]]:
    ...

@overload
def cross(x1: _ArrayLikeInt_co, x2: _ArrayLikeInt_co, /, *, axis: int = ...) -> NDArray[signedinteger[Any]]:
    ...

@overload
def cross(x1: _ArrayLikeFloat_co, x2: _ArrayLikeFloat_co, /, *, axis: int = ...) -> NDArray[floating[Any]]:
    ...

@overload
def cross(x1: _ArrayLikeComplex_co, x2: _ArrayLikeComplex_co, /, *, axis: int = ...) -> NDArray[complexfloating[Any, Any]]:
    ...
