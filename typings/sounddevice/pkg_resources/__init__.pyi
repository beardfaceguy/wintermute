...
class WorkingSet:
    ...
    def add(
        self, dist: Distribution, entry: str | None = ..., insert: bool = ..., replace: bool = ...
    ) -> None:
...
class Environment:
    ...
    @overload
    def obtain(
        self, requirement: Requirement, installer: Callable[[Requirement], None] | None = ...
    ) -> None: ...
    @overload
    def obtain(
...
def null_ns_handler(
    importer: object, path_item: str | None, packageName: str | None, module: _ModuleLike | None
) -> None: ...
@overload
