...
class Emu3Processor(ProcessorMixin):
    ...
    def __call__(self, images: Optional[ImageInput] = ..., text: Optional[Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]]] = ..., audio=..., videos=..., **kwargs: Unpack[Emu3ProcessorKwargs]) -> BatchFeature:
        """
