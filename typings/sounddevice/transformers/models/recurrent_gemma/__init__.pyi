...
class RecurrentGemmaDecoderLayer(nn.Module):
    ...
    def forward(self, activations: torch.Tensor, position_ids: torch.Tensor, attention_mask: torch.Tensor, cache_position: Optional[torch.Tensor] = ..., use_cache: Optional[bool] = ...) -> Tuple[torch.Tensor, Dict[str, torch.Tensor]]:
        ...
