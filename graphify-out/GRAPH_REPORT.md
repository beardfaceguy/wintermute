...
## Summary
- 5354 nodes · 9920 edges · 344 communities (280 shown, 64 thin omitted)
...
## Communities (344 total, 64 thin omitted)
...
Cohesion: 0.04
Nodes (65): BaseBenchmark, Run the benchmark against model and return a BenchmarkResult., _answer_matches(), Loose match: expected answer appears in response (case-insensitive)., _parse_answer(), MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac, subjects:         list of MMLU subject names, or None for all 57         max_per, _is_refusal() (+57 more)
...
Cohesion: 0.05
Nodes (64): de_DE-eva_k-x_low, aliases, key, language, name, num_speakers, quality, language (+56 more)
...
Cohesion: 0.10
Nodes (45): _embed(), _ensure_hnsw_index(), _ensure_tables(), _entry_to_dict(), _get_embedder(), memory_add(), memory_flag(), memory_promote() (+37 more)
...
Cohesion: 0.10
Nodes (30): bool, device, float, int, Path, str, TestIsMain, TestReduceScalar (+22 more)
...
Cohesion: 0.08
Nodes (14): AnthropicBackend, HFLocalBackend, make_backend(), OpenAICompatBackend, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID, target shortcuts for frontier providers (format: <provider>:<model>):       open, Talks to any /v1/chat/completions endpoint.      base_url examples:       "http: (+6 more)

### Community 33 - "Module Cluster 33"
Cohesion: 0.07
Nodes (27): _cleanup(), _init_gloo(), Tests for distributed training utilities: DDP helpers, data sharding, grad accum, Only rank 0 should produce log output., total_tokens_seen should account for all GPUs., Checkpoints saved from DDP (model.module) should load into bare models., Simulate DDP: wrap model, save model.module, reload into bare model., raw_model.state_dict() should not have 'module.' prefix. (+19 more)
...
Cohesion: 0.10
Nodes (14): generate_pentest_report(), str, bool, float, int, str, DiscriminatorP, DiscriminatorS (+6 more)

### Community 36 - "Module Cluster 36"
Cohesion: 0.11
Nodes (24): CausalLMOutputWithCrossAttentions, bool, device, int, object, str, bool, int (+16 more)
...
Cohesion: 0.08
Nodes (23): Shared fixtures for titanProject tests., Trivial tokenizer that maps each character to its ordinal., dummy_tokenizer(), DummyTokenizer, mock_piper_voice(), Create a small on-disk token cache with 3 shards for testing., Create a temporary audio file for testing., Sample text for testing. (+15 more)

### Community 46 - "Module Cluster 46"
Cohesion: 0.08
Nodes (30): AbstractEventLoop, MagicMock, str, TestClient, Pytest configuration and fixtures for talkingHead backend tests., async_session(), client(), event_loop() (+22 more)
...
Cohesion: 0.07
Nodes (29): logic_val_used, oasst_train_used, openhermes_val_used, slimorca_train_used, slimorca_val_used, train_total, val_total, filters (+21 more)
...
Cohesion: 0.11
Nodes (18): main(), # NOTE: audio is already in [-1, 1] coming from librosa, rand_slice_segments(), slice_segments(), discriminator_loss(), feature_loss(), generator_loss(), kl_loss() (+10 more)
...
Cohesion: 0.08
Nodes (26): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, da_DK-talesyntese-medium, aliases (+18 more)
...
Cohesion: 0.11
Nodes (25): __pyx_align_pointer(), __Pyx__ArgTypeTest(), __pyx_array___cinit__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array___cinit__(), __Pyx_div_Py_ssize_t(), __pyx_fill_contig_strides_array(), __Pyx_InBases(), __Pyx_IsSubtype() (+17 more)
...
Cohesion: 0.13
Nodes (23): CYTHON_NCP_UNUSED, _copy_strided_to_strided(), __pyx_array___len__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_6__len__(), __Pyx_GetItemInt_Fast(), __Pyx_GetItemInt_Generic(), __Pyx_GetItemInt_List_Fast(), __Pyx_GetItemInt_Tuple_Fast() (+15 more)
...
Cohesion: 0.13
Nodes (15): int, add_timing_signal_1d(), cat_timing_signal_1d(), fused_add_tanh_sigmoid_multiply(), generate_path(), get_padding(), get_timing_signal_1d(), init_weights() (+7 more)
...
Cohesion: 0.13
Nodes (18): Store a conversation exchange in mcp-memory as a 'live' entry.      Tags the ent, Semantic search over mcp-memory for context relevant to the query.      Args:, search_relevant_memories(), store_conversation(), Any, bool, float, int (+10 more)
...
Cohesion: 0.21
Nodes (7): float, int, ConvReluNorm, DDSConv, ElementwiseAffine, Dialted and Depth-Separable Convolution, WN
...
Cohesion: 0.12
Nodes (17): agents, default_llm_port, default_model, max_iterations, temperature, dag_retrieval, llm_timeout, frequency_penalty (+9 more)
...
Cohesion: 0.19
Nodes (17): __Pyx_Import(), __Pyx_ImportFrom(), __pyx_memoryview_assign_item_from_object(), __pyx_memoryview_convert_item_to_object(), __pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview_12__repr__(), __pyx_memoryview___repr__(), __pyx_pf_15View_dot_MemoryView___pyx_unpickle_Enum(), __Pyx_PyCFunction_FastCall() (+9 more)

### Community 118 - "Module Cluster 118"
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, ca_ES-upc_ona-x_low, aliases, files (+9 more)

### Community 119 - "Module Cluster 119"
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, ca_ES-upc_pau-x_low, aliases (+9 more)
...
Cohesion: 0.25
Nodes (14): bool, str, main(), Run pytest with the given pattern., run_integration_tests(), run_specific_test(), run_tests(), Run integration tests only. (+6 more)
...
Cohesion: 0.14
Nodes (13): base_train, base_val, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview (+5 more)
...
Cohesion: 0.15
Nodes (12): arith_boosters_path, arith_train_added, intro_boosters_path, intro_train_added, source, story_boosters_path, train_total, val_total (+4 more)
...
Cohesion: 0.18
Nodes (12): codereview, host, paths, port, scheme, batch, health, review (+4 more)
...
Cohesion: 0.38
Nodes (5): ConvFlow, piecewise_rational_quadratic_transform(), rational_quadratic_spline(), searchsorted(), unconstrained_rational_quadratic_spline()
...
Cohesion: 0.40
Nodes (5): _is_read_only(), Run EXPLAIN ANALYZE on a query and return the execution plan.      Args:, Reject obviously mutating statements before they hit the DB., sql_explain(), bool
...
## Knowledge Gaps
- **1290 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1285 more)
...
- **Why does `PiperVoice` connect `Module Cluster 76` to `Module Cluster 128`, `Module Cluster 70`, `Module Cluster 137`, `Module Cluster 45`, `Module Cluster 46`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `AsyncMock` connect `PostgreSQL MCP Server` to `Module Cluster 160`, `HuggingFace Model Utilities`, `Cython C Extensions`, `Module Cluster 39`, `Module Cluster 46`, `Module Cluster 80`, `SQL Agent & Test Harness`, `Module Cluster 86`, `talkingHead WebSocket & TTS`, `Module Cluster 63`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 42` to `Module Cluster 43`, `Module Cluster 49`, `talkingHead FastAPI Backend`, `Module Cluster 116`, `TTS Voice Subsystem`, `Eval Benchmark Adapters`, `Module Cluster 26`?**
