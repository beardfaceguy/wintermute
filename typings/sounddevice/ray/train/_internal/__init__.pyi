...
from ray.train._internal.syncer import SyncConfig, _BackgroundSyncer
...
class _ExcludingLocalFilesystem(LocalFileSystem):
    ...
    def fsid(self):  # -> Literal['_excluding_local']:
        ...
    def find(
        self, path, maxdepth=..., withdirs=..., detail=..., **kwargs
    ):  # -> dict[Any, Any] | list[Any]:
        """Call parent find() and exclude from result."""
        ...

def get_fs_and_path(
    storage_path: str | os.PathLike, storage_filesystem: pyarrow.fs.FileSystem | None = ...
...
class _FilesystemSyncer(_BackgroundSyncer):
    ...
    def __init__(self, storage_filesystem: pyarrow.fs.FileSystem | None, **kwargs) -> None: ...
...
class StorageContext:
    ...
    def __init__(
        ...
        storage_filesystem: pyarrow.fs.FileSystem | None = ...,
    ...
    @staticmethod
    def get_experiment_dir_name(run_obj: str | Callable | type) -> str: ...
