...
class Kosmos2Processor(ProcessorMixin):
    ...
    def __call__(self, images: ImageInput = ..., text: Union[TextInput, List[TextInput]] = ..., audio=..., videos=..., **kwargs: Unpack[Kosmos2ProcessorKwargs]) -> BatchFeature:
        """
    ...
    def post_process_generation(self, text, cleanup_and_extract=...): # -> tuple[Any, list[Any]]:
        ...
    
    def post_process_image_text_to_text(self, generated_outputs, skip_special_tokens=..., **kwargs): # -> list[tuple[Any, list[Any]] | Any]:
        """
...
def clean_text_and_extract_entities_with_bboxes(text, num_patches_per_side=...): # -> tuple[Any, list[Any]]:
