...
from ...image_utils import ImageInput, load_images
...
class GotOcr2Processor(ProcessorMixin):
    ...
    def __call__(self, images: Optional[ImageInput] = ..., text: Optional[Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]]] = ..., audio=..., videos=..., **kwargs: Unpack[GotOcr2ProcessorKwargs]) -> BatchFeature:
        """
