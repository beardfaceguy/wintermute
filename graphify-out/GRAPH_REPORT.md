...
## Summary
- 5364 nodes · 9952 edges · 350 communities (288 shown, 62 thin omitted)
...
## Communities (350 total, 62 thin omitted)
...
Cohesion: 0.05
Nodes (63): ca_ES-upc_ona-medium, aliases, key, language, name, num_speakers, ca_ES-upc_ona-x_low, aliases (+55 more)
...
Cohesion: 0.05
Nodes (50): Allocator, compares_unordered, adl_serializer, boolean(), clear(), dump_integer(), get_error_message(), get_number_float() (+42 more)
...
Cohesion: 0.07
Nodes (24): AnthropicBackend, HFLocalBackend, make_backend(), OpenAICompatBackend, str, Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID (+16 more)
...
Cohesion: 0.13
Nodes (28): back(), get_token_string(), handle_value(), json_sax_acceptor, json_sax_dom_callback_parser, allow_exceptions, callback, discarded (+20 more)
...
Cohesion: 0.10
Nodes (26): bool, float, int, Path, setup_distributed() fallback behavior without torchrun., cleanup should not raise when no process group is initialized., TestIsMain, TestReduceScalar (+18 more)
...
Cohesion: 0.10
Nodes (18): device, str, Tests for training utilities: LR schedules, path resolution, hashing, checkpoint, TokenizerAdapter encode/decode contract., S3 tokenizer downloads must not collide when only the basename matches., Two S3 URIs with the same filename but different prefixes must         download, Path resolution logic., TestGetTokenizerS3PathCollision (+10 more)
...
Cohesion: 0.08
Nodes (26): Trivial tokenizer that maps each character to its ordinal., async_session(), dummy_tokenizer(), DummyTokenizer, mock_piper_voice(), Create a temporary audio file for testing., Create a sample audio file for testing voice upload., Sample text for testing. (+18 more)
...
Cohesion: 0.15
Nodes (14): bool, DataLoader, int, Path, str, Cache key generation and helper functions., TestCacheUtilities, build_cache_key() (+6 more)
...
Cohesion: 0.08
Nodes (24): md5_digest, size_bytes, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest (+16 more)
...
Cohesion: 0.12
Nodes (17): train_total, arith_stabilizer_train_added, self_intro_train_added, train_total, val_copied_from, val_total, base_train, microstory_train_added (+9 more)
...
Cohesion: 0.24
Nodes (10): bool, float, int, str, Decoder, Encoder, FFN, x: decoder input         h: encoder output (+2 more)

### Community 91 - "Module Cluster 91"
Cohesion: 0.13
Nodes (14): int, add_timing_signal_1d(), cat_timing_signal_1d(), fused_add_tanh_sigmoid_multiply(), generate_path(), get_timing_signal_1d(), init_weights(), rand_gumbel() (+6 more)

### Community 92 - "Module Cluster 92"
Cohesion: 0.15
Nodes (10): ConvFlow, ConvReluNorm, ElementwiseAffine, ResBlock1, ResBlock2, ResidualCouplingLayer, piecewise_rational_quadratic_transform(), rational_quadratic_spline() (+2 more)
...
Cohesion: 0.11
Nodes (18): speaker_id_map, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, en_GB-alan-medium (+10 more)
...
Cohesion: 0.11
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-karlsson-low, aliases (+9 more)
...
Cohesion: 0.17
Nodes (18): allow_http, max_user_chars, oasst_best_only, oasst_max_fails_task, oasst_min_helpfulness, filters, max_assistant_chars, max_digit_ratio (+10 more)
...
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-thorsten-high, aliases (+9 more)
...
Cohesion: 0.25
Nodes (14): bool, str, Run pytest with the given pattern., run_integration_tests(), run_specific_test(), run_tests(), Run integration tests only., Run a specific test file. (+6 more)
...
Cohesion: 0.17
Nodes (12): md5_digest, size_bytes, md5_digest, md5_digest, size_bytes, md5_digest, size_bytes, files (+4 more)
...
Cohesion: 0.18
Nodes (11): logic_train_used, oasst_train_used, oasst_val_used, openhermes_train_used, openhermes_val_used, train_total, val_total, counts (+3 more)
...
Cohesion: 0.25
Nodes (8): mcp_memory, default_db_url, port, rag, device, embed_model, live_data_dir, storage_dir
...
Cohesion: 0.25
Nodes (7): base_train, base_val, curated_train_added, curated_val_added, train_total, val_total, source
...
Cohesion: 0.38
Nodes (5): train, output_format, paths, val, seed

### Community 219 - "Module Cluster 219"
Cohesion: 0.29
Nodes (6): base_train, source, story_train_added, story_val_added, train_total, val_total
...
Cohesion: 0.33
Nodes (4): Checkpoints saved from DDP (model.module) should load into bare models., Simulate DDP: wrap model, save model.module, reload into bare model., raw_model.state_dict() should not have 'module.' prefix., TestDDPCheckpointPortability
...
## Knowledge Gaps
- **1284 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1279 more)
...
- **Why does `AsyncMock` connect `Module Cluster 28` to `HuggingFace Model Utilities`, `Module Cluster 38`, `Cython C Extensions`, `Module Cluster 49`, `Module Cluster 83`, `Model Training Data`, `Module Cluster 54`, `Eval Benchmark Adapters`, `Module Cluster 57`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `ModelConfig` connect `Module Cluster 76` to `Module Cluster 136`, `Module Cluster 137`, `Module Cluster 140`, `TTS Voice Subsystem`, `Module Cluster 29`, `Module Cluster 158`, `Module Cluster 159`, `Module Cluster 33`, `Module Cluster 34`, `Module Cluster 167`, `Module Cluster 45`, `Module Cluster 175`, `Module Cluster 186`, `Module Cluster 192`, `Module Cluster 64`, `Module Cluster 196`, `Module Cluster 197`, `Module Cluster 81`, `Module Cluster 95`, `Module Cluster 229`, `Module Cluster 233`, `Module Cluster 115`, `Module Cluster 117`, `Module Cluster 127`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 40` to `Module Cluster 34`, `Module Cluster 41`, `Module Cluster 46`, `PostgreSQL MCP Server`, `SQL Agent & Test Harness`, `Module Cluster 118`, `Shared Config & Utilities`?**
