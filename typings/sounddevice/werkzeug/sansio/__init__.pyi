...
from ..datastructures import CallbackDict, ContentRange, ContentSecurityPolicy, HeaderSet, Headers, ResponseCacheControl, WWWAuthenticate
from ..http import COEP, COOP, HTTP_STATUS_CODES, dump_age, dump_cookie, dump_header, dump_options_header, http_date, parse_age, parse_cache_control_header, parse_content_range_header, parse_csp_header, parse_date, parse_options_header, parse_set_header, quote_etag, unquote_etag
...
class Response:
    ...
    max_cookie_size = ...
    headers: Headers
    def __init__(self, status: int | str | HTTPStatus | None = ..., headers: t.Mapping[str, str | t.Iterable[str]] | t.Iterable[tuple[str, str]] | None = ..., mimetype: str | None = ..., content_type: str | None = ...) -> None:
        ...
    ...
    def set_cookie(self, key: str, value: str = ..., max_age: timedelta | int | None = ..., expires: str | datetime | int | float | None = ..., path: str | None = ..., domain: str | None = ..., secure: bool = ..., httponly: bool = ..., samesite: str | None = ..., partitioned: bool = ...) -> None:
        """Sets a cookie.
    ...
    def delete_cookie(self, key: str, path: str | None = ..., domain: str | None = ..., secure: bool = ..., httponly: bool = ..., samesite: str | None = ..., partitioned: bool = ...) -> None:
