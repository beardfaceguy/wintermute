...
## Summary
- 5428 nodes · 10062 edges · 345 communities (282 shown, 63 thin omitted)
...
## Communities (345 total, 63 thin omitted)
...
Cohesion: 0.04
Nodes (70): BaseBenchmark, Run the benchmark against model and return a BenchmarkResult., _answer_matches(), LoCoMo — Long-Context Conversation Memory Dataset: snap-research/LoCoMo Metric:, Loose match: expected answer appears in response (case-insensitive)., _letters(), _parse_single(), TruthfulQA Dataset: truthful_qa (mc1 and mc2 configs) Metric:  mc1_accuracy (sin (+62 more)
...
Cohesion: 0.05
Nodes (62): ca_ES-upc_ona-medium, aliases, key, language, num_speakers, quality, speaker_id_map, ca_ES-upc_pau-x_low (+54 more)
...
Cohesion: 0.07
Nodes (25): ABC, Base class all benchmark adapters inherit from., Popen, ServeBackend — the interface every serving backend implements.  A backend provis, Describes a provisioned model endpoint.      base_url      — set for OpenAI-comp, Return an eval.model.OpenAICompatBackend for OpenAI-compatible backends., Provision model_ref and return a handle to reach it., Tear down a previously deployed endpoint. (+17 more)
...
Cohesion: 0.07
Nodes (34): bool, float, int, Path, Each rank should see a mostly-disjoint shard of the dataset.          Distribute, Union of all rank indices should cover the full dataset (with possible padding)., DistributedSampler.set_epoch changes shuffling order., setup_distributed() fallback behavior without torchrun. (+26 more)
...
Cohesion: 0.08
Nodes (29): bool, float, int, Path, str, device, str, Tests for training utilities: LR schedules, path resolution, hashing, checkpoint (+21 more)
...
Cohesion: 0.06
Nodes (16): _parse(), _extract_answer(), _normalize(), GSM8K — Grade School Math Dataset: openai/gsm8k Metric:  accuracy (exact final n, Pull the final numeric answer out of a model response., _parse(), str, str (+8 more)
...
Cohesion: 0.07
Nodes (33): AbstractEventLoop, str, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests., async_session(), client(), event_loop() (+25 more)
...
Cohesion: 0.09
Nodes (24): Trivial tokenizer that maps each character to its ordinal., dummy_tokenizer(), DummyTokenizer, mock_piper_voice(), Create a temporary audio file for testing., Create a sample audio file for testing voice upload., Sample text for testing., Sample phonemes for testing. (+16 more)
...
Cohesion: 0.08
Nodes (26): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-kerstin-low, aliases (+18 more)
...
Cohesion: 0.11
Nodes (16): Path, _load_and_merge(), main(), merge_adapter(), Merge a LoRA adapter into its base model to produce a standalone HF model dir., Return base_model_name_or_path from an adapter's adapter_config.json., Heavy seam: load base + adapter, merge, return (model, tokenizer)., Merge a LoRA adapter into its base model and save to output_dir.      base_model (+8 more)
...
Cohesion: 0.17
Nodes (9): float, int, fused_add_tanh_sigmoid_multiply(), get_padding(), DDSConv, Dialted and Depth-Separable Convolution, ResBlock1, ResBlock2 (+1 more)
...
Cohesion: 0.12
Nodes (17): train, output_format, paths, val, seed, base_train, microstory_train_added, source (+9 more)
...
Cohesion: 0.11
Nodes (18): name, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, el_GR-rapunzelina-low (+10 more)
...
Cohesion: 0.10
Nodes (18): md5_digest, size_bytes, size_bytes, md5_digest, size_bytes, files, speaker_id_map, en/en_GB/alan/medium/en_GB-alan-medium.onnx (+10 more)
...
Cohesion: 0.17
Nodes (18): allow_http, max_assistant_chars, oasst_max_fails_task, oasst_max_spam, oasst_min_quality, filters, max_digit_ratio, max_user_chars (+10 more)
...
Cohesion: 0.13
Nodes (15): da_DK-talesyntese-medium, aliases, key, language, name, num_speakers, quality, speaker_id_map (+7 more)
...
Cohesion: 0.14
Nodes (15): codereview, host, paths, batch, health, review, vllm, host (+7 more)
...
Cohesion: 0.25
Nodes (14): bool, str, main(), Run pytest with the given pattern., Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments., Run integration tests. (+6 more)

### Community 131 - "Module Cluster 131"
Cohesion: 0.18
Nodes (11): int, add_timing_signal_1d(), cat_timing_signal_1d(), generate_path(), get_timing_signal_1d(), rand_gumbel(), rand_gumbel_like(), duration: [b, 1, t_x]     mask: [b, 1, t_y, t_x] (+3 more)
...
Cohesion: 0.15
Nodes (12): base_val, curated_train_added, curated_val_added, source, train_total, val_total, story_train_added, base_train (+4 more)
...
Cohesion: 0.15
Nodes (13): logic_val_used, oasst_train_used, openhermes_train_used, slimorca_val_used, train_total, val_total, counts, logic_train_used (+5 more)
...
Cohesion: 0.18
Nodes (10): base_train, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview, train_total (+2 more)
...
Cohesion: 0.20
Nodes (10): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, files, size_bytes, cs/cs_CZ/jirka/medium/cs_CZ-jirka-medium.onnx (+2 more)
...
Cohesion: 0.50
Nodes (3): _parse(), ARC Challenge — AI2 Reasoning Challenge (hard subset) Dataset: allenai/ARC (ARC-, str
...
- **Why does `PiperVoice` connect `Module Cluster 73` to `Module Cluster 68`, `Module Cluster 39`, `Module Cluster 137`, `Module Cluster 53`, `Module Cluster 124`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `AsyncMock` connect `Model Training Data` to `HuggingFace Model Utilities`, `Cython C Extensions`, `Module Cluster 39`, `Module Cluster 40`, `Module Cluster 78`, `Module Cluster 86`, `Eval Benchmark Adapters`, `Module Cluster 157`, `Module Cluster 30`, `Module Cluster 63`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 45` to `Module Cluster 46`, `Module Cluster 49`, `Module Cluster 114`, `SQL Agent & Test Harness`, `Shared Config & Utilities`, `Module Cluster 26`, `Module Cluster 28`?**
