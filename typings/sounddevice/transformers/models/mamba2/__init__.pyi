...
class Mamba2Cache:
    ...
    def update_conv_state(self, layer_idx: int, new_conv_state: torch.Tensor, cache_init: bool = ...) -> torch.Tensor:
        ...
...
class Mamba2Mixer(nn.Module):
    ...
    def torch_forward(self, hidden_states: torch.Tensor, cache_params: Optional[Mamba2Cache] = ..., cache_position: Optional[torch.LongTensor] = ..., attention_mask: Optional[torch.Tensor] = ...): # -> Any:
        ...
