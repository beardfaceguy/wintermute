...
class Phi4MultimodalProcessor(ProcessorMixin):
    ...
    def __call__(self, text: Union[TextInput, List[TextInput]], images: Optional[ImageInput] = ..., audio: Optional[AudioInput] = ..., **kwargs: Unpack[ProcessingKwargs]) -> BatchFeature:
        """
