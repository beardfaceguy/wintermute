...
## Summary
- 5377 nodes · 9971 edges · 349 communities (285 shown, 64 thin omitted)
...
## Communities (349 total, 64 thin omitted)
...
Cohesion: 0.08
Nodes (38): bool, Path, bool, device, float, int, Path, str (+30 more)
...
Cohesion: 0.11
Nodes (20): Batch, DataLoader, bool, float, int, Path, str, Batch (+12 more)
...
Cohesion: 0.09
Nodes (19): bool, float, int, Tensor, get_padding(), ConvFlow, ConvReluNorm, DDSConv (+11 more)
...
Cohesion: 0.07
Nodes (27): AbstractEventLoop, Shared fixtures for titanProject tests., str, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests., client(), event_loop() (+19 more)
...
Cohesion: 0.14
Nodes (15): bool, float, int, str, Decoder, Encoder, FFN, MultiHeadAttention (+7 more)
...
Cohesion: 0.07
Nodes (27): md5_digest, md5_digest, size_bytes, md5_digest, size_bytes, ca_ES-upc_ona-medium, aliases, files (+19 more)
...
Cohesion: 0.13
Nodes (14): Dataset, AdjDocs, eval_depths(), main(), Salvage test for #952 option 4: MQAR-in-text — is the text-recall failure caused, [filler] KEY VALUE [filler] KEY -> VALUE. KEY unique (absent from filler)., eval_depths(), load_filler() (+6 more)
...
Cohesion: 0.10
Nodes (20): en_GB-aru-medium, aliases, key, language, name, num_speakers, quality, speaker_id_map (+12 more)
...
Cohesion: 0.11
Nodes (18): size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, cs_CZ-jirka-medium, aliases, files (+10 more)
...
Cohesion: 0.17
Nodes (18): filters, max_assistant_chars, max_user_chars, oasst_best_only, oasst_max_spam, reject_role_markers, filters, allow_http (+10 more)
...
Cohesion: 0.12
Nodes (17): size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, da_DK-talesyntese-medium, aliases, files (+9 more)
...
Cohesion: 0.25
Nodes (14): bool, int, Run pytest with the given pattern., run_tests(), run_unit_tests(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments. (+6 more)
...
Cohesion: 0.20
Nodes (10): str, Should accept 'content', 'value', and 'text' keys., TestFormatMessagesAsChat, _format_messages_as_chat(), _get_boundary_tokens(), _maybe_enable_hf_gradient_checkpointing(), SFT finetuning loop for Titans checkpoints and HuggingFace causal LMs.  Accepts, Enable HF gradient checkpointing to cut activation VRAM (needed for 7B full FT o (+2 more)
...
Cohesion: 0.18
Nodes (11): microstory_train_added, source, val_total, arith_stabilizer_train_added, base_train, self_intro_train_added, source, train_total (+3 more)
...
Cohesion: 0.17
Nodes (12): logic_val_used, oasst_train_used, oasst_val_used, openhermes_train_used, train_total, val_total, counts, logic_train_used (+4 more)
...
Cohesion: 0.18
Nodes (10): base_train, base_val, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview (+2 more)

### Community 162 - "Module Cluster 162"
Cohesion: 0.18
Nodes (10): base_train_path, arith_boosters_path, arith_train_added, base_val_path, intro_boosters_path, intro_train_added, source, story_boosters_path (+2 more)
...
Cohesion: 0.22
Nodes (9): codereview, host, paths, scheme, batch, health, review, talkingHead (+1 more)
...
Cohesion: 0.39
Nodes (4): int, Path, TestMaskedSFTDatasetFormats, MaskedSFTDataset
...
Cohesion: 0.32
Nodes (8): vllm, host, model, port, web_interface, path, port, scheme
...
Cohesion: 0.25
Nodes (7): train_total, arith_stabilizer_train_added, base_train, broader_story_train_added, source, val_copied_from, val_total
...
Cohesion: 0.33
Nodes (5): output_format, val, paths, train, seed
...
- **Why does `AsyncMock` connect `Module Cluster 31` to `HuggingFace Model Utilities`, `DAG Query Retrieval`, `Module Cluster 38`, `Module Cluster 39`, `Module Cluster 152`, `Module Cluster 53`, `Shared Config & Utilities`, `Module Cluster 56`, `Module Cluster 29`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `ModelConfig` connect `Module Cluster 75` to `Module Cluster 128`, `Model Training Data`, `Module Cluster 151`, `Module Cluster 153`, `talkingHead WebSocket & TTS`, `Module Cluster 28`, `Module Cluster 160`, `Module Cluster 36`, `Module Cluster 170`, `Module Cluster 46`, `Module Cluster 181`, `Module Cluster 187`, `Module Cluster 62`, `Module Cluster 192`, `Module Cluster 69`, `Module Cluster 72`, `Module Cluster 90`, `Module Cluster 229`, `Module Cluster 232`, `Module Cluster 120`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 42` to `Piper TTS Tests`, `Eval Harness Tests`, `Module Cluster 43`, `Module Cluster 109`, `Module Cluster 47`, `Model Training Data`, `TTS Voice Subsystem`?**
