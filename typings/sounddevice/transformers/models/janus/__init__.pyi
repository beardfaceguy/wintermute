...
class JanusProcessor(ProcessorMixin):
    ...
    tokenizer_class = ...
    def __init__(self, image_processor, tokenizer, chat_template=..., use_default_system_prompt=..., **kwargs) -> None:
        ...
    
    def __call__(self, text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = ..., images: ImageInput = ..., videos=..., audio=..., **kwargs: Unpack[JanusProcessorKwargs]) -> BatchFeature:
        """
