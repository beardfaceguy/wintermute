...
## Summary
- 5453 nodes · 10078 edges · 356 communities (293 shown, 63 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1101 edges (avg confidence: 0.64)
...
## Communities (356 total, 63 thin omitted)
...
Cohesion: 0.04
Nodes (69): _parse(), ARC Challenge — AI2 Reasoning Challenge (hard subset) Dataset: allenai/ARC (ARC-, BaseBenchmark, Run the benchmark against model and return a BenchmarkResult., _parse(), GPQA Diamond — Graduate-level Google-Proof Q&A Dataset: google-deepmind/gpqa (gp, _build_test(), Build a simple assertion block from public test cases. (+61 more)
...
Cohesion: 0.07
Nodes (50): AuditFinding, AuditReport, check_contradictions_ann(), check_low_quality(), check_near_duplicates_ann(), FreudAuditor, main(), _neighbors_query() (+42 more)
...
Cohesion: 0.05
Nodes (53): Allocator, compares_unordered, const_reverse_iterator, adl_serializer, boolean(), clear(), crbegin(), crend() (+45 more)
...
Cohesion: 0.10
Nodes (55): _is_pair_owner(), Return True iff `entry` should own the pair (entry, neighbor) finding.      Olde, datetime, ExitStack, _enter_all(), _fresh(), _make_entry(), _mock_query_chain() (+47 more)
...
Cohesion: 0.07
Nodes (26): AnthropicBackend, HFLocalBackend, make_backend(), OpenAICompatBackend, str, Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID (+18 more)
...
Cohesion: 0.07
Nodes (22): Tests for model.py: model factory, forward pass shapes, config validation., ModelConfig dataclass defaults and construction., HFGPT2LM forward pass shape checks., Sanity check that model parameter counts scale as expected., build_model factory function., GPTLM forward pass shape and behavior checks., TestBuildModel, TestGPTLMForward (+14 more)
...
Cohesion: 0.12
Nodes (29): get_token_string(), handle_value(), json_sax_acceptor, json_sax_dom_callback_parser, allow_exceptions, callback, discarded, errored (+21 more)
...
Cohesion: 0.16
Nodes (40): const_iterator, at(), begin(), cbegin(), cend(), contains(), convert(), count() (+32 more)

### Community 30 - "Module Cluster 30"
Cohesion: 0.11
Nodes (28): bool, device, float, int, Path, str, TestIsMain, TestReduceScalar (+20 more)
...
Cohesion: 0.08
Nodes (19): Any, build_estimator_kwargs(), _job_name(), _make_estimator(), SageMakerBackend — run the SFT job as a SageMaker Training Job.  Submits a Huggi, # NOTE: the local training stack is pinned to transformers 5.x / torch 2.12, DNS-safe SageMaker base job name derived from the model id.      SageMaker appen, Build the HuggingFace estimator constructor kwargs from an SFTConfig. (+11 more)

### Community 33 - "Module Cluster 33"
Cohesion: 0.07
Nodes (20): ServeBackend, build_modelfile(), _ollama_create(), _ollama_rm(), OllamaBackend, ServingHandle, Build Modelfile text pointing at a GGUF file or importable model dir., build_serving_env() (+12 more)
...
Cohesion: 0.11
Nodes (21): compare(), main(), str, _scores_by_benchmark(), _ensure_db(), list_runs(), load_run(), new_run() (+13 more)
...
Cohesion: 0.09
Nodes (18): HumanEval Dataset: openai_humaneval Metric:  pass@1 (fraction of problems where, BenchmarkResult, GenerateConfig, ModelBackend, BenchmarkResult, GenerateConfig, ModelBackend, ExecResult (+10 more)
...
Cohesion: 0.13
Nodes (23): bool, float, int, object, str, device, int, str (+15 more)
...
Cohesion: 0.08
Nodes (27): Any, async_session(), isolate_config_cache(), mock_embed(), mock_embed_unique(), mock_piper_voice(), Root-level conftest.py for the Wintermute platform test suite.  Provides shared, Create a temporary audio file for testing. (+19 more)
...
Cohesion: 0.12
Nodes (27): BasicJsonType, CompatibleType, basic_json(), decode(), flatten(), from_json(), get_impl(), json_sax_dom_parser() (+19 more)
...
Cohesion: 0.33
Nodes (25): ARCChallengeBenchmark, GPQADiamondBenchmark, GSM8KBenchmark, HellaSwagBenchmark, HumanEvalBenchmark, IFEvalBenchmark, LiveCodeBenchmark, LoCoMoBenchmark (+17 more)

### Community 56 - "Module Cluster 56"
Cohesion: 0.11
Nodes (20): _cleanup(), _init_gloo(), Tests for distributed training utilities: DDP helpers, data sharding, grad accum, Only rank 0 should produce log output., total_tokens_seen should account for all GPUs., Verify effective_tokens_per_step = batch_size * seq_len * grad_accum * world_siz, Initialize a gloo process group using a file-based store., Each rank trains the same model on different data; DDP should sync gradients. (+12 more)

### Community 57 - "Module Cluster 57"
Cohesion: 0.11
Nodes (16): Path, _load_and_merge(), main(), merge_adapter(), Merge a LoRA adapter into its base model to produce a standalone HF model dir., Return base_model_name_or_path from an adapter's adapter_config.json., Heavy seam: load base + adapter, merge, return (model, tokenizer).      NOTE: lo, Merge a LoRA adapter into its base model and save to output_dir.      base_model (+8 more)
...
Cohesion: 0.12
Nodes (14): ABC, Base class all benchmark adapters inherit from., LiveCodeBench — Code Generation (Lite) Dataset: livecodebench/code_generation_li, LoCoMo — Long-Context Conversation Memory Dataset: snap-research/LoCoMo Metric:, MBPP — Mostly Basic Python Problems Dataset: google-research-datasets/mbpp (sani, OR-Bench — Over-Refusal Benchmark Dataset: bench-llm/or-bench Metric:  complianc, SWE-bench Verified Dataset: princeton-nlp/SWE-bench_Verified Metric:  resolve_ra, WinoGrande — Large-Scale Winograd Schema Challenge Dataset: allenai/winogrande M (+6 more)
...
Cohesion: 0.10
Nodes (21): base_train, microstory_train_added, self_intro_train_added, train_total, val_copied_from, val_total, arith_stabilizer_train_added, base_train (+13 more)

### Community 70 - "Module Cluster 70"
Cohesion: 0.12
Nodes (11): Tests for training utilities: LR schedules, path resolution, hashing, checkpoint, TokenizerAdapter encode/decode contract., S3 tokenizer downloads must not collide when only the basename matches., Two S3 URIs with the same filename but different prefixes must         download, Path resolution logic., TestGetTokenizerS3PathCollision, TestResolvePath, TestSha256File (+3 more)
...
Cohesion: 0.10
Nodes (13): Shared fixtures for titanProject tests., Trivial tokenizer that maps each character to its ordinal., str, dummy_tokenizer(), DummyTokenizer, Create a small on-disk token cache with 3 shards for testing., Sample message data for WebSocket tests., Create a small text file with known content for dataset tests. (+5 more)
...
Cohesion: 0.09
Nodes (21): size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, files (+13 more)
...
Cohesion: 0.14
Nodes (13): int, str, Should accept 'content', 'value', and 'text' keys., TestFormatMessagesAsChat, _format_messages_as_chat(), _get_boundary_tokens(), _hf_tokenizer_to_adapter(), _maybe_enable_hf_gradient_checkpointing() (+5 more)
...
Cohesion: 0.11
Nodes (19): md5_digest, size_bytes, md5_digest, md5_digest, size_bytes, files, md5_digest, size_bytes (+11 more)
...
Cohesion: 0.15
Nodes (10): get_padding(), init_weights(), ConvFlow, ElementwiseAffine, ResBlock1, ResBlock2, piecewise_rational_quadratic_transform(), rational_quadratic_spline() (+2 more)

### Community 94 - "Module Cluster 94"
Cohesion: 0.13
Nodes (17): AbstractEventLoop, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests., client(), event_loop(), mock_chat_processor(), mock_httpx_client() (+9 more)
...
Cohesion: 0.17
Nodes (18): filters, allow_http, max_assistant_chars, max_digit_ratio, oasst_best_only, oasst_max_fails_task, oasst_max_spam, filters (+10 more)
...
Cohesion: 0.26
Nodes (15): back(), emplace_back(), empty(), end_array(), end_object(), is_array(), is_discarded(), is_structured() (+7 more)
...
Cohesion: 0.19
Nodes (6): DistributedSampler, DataLoader, TestBuildSFTDataloader, build_sft_dataloader(), cycle_batches(), Infinite iterator over a dataloader, calling set_epoch on each restart.
...
Cohesion: 0.13
Nodes (16): byte_container_with_subtype, const_reference, compares_unordered(), operator<(), type(), difference_type, iter_impl, IterImpl (+8 more)
...
Cohesion: 0.13
Nodes (15): de_DE-thorsten-low, aliases, key, language, name, num_speakers, quality, speaker_id_map (+7 more)
...
Cohesion: 0.13
Nodes (15): codereview, paths, port, scheme, mcp_memory, default_db_url, embed_model, batch (+7 more)
...
Cohesion: 0.13
Nodes (15): md5_digest, size_bytes, md5_digest, size_bytes, de_DE-pavoque-low, aliases, files, key (+7 more)

### Community 137 - "Module Cluster 137"
Cohesion: 0.25
Nodes (14): bool, int, main(), Run pytest with the given pattern., run_specific_test(), run_tests(), run_unit_tests(), Run integration tests only. (+6 more)

### Community 138 - "Module Cluster 138"
Cohesion: 0.25
Nodes (6): float, int, ConvReluNorm, DDSConv, Dialted and Depth-Separable Convolution, WN
...
Cohesion: 0.15
Nodes (13): logic_val_used, train_total, val_total, counts, logic_train_used, oasst_train_used, oasst_val_used, openhermes_train_used (+5 more)
...
Cohesion: 0.18
Nodes (8): _parse_answer(), MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac, subjects:         list of MMLU subject names, or None for all 57         max_per, BenchmarkResult, GenerateConfig, int, ModelBackend, str
...
Cohesion: 0.17
Nodes (12): agents, default_llm_port, default_model, max_iterations, dag_retrieval, llm_timeout, max_tokens, temperature (+4 more)
...
Cohesion: 0.18
Nodes (10): base_train_path, base_val_path, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview (+2 more)
...
Cohesion: 0.29
Nodes (8): vllm, model, port, scheme, web_interface, host, path, port
...
Cohesion: 0.25
Nodes (7): base_train, arith_stabilizer_train_added, broader_story_train_added, source, train_total, val_copied_from, val_total
...
Cohesion: 0.14
Nodes (8): AuditFinding should store all fields including optional related_entry_id., AuditFinding should accept a related_entry_id., AuditReport should have sensible zero/empty defaults., Default constructor should set dry_run=False, zone='live', etc., test_audit_finding_construction(), test_audit_finding_with_related(), test_audit_report_defaults(), test_freud_auditor_init_defaults()
...
Cohesion: 0.48
Nodes (6): Path, load_config(), load_tokenizer(), main(), Quick text generation script for Titans checkpoints and HuggingFace models.  Usa, resolve_path()
...
Cohesion: 0.38
Nodes (5): output_format, paths, val, seed, train

### Community 225 - "Module Cluster 225"
Cohesion: 0.29
Nodes (6): story_train_added, base_train, base_val, source, story_val_added, val_total
...
Cohesion: 0.40
Nodes (4): bool, Tensor, Flip, ResidualCouplingLayer
...
### Community 268 - "Module Cluster 268"
Cohesion: 0.67
...
## Knowledge Gaps
- **1281 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1276 more)
...
- **Why does `AsyncMock` connect `TTS Voice Subsystem` to `MCP Agent Runner`, `Module Cluster 164`, `DAG Query Retrieval`, `Module Cluster 38`, `Module Cluster 46`, `Module Cluster 83`, `Shared Config & Utilities`, `talkingHead WebSocket & TTS`, `Module Cluster 59`, `Module Cluster 94`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `datetime` connect `Cython Threading` to `Module Cluster 35`, `Freud Memory Auditor`, `talkingHead FastAPI Backend`, `Module Cluster 120`, `Module Cluster 252`, `Module Cluster 30`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `VoiceNotFoundError` connect `Module Cluster 65` to `Module Cluster 27`?**
