...
from .configuration_auto import AutoConfig, CONFIG_MAPPING_NAMES, model_type_to_module_name, replace_list_option_in_docstrings
...
def get_video_processor_config(pretrained_model_name_or_path: Union[str, os.PathLike], cache_dir: Optional[Union[str, os.PathLike]] = ..., force_download: bool = ..., resume_download: Optional[bool] = ..., proxies: Optional[Dict[str, str]] = ..., token: Optional[Union[bool, str]] = ..., revision: Optional[str] = ..., local_files_only: bool = ..., **kwargs): # -> dict[Any, Any] | Any:
    """
