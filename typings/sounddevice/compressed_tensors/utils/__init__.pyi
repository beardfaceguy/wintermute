...
__all__ = ["get_safetensors_folder", "get_safetensors_header", "match_param_name", "merge_names", "get_weight_mappings", "get_nested_weight_mappings", "get_nested_mappings_from_state_dict", "get_quantization_parameter_to_path_mapping", "is_quantization_param"]
WeightMappingType = Dict[str, str]
NestedWeightMappingType = Dict[str, WeightMappingType]
def get_safetensors_folder(pretrained_model_name_or_path: str, cache_dir: Optional[str] = ...) -> str:
    """
...
def get_nested_weight_mappings(model_path: str, params_to_nest: Iterable[str], return_unmatched_params: bool = ...) -> Union[NestedWeightMappingType, Tuple[NestedWeightMappingType, WeightMappingType]]:
    """
...
def get_nested_mappings_from_state_dict(state_dict, params_to_nest: Iterable[str]) -> NestedWeightMappingType:
    """
