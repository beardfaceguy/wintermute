...
class PermutationGroup(Basic):
    ...
    def coset_transversal(
        self, H
    ) -> list[Any | Basic | list[Any] | Permutation] | list[Permutation]: ...
    ...
    def generate(
        ...
        Generator[Any | Basic | list[Any] | Permutation, Any, None]
        | Generator[list[int] | Permutation | list[Any], Any, None]
    ): ...
    def generate_dimino(
        self, af=...
    ) -> Generator[list[int] | Permutation | list[Any], Any, None]: ...
    def generate_schreier_sims(
        self, af=...
    ) -> Generator[Any | Basic | list[Any] | Permutation, Any, None]: ...
    @property
    ...
    def subgroup_search(
        self, prop, base=..., strong_gens=..., tests=..., init_subgroup=...
    ) -> PermutationGroup: ...
    @property
    ...
    def strong_presentation(
        self,
    ) -> FpGroup | tuple[Any, Any] | tuple[Any | list[Any], Any | list[Any]]: ...
    def presentation(
        self, eliminate_gens=...
    ) -> FpGroup | tuple[Any, Any] | tuple[Any | list[Any], Any | list[Any]] | Any: ...
