...
## Summary
- 5355 nodes · 9900 edges · 351 communities (280 shown, 71 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1074 edges (avg confidence: 0.64)
...
3. `phoneme_id_map` - 115 edges
4. `BenchmarkResult` - 109 edges
5. `BaseBenchmark` - 102 edges
...
## Communities (351 total, 71 thin omitted)
...
Cohesion: 0.05
Nodes (57): _parse(), BaseBenchmark, _build_test(), Build a simple assertion block from public test cases., _answer_matches(), LoCoMo — Long-Context Conversation Memory Dataset: snap-research/LoCoMo Metric:, Loose match: expected answer appears in response (case-insensitive)., max_samples: cap total problems (0 = all ~893k — use a cap in practice) (+49 more)
...
Cohesion: 0.04
Nodes (69): Allocator, array_t, binary_t, boolean_t, compares_unordered, adl_serializer, binary(), boolean() (+61 more)
...
Cohesion: 0.06
Nodes (28): memmap, bool, DataLoader, int, Path, str, Tensor, Tests for data.py: TokenCache, TextWindowDataset, cache utilities. (+20 more)
...
Cohesion: 0.05
Nodes (60): ca_ES-upc_ona-medium, aliases, key, language, name, num_speakers, quality, speaker_id_map (+52 more)
...
Cohesion: 0.11
Nodes (54): byte_container_with_subtype, const_iterator, const_reference, at(), begin(), cbegin(), cend(), compares_unordered() (+46 more)
...
Cohesion: 0.12
Nodes (34): back(), empty(), end_array(), end_object(), get_token_string(), handle_value(), json_sax_acceptor, json_sax_dom_callback_parser (+26 more)
...
Cohesion: 0.10
Nodes (21): Batch, LongTensor, bool, int, Path, str, bool, float (+13 more)

### Community 25 - "talkingHead WebSocket & TTS"
Cohesion: 0.07
Nodes (22): AnthropicBackend, HFLocalBackend, make_backend(), OpenAICompatBackend, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID, target shortcuts for frontier providers (format: <provider>:<model>):       open, Human-readable identifier stored in results. (+14 more)
...
Cohesion: 0.09
Nodes (22): Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, Tests for model.py: model factory, forward pass shapes, config validation., ModelConfig dataclass defaults and construction., HFGPT2LM forward pass shape checks., Sanity check that model parameter counts scale as expected., build_model factory function., GPTLM forward pass shape and behavior checks., TestBuildModel (+14 more)
...
Cohesion: 0.10
Nodes (18): float, int, fused_add_tanh_sigmoid_multiply(), get_padding(), init_weights(), ConvFlow, ConvReluNorm, DDSConv (+10 more)
...
Cohesion: 0.09
Nodes (17): DistributedSampler, DataLoader, int, str, TestBuildSFTDataloader, Should accept 'content', 'value', and 'text' keys., TestFormatMessagesAsChat, build_sft_dataloader() (+9 more)
...
Cohesion: 0.08
Nodes (31): AbstractEventLoop, Any, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests., async_session(), client(), event_loop() (+23 more)

### Community 41 - "Module Cluster 41"
Cohesion: 0.10
Nodes (16): HumanEval Dataset: openai_humaneval Metric:  pass@1 (fraction of problems where, MBPP — Mostly Basic Python Problems Dataset: google-research-datasets/mbpp (sani, BenchmarkResult, GenerateConfig, ModelBackend, ExecResult, extract_code_block(), int (+8 more)
...
Cohesion: 0.10
Nodes (22): CausalLMOutputWithCrossAttentions, bool, float, int, Path, str, bool, int (+14 more)
...
Cohesion: 0.27
Nodes (26): BaseBenchmark, ARCChallengeBenchmark, GPQADiamondBenchmark, GSM8KBenchmark, HellaSwagBenchmark, HumanEvalBenchmark, IFEvalBenchmark, LiveCodeBenchmark (+18 more)
...
Cohesion: 0.10
Nodes (14): lifespan(), FastAPI, echo(), Request, extend_path(), Tests for app.main — FastAPI application wiring., test_lifespan_creates_tables(), get_embed_device() (+6 more)

### Community 55 - "Module Cluster 55"
Cohesion: 0.10
Nodes (14): bool, Tensor, TestForwardLogits, Tests for training utilities: LR schedules, path resolution, hashing, checkpoint, TokenizerAdapter encode/decode contract., S3 tokenizer downloads must not collide when only the basename matches., Two S3 URIs with the same filename but different prefixes must         download, Path resolution logic. (+6 more)
...
Cohesion: 0.07
Nodes (27): md5_digest, size_bytes, md5_digest, md5_digest, size_bytes, ca_ES-upc_pau-x_low, aliases, files (+19 more)
...
Cohesion: 0.09
Nodes (17): str, Shared fixtures for titanProject tests., Trivial tokenizer that maps each character to its ordinal., dummy_tokenizer(), DummyTokenizer, Create a small on-disk token cache with 3 shards for testing., Create a temporary audio file for testing., Sample phonemes for testing. (+9 more)
...
Cohesion: 0.12
Nodes (14): ABC, ARC Challenge — AI2 Reasoning Challenge (hard subset) Dataset: allenai/ARC (ARC-, Base class all benchmark adapters inherit from., LiveCodeBench — Code Generation (Lite) Dataset: livecodebench/code_generation_li, MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac, OR-Bench — Over-Refusal Benchmark Dataset: bench-llm/or-bench Metric:  complianc, SWE-bench Verified Dataset: princeton-nlp/SWE-bench_Verified Metric:  resolve_ra, WinoGrande — Large-Scale Winograd Schema Challenge Dataset: allenai/winogrande M (+6 more)
...
Cohesion: 0.09
Nodes (23): mcp_memory, default_db_url, port, mcp_servers, map_echo_port, map_list_port, postgres_default_url, rag (+15 more)
...
Cohesion: 0.13
Nodes (22): object, str, Wave_write, _make_mock_ws(), Lifecycle / resource-leak tests inspired by daimonos memory-leak prevention rule, CLA-261: A connection that errors during broadcast should be evicted from active, Connect N websockets, disconnect all → active_connections should be empty., AsyncSessionLocal used as context manager should close the session. (+14 more)
...
Cohesion: 0.11
Nodes (21): ARC Challenge Benchmark Adapter, Base Benchmark Abstract Class, HellaSwag Commonsense NLI Benchmark, HumanEval Coding Benchmark (pass@1), IFEval Instruction Following Benchmark, LiveCodeBench Competitive Programming Benchmark, LoCoMo Long-Context Conversation Memory Benchmark, MATH Competition Math Benchmark (+13 more)
...
Cohesion: 0.12
Nodes (18): de_DE-kerstin-low, aliases, key, name, num_speakers, quality, de_DE-ramona-low, key (+10 more)
...
Cohesion: 0.14
Nodes (14): int, x: decoder input         h: encoder output, add_timing_signal_1d(), cat_timing_signal_1d(), generate_path(), get_timing_signal_1d(), rand_gumbel(), rand_gumbel_like() (+6 more)
...
Cohesion: 0.17
Nodes (18): filters, max_digit_ratio, oasst_best_only, oasst_max_fails_task, oasst_min_helpfulness, oasst_min_quality, reject_role_markers, allow_http (+10 more)
...
Cohesion: 0.15
Nodes (14): output_format, paths, train, val, seed, source, train_total, val_total (+6 more)
...
Cohesion: 0.12
Nodes (16): language, md5_digest, size_bytes, size_bytes, md5_digest, size_bytes, en_GB-alan-medium, aliases (+8 more)
...
Cohesion: 0.25
Nodes (14): bool, int, Run pytest with the given pattern., run_tests(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments., Run integration tests. (+6 more)
...
Cohesion: 0.15
Nodes (13): counts, slimorca_val_used, train_total, val_total, logic_train_used, logic_val_used, oasst_train_used, oasst_val_used (+5 more)
...
Cohesion: 0.17
Nodes (11): base_train, base_val, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview (+3 more)

### Community 151 - "Module Cluster 151"
Cohesion: 0.17
Nodes (11): base_val_path, arith_boosters_path, arith_train_added, base_train, base_train_path, intro_boosters_path, intro_train_added, source (+3 more)
...
Cohesion: 0.33
Nodes (3): _extract_answer(), Pull the final numeric answer out of a model response.      Preference order:, TestGSM8KExtractor
...
Cohesion: 0.20
Nodes (10): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, files, de/de_DE/kerstin/low/de_DE-kerstin-low.onnx (+2 more)
...
Cohesion: 0.20
Nodes (10): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, files, el/el_GR/rapunzelina/low/el_GR-rapunzelina-low.onnx (+2 more)
...
Cohesion: 0.22
Nodes (5): _normalize(), GSM8K — Grade School Math Dataset: openai/gsm8k Metric:  accuracy (exact final n, BenchmarkResult, GenerateConfig, ModelBackend
...
Cohesion: 0.22
Nodes (9): codereview, host, paths, port, scheme, batch, health, review (+1 more)
...
Cohesion: 0.29
Nodes (8): vllm, host, model, path, port, scheme, web_interface, port
...
Cohesion: 0.25
Nodes (7): source, val_copied_from, arith_stabilizer_train_added, base_train, broader_story_train_added, train_total, val_total
...
Cohesion: 0.29
Nodes (4): bool, str, WebSocket, Accept a WebSocket connection. Returns False if at capacity.
...
Cohesion: 0.29
Nodes (5): _parse(), GPQA Diamond — Graduate-level Google-Proof Q&A Dataset: google-deepmind/gpqa (gp, BenchmarkResult, GenerateConfig, ModelBackend
...
Cohesion: 0.29
Nodes (6): base_train, base_val, curated_train_added, curated_val_added, val_total, train_total
...
Cohesion: 0.40
Nodes (5): dump_float(), get_number_float(), false_type, number_float_t, true_type
...
## Knowledge Gaps
- **1292 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1287 more)
...
- **Why does `datetime` connect `Cython Threading` to `Module Cluster 36`, `Piper TTS Tests`, `Module Cluster 114`, `PostgreSQL MCP Server`, `SQL Agent & Test Harness`, `Module Cluster 245`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `AsyncMock` connect `Model Training Data` to `Module Cluster 32`, `GPT-2 Pretraining Pipeline`, `Module Cluster 71`, `Module Cluster 40`, `Module Cluster 48`, `Module Cluster 148`, `Module Cluster 54`, `Shared Config & Utilities`, `Module Cluster 56`, `Module Cluster 26`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `PiperVoice` connect `Module Cluster 78` to `Module Cluster 128`, `Module Cluster 64`, `Module Cluster 70`, `Module Cluster 231`, `Module Cluster 40`, `Module Cluster 121`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Are the 91 inferred relationships involving `BenchmarkResult` (e.g. with `ARCChallengeBenchmark` and `BaseBenchmark`) actually correct?**
  _`BenchmarkResult` has 91 INFERRED edges - model-reasoned connections that need verification._
- **Are the 84 inferred relationships involving `BaseBenchmark` (e.g. with `ARCChallengeBenchmark` and `BenchmarkResult`) actually correct?**
  _`BaseBenchmark` has 84 INFERRED edges - model-reasoned connections that need verification._
