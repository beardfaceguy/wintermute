...
from .._distn_infrastructure import rv_continuous, rv_continuous_frozen
...
class levy_stable_gen(rv_continuous):
    ...
    def rvs(self, *args, **kwds):  # -> NDArray[Any] | None:
        ...
    @inherit_docstring_from(rv_continuous)
    def pdf(self, x, *args, **kwds):  # -> ndarray[_Shape, dtype[Any]] | Any | None:
        ...
    @inherit_docstring_from(rv_continuous)
    def cdf(self, x, *args, **kwds):  # -> ndarray[_Shape, dtype[Any]] | Any | None:
        ...
