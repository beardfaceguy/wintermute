...
class SeamlessM4Tv2EncoderLayer(nn.Module):
    def __init__(
        self, config: SeamlessM4Tv2Config, encoder_ffn_dim=..., encoder_attention_heads=...
    ) -> None: ...
    def forward(
        self,
        hidden_states: torch.Tensor,
...
class SeamlessM4Tv2DecoderLayer(nn.Module):
    def __init__(
        self, config: SeamlessM4Tv2Config, decoder_ffn_dim=..., decoder_attention_heads=...
    ) -> None: ...
    def forward(
        self,
        hidden_states: torch.Tensor,
...
class SeamlessM4Tv2Decoder(SeamlessM4Tv2PreTrainedModel):
    def __init__(
        self, config: SeamlessM4Tv2Config, embed_tokens: nn.Embedding | None = ...
    ) -> None:
        r"""
        embed_tokens (`nn.Embedding`, *optional*):
            Input embedding
...
class SeamlessM4Tv2TextToUnitModel(SeamlessM4Tv2PreTrainedModel):
    def __init__(
        self, config: SeamlessM4Tv2Config, embed_tokens_decoder: nn.Embedding | None = ...
    ) -> None:
        r"""
