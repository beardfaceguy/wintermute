...
class FlaxDinov2PreTrainedModel(FlaxPreTrainedModel):
    ...
    def __call__(self, pixel_values, params: Optional[dict] = ..., dropout_rng: jax.random.PRNGKey = ..., train: bool = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...):
        ...
