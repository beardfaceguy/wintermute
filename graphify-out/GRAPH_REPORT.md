...
## Summary
- 5366 nodes · 9946 edges · 345 communities (285 shown, 60 thin omitted)
...
## Communities (345 total, 60 thin omitted)
...
Cohesion: 0.05
Nodes (62): _parse(), BaseBenchmark, Run the benchmark against model and return a BenchmarkResult., _parse(), _parse(), _is_refusal(), BenchmarkResult, GenerateConfig (+54 more)
...
Cohesion: 0.05
Nodes (65): ca_ES-upc_ona-medium, aliases, language, name, num_speakers, quality, speaker_id_map, ca_ES-upc_ona-x_low (+57 more)
...
Cohesion: 0.06
Nodes (54): __pyx_array___getattr__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_12__setitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_8__getattr__(), __pyx_array___setitem__(), __Pyx_GetAttr(), __Pyx_GetAttr3(), __Pyx_GetAttr3Default(), __pyx_getprop___pyx_array_memview() (+46 more)
...
Cohesion: 0.09
Nodes (21): bool, float, int, Tensor, fused_add_tanh_sigmoid_multiply(), get_padding(), init_weights(), ConvFlow (+13 more)
...
Cohesion: 0.10
Nodes (34): JoinableQueue, cache_norm_audio(), make_silence_detector(), # NOTE: audio is already in [-1, 1] coming from librosa, Returns the offset/duration of trimmed audio in seconds, trim_silence(), Detects speech/silence using Silero VAD.      https://github.com/snakers4/silero, SileroVoiceActivityDetector (+26 more)
...
Cohesion: 0.08
Nodes (20): HumanEval Dataset: openai_humaneval Metric:  pass@1 (fraction of problems where, _build_test(), LiveCodeBench — Code Generation (Lite) Dataset: livecodebench/code_generation_li, Build a simple assertion block from public test cases., MBPP — Mostly Basic Python Problems Dataset: google-research-datasets/mbpp (sani, BenchmarkResult, GenerateConfig, ModelBackend (+12 more)
...
Cohesion: 0.07
Nodes (26): AbstractEventLoop, str, Shared fixtures for titanProject tests., Trivial tokenizer that maps each character to its ordinal., MagicMock, TestClient, Pytest configuration and fixtures for talkingHead backend tests., client() (+18 more)
...
Cohesion: 0.08
Nodes (26): aws, ec2_describe_instance_query, profile, region, default_probe_check_pid, default_layout, default_probe_check_pid, default_work_dir (+18 more)
...
Cohesion: 0.07
Nodes (27): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, cs_CZ-jirka-medium, aliases (+19 more)

### Community 68 - "Module Cluster 68"
Cohesion: 0.09
Nodes (25): mcp_memory, default_db_url, port, mcp_servers, map_echo_port, map_list_port, postgres_default_url, rag (+17 more)
...
Cohesion: 0.11
Nodes (22): str, async_session(), mock_piper_voice(), Create a temporary audio file for testing., Sample text for testing., Sample message data for WebSocket tests., Sample phonemes for testing., Create a temporary SQLite database for testing. (+14 more)

### Community 79 - "Module Cluster 79"
Cohesion: 0.16
Nodes (20): _build_llm_prompt(), _clean_sql(), main(), _parse_args(), preflight_check(), _print_summary(), Any, bool (+12 more)
...
Cohesion: 0.16
Nodes (20): _generate_sql_from_hints(), Validate query results against the expected specification., Run a test case in manual mode: use the hints to construct SQL., Return reference SQL by test case ID (does not use case.hints — ID lookup only)., run_test_case_manual(), TestCase, validate_result(), Tests for agents/sql_agent.py — batch resilience and validation logic.  The sql_ (+12 more)
...
Cohesion: 0.11
Nodes (19): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes (+11 more)
...
Cohesion: 0.12
Nodes (16): base_val_path, base_train, arith_boosters_path, arith_train_added, base_train_path, base_val, intro_boosters_path, intro_train_added (+8 more)
...
Cohesion: 0.11
Nodes (18): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-pavoque-low, files (+10 more)
...
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, en_GB-alba-medium, aliases (+9 more)
...
Cohesion: 0.12
Nodes (16): md5_digest, size_bytes, size_bytes, md5_digest, size_bytes, en_GB-alan-medium, files, key (+8 more)
...
Cohesion: 0.14
Nodes (14): da_DK-talesyntese-medium, aliases, key, language, name, num_speakers, quality, speaker_id_map (+6 more)

### Community 131 - "Module Cluster 131"
Cohesion: 0.25
Nodes (14): bool, main(), Run pytest with the given pattern., run_tests(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments., Run integration tests. (+6 more)

### Community 132 - "Module Cluster 132"
Cohesion: 0.14
Nodes (10): Tests for the sql_describe_table tool., sql_describe_table returns schema, table, row_count, columns, pk, fk., Tests for the sql_sample_rows tool., Limit below 1 is clamped to 1., Limit above 20 is clamped to 20., Successful call returns columns, rows, and row_count., Database errors are caught and returned as error dicts., Exceptions from _run_query produce error dicts. (+2 more)
...
Cohesion: 0.17
Nodes (10): _extract(), _normalize(), MATH — Competition Math Benchmark Dataset: TIGER-Lab/MATH-plus (train split, cap, Light normalization: strip whitespace, LaTeX commas, dollar signs., max_per_tier: samples per difficulty tier (0-9)         tiers:        which tier, BenchmarkResult, GenerateConfig, ModelBackend (+2 more)
...
Cohesion: 0.23
Nodes (8): Enum, ExcludeReason, main(), ProcessUtterance, Uses ffmpeg to get audio duration., Utterance, float, Path
...
Cohesion: 0.17
Nodes (12): counts, logic_val_used, oasst_train_used, oasst_val_used, openhermes_train_used, openhermes_val_used, slimorca_val_used, train_total (+4 more)
...
Cohesion: 0.18
Nodes (10): source, train_total, val_total, arith_stabilizer_train_added, base_train, broader_story_train_added, source, train_total (+2 more)

### Community 166 - "Module Cluster 166"
Cohesion: 0.18
Nodes (11): allow_http, max_user_chars, oasst_max_fails_task, oasst_max_spam, oasst_min_helpfulness, oasst_min_quality, reject_role_markers, filters (+3 more)
...
Cohesion: 0.22
Nodes (8): arith_stabilizer_train_added, base_train, source, train_total, val_copied_from, val_total, microstory_train_added, self_intro_train_added
...
Cohesion: 0.39
Nodes (7): answer(), build_sample(), load_model(), main(), _make_names(), Stage-A memory recall probe for a trained Titan (the go/no-go on the memory clai, Fresh example each call. Returns (prompt, gold_code). Prompt ends at     'The se
...
Cohesion: 0.60
Nodes (4): main(), make_example(), _make_names(), Synthetic recall TRAINING data generator for Stage A.  Emits self-contained need
...
Cohesion: 0.50
Nodes (3): Return probability of speech in audio [0-1].          Audio must be 16Khz 16-bit, int, ndarray
...
## Knowledge Gaps
- **1293 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1288 more)
...
- **Why does `AsyncMock` connect `Module Cluster 30` to `Module Cluster 34`, `Module Cluster 36`, `DAG Query Retrieval`, `Module Cluster 81`, `SQL Agent & Test Harness`, `Module Cluster 52`, `Module Cluster 54`, `Module Cluster 88`, `Module Cluster 60`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 43` to `Module Cluster 44`, `SFT Fine-Tuning Pipeline`, `talkingHead FastAPI Backend`, `Module Cluster 115`, `PostgreSQL MCP Server`, `Module Cluster 49`, `Shared Config & Utilities`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `ModelConfig` connect `Module Cluster 45` to `Module Cluster 135`, `Module Cluster 138`, `MCP Memory Server`, `SFT Fine-Tuning Pipeline`, `talkingHead WebSocket & TTS`, `Module Cluster 157`, `Module Cluster 31`, `Module Cluster 164`, `Module Cluster 36`, `Module Cluster 39`, `Module Cluster 47`, `Module Cluster 183`, `Module Cluster 59`, `Module Cluster 193`, `Module Cluster 194`, `Module Cluster 86`, `Module Cluster 215`, `Module Cluster 97`, `Module Cluster 227`, `Module Cluster 110`, `Module Cluster 125`?**
