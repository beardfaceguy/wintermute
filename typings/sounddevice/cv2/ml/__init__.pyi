...
class ParamGrid:
    ...
    @classmethod
    def create(
        cls, minVal: float = ..., maxVal: float = ..., logstep: float = ...
    ) -> ParamGrid: ...
...
class TrainData:
    ...
    @staticmethod
    def getSubMatrix(
        matrix: cv2.typing.MatLike, idx: cv2.typing.MatLike, layout: int
    ) -> cv2.typing.MatLike: ...
    @classmethod
    @_typing.overload
    def create(
...
class StatModel(cv2.Algorithm):
    ...
    @_typing.overload
    def train(
        self, samples: cv2.typing.MatLike, layout: int, responses: cv2.typing.MatLike
    ) -> bool: ...
    @_typing.overload
    ...
    @_typing.overload
    def calcError(
        self, data: TrainData, test: bool, resp: cv2.UMat | None = ...
...
class SVM(StatModel):
    ...
    def getDecisionFunction(
        self, i: int, alpha: cv2.typing.MatLike | None = ..., svidx: cv2.typing.MatLike | None = ...
    ) -> tuple[float, cv2.typing.MatLike, cv2.typing.MatLike]: ...
    @_typing.overload
    def getDecisionFunction(
...
class EM(StatModel):
    ...
    @_typing.overload
    def predict2(
        self, sample: cv2.UMat, probs: cv2.UMat | None = ...
    ) -> tuple[cv2.typing.Vec2d, cv2.UMat]: ...
    @_typing.overload
    def trainEM(
        self,
        samples: cv2.typing.MatLike,
...
class RTrees(DTrees):
    ...
    @_typing.overload
    def getVotes(
        self, samples: cv2.typing.MatLike, flags: int, results: cv2.typing.MatLike | None = ...
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
    def getVotes(
        self, samples: cv2.UMat, flags: int, results: cv2.UMat | None = ...
    ) -> cv2.UMat: ...
...
class ANN_MLP(StatModel):
    ...
    def setActivationFunction(
        self, type: int, param1: float = ..., param2: float = ...
    ) -> None: ...
    @_typing.overload
