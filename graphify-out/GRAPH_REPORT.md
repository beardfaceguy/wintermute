...
## Summary
- 5374 nodes · 9964 edges · 350 communities (285 shown, 65 thin omitted)
...
## Communities (350 total, 65 thin omitted)
...
Cohesion: 0.04
Nodes (63): _parse(), BaseBenchmark, _parse(), _build_test(), Build a simple assertion block from public test cases., _answer_matches(), Loose match: expected answer appears in response (case-insensitive)., max_samples: cap total problems (0 = all ~893k — use a cap in practice) (+55 more)
...
Cohesion: 0.05
Nodes (66): ca_ES-upc_ona-medium, aliases, key, language, name, num_speakers, quality, speaker_id_map (+58 more)
...
Cohesion: 0.05
Nodes (51): Allocator, compares_unordered, const_reverse_iterator, adl_serializer, boolean(), clear(), crbegin(), crend() (+43 more)
...
Cohesion: 0.10
Nodes (40): back(), empty(), end_array(), end_object(), get_token_string(), handle_value(), hex_bytes(), is_array() (+32 more)
...
Cohesion: 0.05
Nodes (25): _extract_answer(), _normalize(), GSM8K — Grade School Math Dataset: openai/gsm8k Metric:  accuracy (exact final n, Pull the final numeric answer out of a model response., _extract(), _normalize(), MATH — Competition Math Benchmark Dataset: TIGER-Lab/MATH-plus (train split, cap, Light normalization: strip whitespace, LaTeX commas, dollar signs. (+17 more)
...
Cohesion: 0.09
Nodes (32): bool, device, float, int, Path, str, TestIsMain, TestReduceScalar (+24 more)
...
Cohesion: 0.07
Nodes (20): Tests for model.py: model factory, forward pass shapes, config validation., ModelConfig dataclass defaults and construction., HFGPT2LM forward pass shape checks., Sanity check that model parameter counts scale as expected., build_model factory function., GPTLM forward pass shape and behavior checks., TestBuildModel, TestGPTLMForward (+12 more)
...
Cohesion: 0.06
Nodes (30): AbstractEventLoop, str, Shared fixtures for titanProject tests., Trivial tokenizer that maps each character to its ordinal., MagicMock, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests. (+22 more)
...
Cohesion: 0.11
Nodes (32): JoinableQueue, cache_norm_audio(), make_silence_detector(), # NOTE: audio is already in [-1, 1] coming from librosa, Returns the offset/duration of trimmed audio in seconds, trim_silence(), Detects speech/silence using Silero VAD.      https://github.com/snakers4/silero, SileroVoiceActivityDetector (+24 more)
...
Cohesion: 0.08
Nodes (29): mcp_memory, default_db_url, embed_model, port, mcp_servers, map_echo_port, map_list_port, postgres_default_url (+21 more)
...
Cohesion: 0.10
Nodes (12): AnthropicBackend, make_backend(), Claude models via the Anthropic SDK.     pip install anthropic      model exampl, target shortcuts for frontier providers (format: <provider>:<model>):       open, Human-readable identifier stored in results., Send a messages list and return the assistant reply text., Tests for eval/model.py — backend factory and provider shortcut parsing.  All te, make_backend() shortcut routing. (+4 more)

### Community 52 - "Module Cluster 52"
Cohesion: 0.12
Nodes (18): HFLocalBackend, OpenAICompatBackend, str, Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, Loads a HuggingFace model locally via transformers.      model_path: HF model ID, Convenience wrapper: single user turn., Talks to any /v1/chat/completions endpoint.      base_url examples:       "http:, bool (+10 more)
...
Cohesion: 0.07
Nodes (27): md5_digest, md5_digest, size_bytes, md5_digest, size_bytes, files, md5_digest, size_bytes (+19 more)
...
Cohesion: 0.12
Nodes (14): ABC, ARC Challenge — AI2 Reasoning Challenge (hard subset) Dataset: allenai/ARC (ARC-, Base class all benchmark adapters inherit from., GPQA Diamond — Graduate-level Google-Proof Q&A Dataset: google-deepmind/gpqa (gp, LiveCodeBench — Code Generation (Lite) Dataset: livecodebench/code_generation_li, LoCoMo — Long-Context Conversation Memory Dataset: snap-research/LoCoMo Metric:, MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac, OR-Bench — Over-Refusal Benchmark Dataset: bench-llm/or-bench Metric:  complianc (+6 more)
...
Cohesion: 0.08
Nodes (23): audio, quality, sample_rate, dataset, espeak, voice, inference, length_scale (+15 more)
...
Cohesion: 0.10
Nodes (23): bytes, async_session(), mock_piper_voice(), Create a temporary audio file for testing., Create a sample audio file for testing voice upload., Sample text for testing., Sample phonemes for testing., Create sample audio data for testing. (+15 more)
...
Cohesion: 0.12
Nodes (23): array_t, binary_t, boolean_t, binary(), dump_float(), get_impl_ptr(), get_number_float(), get_ptr() (+15 more)
...
Cohesion: 0.14
Nodes (10): bool, Tests for data.py: TokenCache, TextWindowDataset, cache utilities., Dataset indexing and window construction., Building the dataset twice with same params should reuse cache., Dataloader construction., TestBuildDataloader, TestTextWindowDataset, build_dataloader() (+2 more)
...
Cohesion: 0.10
Nodes (20): ca_ES-upc_pau-x_low, aliases, key, name, num_speakers, speaker_id_map, de_DE-kerstin-low, aliases (+12 more)
...
Cohesion: 0.13
Nodes (10): init_weights(), ConvFlow, ElementwiseAffine, ResBlock1, ResBlock2, ResidualCouplingLayer, piecewise_rational_quadratic_transform(), rational_quadratic_spline() (+2 more)
...
Cohesion: 0.11
Nodes (18): size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, ca_ES-upc_ona-x_low, aliases, files (+10 more)
...
Cohesion: 0.17
Nodes (18): filters, allow_http, max_assistant_chars, max_digit_ratio, oasst_max_fails_task, oasst_min_quality, reject_role_markers, filters (+10 more)
...
Cohesion: 0.12
Nodes (17): size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-ramona-low, aliases, files (+9 more)

### Community 120 - "Module Cluster 120"
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, en_GB-aru-medium, aliases (+9 more)
...
Cohesion: 0.26
Nodes (7): float, int, get_padding(), ConvReluNorm, DDSConv, Dialted and Depth-Separable Convolution, WN
...
Cohesion: 0.25
Nodes (14): bool, Run pytest with the given pattern., run_specific_test(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments., Run integration tests., int (+6 more)
...
Cohesion: 0.16
Nodes (12): base_train, microstory_train_added, self_intro_train_added, source, val_total, arith_stabilizer_train_added, base_train, broader_story_train_added (+4 more)
...
Cohesion: 0.15
Nodes (13): logic_train_used, openhermes_train_used, openhermes_val_used, slimorca_train_used, slimorca_val_used, train_total, val_total, counts (+5 more)
...
Cohesion: 0.20
Nodes (10): train, val, output_format, paths, seed, arith_stabilizer_train_added, base_train, train_total (+2 more)
...
Cohesion: 0.25
Nodes (7): int, Path, load_config(), load_tokenizer(), main(), QADataset, Quick finetune on the synthetic memory QA set (memory_test.txt + answers).  We a
...
Cohesion: 0.18
Nodes (10): base_val_path, arith_boosters_path, arith_train_added, base_val, intro_boosters_path, intro_train_added, source, story_boosters_path (+2 more)
...
Cohesion: 0.24
Nodes (6): Dataset, build_ids(), LMWindows, main(), SageMaker training entry point for the Titan pretraining PoC.  Runs inside a Sag, Tokenize the corpus to a flat uint16 array. Source is either a HuggingFace     d
...
Cohesion: 0.39
Nodes (7): answer(), build_sample(), _code(), load_model(), main(), Stage-A memory recall probe for a trained Titan (the go/no-go on the memory clai, Return (prompt, gold_code). One fact per name; target placed at target_idx.
...
- **Why does `AsyncMock` connect `Eval Benchmark Adapters` to `Module Cluster 34`, `Module Cluster 66`, `HuggingFace Model Utilities`, `DAG Query Retrieval`, `Module Cluster 156`, `PostgreSQL MCP Server`, `TTS Voice Subsystem`, `Module Cluster 55`, `Module Cluster 28`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 39` to `Cython Core Runtime`, `Module Cluster 40`, `C++ JSON Library (json.hpp)`, `Module Cluster 44`, `Module Cluster 47`, `Model Training Data`, `Module Cluster 118`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `VoiceNotFoundError` connect `Module Cluster 73` to `JSON C++ Type System`?**
