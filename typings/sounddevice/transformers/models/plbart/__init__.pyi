...
class PLBartTokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, bos_token=..., eos_token=..., sep_token=..., cls_token=..., unk_token=..., pad_token=..., mask_token=..., language_codes=..., tokenizer_file=..., src_lang=..., tgt_lang=..., sp_model_kwargs: Optional[Dict[str, Any]] = ..., additional_special_tokens=..., clean_up_tokenization_spaces=..., **kwargs) -> None:
        ...
