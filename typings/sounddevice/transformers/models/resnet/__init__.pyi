...
class TFResNetForImageClassification(TFResNetPreTrainedModel, TFSequenceClassificationLoss):
    ...
    @unpack_inputs
    def call(self, pixel_values: Optional[tf.Tensor] = ..., labels: Optional[tf.Tensor] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., training: bool = ...) -> Union[Tuple[tf.Tensor], TFImageClassifierOutputWithNoAttention]:
        r"""
