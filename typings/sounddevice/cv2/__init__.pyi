...
class RotatedRect:
    ...
    @_typing.overload
    def __init__(
        self, point1: cv2.typing.Point2f, point2: cv2.typing.Point2f, point3: cv2.typing.Point2f
    ) -> None: ...
...
class KeyPoint:
    ...
    @_typing.overload
    def convert(
        keypoints: _typing.Sequence[KeyPoint], keypointIndexes: _typing.Sequence[int] = ...
...
class Subdiv2D:
    ...
    def getVoronoiFacetList(
        ...
        _typing.Sequence[_typing.Sequence[cv2.typing.Point2f]], _typing.Sequence[cv2.typing.Point2f]
    ]: ...
...
class LineSegmentDetector(Algorithm):
    ...
    @_typing.overload
    def compareSegments(
        self, size: cv2.typing.Size, lines1: UMat, lines2: UMat, image: UMat | None = ...
    ) -> tuple[int, UMat]: ...
...
class AlignMTB(AlignExposures):
    ...
    @_typing.overload
    def process(
        self, src: _typing.Sequence[cv2.typing.MatLike], dst: _typing.Sequence[cv2.typing.MatLike]
    ) -> None: ...
    @_typing.overload
    def process(
    ...
    @_typing.overload
    def shiftMat(
        self, src: cv2.typing.MatLike, shift: cv2.typing.Point, dst: cv2.typing.MatLike | None = ...
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
...
class MergeExposures(Algorithm):
    ...
    @_typing.overload
    def process(
        self, src: _typing.Sequence[UMat], times: UMat, response: UMat, dst: UMat | None = ...
    ) -> UMat: ...
...
class MergeMertens(MergeExposures):
    ...
    @_typing.overload
    def process(
        self, src: _typing.Sequence[cv2.typing.MatLike], dst: cv2.typing.MatLike | None = ...
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
...
class Feature2D:
    ...
    @_typing.overload
    def compute(
        self, image: UMat, keypoints: _typing.Sequence[KeyPoint], descriptors: UMat | None = ...
    ...
    def compute(
        ...
        _typing.Sequence[_typing.Sequence[KeyPoint]], _typing.Sequence[cv2.typing.MatLike]
    ]: ...
    @_typing.overload
    def compute(
        self,
...
class MSER(Feature2D):
    ...
    def detectRegions(
        ...
        _typing.Sequence[_typing.Sequence[cv2.typing.Point]], _typing.Sequence[cv2.typing.Rect]
    ]: ...
    @_typing.overload
    def detectRegions(
        self, image: UMat
...
class FlannBasedMatcher(DescriptorMatcher):
    def __init__(
        self, indexParams: cv2.typing.IndexParams = ..., searchParams: cv2.typing.SearchParams = ...
    ) -> None: ...
    @classmethod
...
class CascadeClassifier:
    ...
    def detectMultiScale3(
        ...
        _typing.Sequence[cv2.typing.Rect], _typing.Sequence[int], _typing.Sequence[float]
    ]: ...
    @_typing.overload
    def detectMultiScale3(
        self,
...
class QRCodeEncoder:
    ...
    def encodeStructuredAppend(
        self, encoded_info: str, qrcodes: _typing.Sequence[cv2.typing.MatLike] | None = ...
...
class GraphicalCodeDetector:
    ...
    @_typing.overload
    def decodeMulti(
        self, img: UMat, points: UMat, straight_code: _typing.Sequence[UMat] | None = ...
    ...
    def detectAndDecodeMulti(
        ...
        bool, _typing.Sequence[str], cv2.typing.MatLike, _typing.Sequence[cv2.typing.MatLike]
    ]: ...
    @_typing.overload
    def detectAndDecodeMulti(
        self,
...
class FaceRecognizerSF:
    ...
    @_typing.overload
    def feature(
        self, aligned_img: cv2.typing.MatLike, face_feature: cv2.typing.MatLike | None = ...
    ) -> cv2.typing.MatLike: ...
    @_typing.overload
...
class Stitcher:
    ...
    @_typing.overload
    def composePanorama(
        self, images: _typing.Sequence[cv2.typing.MatLike], pano: cv2.typing.MatLike | None = ...
    ) -> tuple[Stitcher_Status, cv2.typing.MatLike]: ...
    @_typing.overload
    def composePanorama(
    ...
    @_typing.overload
    def stitch(
        self, images: _typing.Sequence[UMat], masks: _typing.Sequence[UMat], pano: UMat | None = ...
    ) -> tuple[Stitcher_Status, UMat]: ...
...
class KalmanFilter:
    ...
    @_typing.overload
    def __init__(
        self, dynamParams: int, measureParams: int, controlParams: int = ..., type: int = ...
    ) -> None: ...
...
class GComputation:
    ...
    def apply(
        self, callback: cv2.typing.ExtractArgsCallback, args: _typing.Sequence[GCompileArg] = ...
    ...
    @_typing.overload
    def compileStreaming(
        self, callback: cv2.typing.ExtractMetaCallback, args: _typing.Sequence[GCompileArg] = ...
    ) -> GStreamingCompiled: ...
...
class GStreamingCompiled:
    ...
    def pull(
        ...
        bool, _typing.Sequence[cv2.typing.GRunArg] | _typing.Sequence[cv2.typing.GOptRunArg]
    ]: ...
    def stop(self) -> None: ...
...
@_typing.overload
def CamShift(
    probImage: cv2.typing.MatLike, window: cv2.typing.Rect, criteria: cv2.typing.TermCriteria
...
@_typing.overload
def LUT(
    src: cv2.typing.MatLike, lut: cv2.typing.MatLike, dst: cv2.typing.MatLike | None = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
...
@_typing.overload
def SVDecomp(
    src: UMat, w: UMat | None = ..., u: UMat | None = ..., vt: UMat | None = ..., flags: int = ...
) -> tuple[UMat, UMat, UMat]: ...
@_typing.overload
def Scharr(
    src: cv2.typing.MatLike,
...
@_typing.overload
def accumulate(
    src: cv2.typing.MatLike, dst: cv2.typing.MatLike, mask: cv2.typing.MatLike | None = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
...
@_typing.overload
def add(
    src1: UMat, src2: UMat, dst: UMat | None = ..., mask: UMat | None = ..., dtype: int = ...
) -> UMat: ...
def addText(
    img: cv2.typing.MatLike,
    text: str,
...
@_typing.overload
def applyColorMap(
    src: cv2.typing.MatLike, userColor: cv2.typing.MatLike, dst: cv2.typing.MatLike | None = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
...
@_typing.overload
def broadcast(
    src: cv2.typing.MatLike, shape: cv2.typing.MatLike, dst: cv2.typing.MatLike | None = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
...
def calibrateCameraROExtended(
    ...
    float, UMat, UMat, _typing.Sequence[UMat], _typing.Sequence[UMat], UMat, UMat, UMat, UMat, UMat
]: ...
@_typing.overload
...
@_typing.overload
def calibrationMatrixValues(
    cameraMatrix: UMat, imageSize: cv2.typing.Size, apertureWidth: float, apertureHeight: float
) -> tuple[float, float, float, cv2.typing.Point2d, float]: ...
@_typing.overload
def cartToPolar(
...
@_typing.overload
def convexHull(
    points: UMat, hull: UMat | None = ..., clockwise: bool = ..., returnPoints: bool = ...
) -> UMat: ...
@_typing.overload
...
@_typing.overload
def cornerHarris(
    src: UMat, blockSize: int, ksize: int, k: float, dst: UMat | None = ..., borderType: int = ...
) -> UMat: ...
@_typing.overload
...
@_typing.overload
def cornerMinEigenVal(
    src: UMat, blockSize: int, dst: UMat | None = ..., ksize: int = ..., borderType: int = ...
) -> UMat: ...
@_typing.overload
def cornerSubPix(
    image: cv2.typing.MatLike,
...
def createMergeMertens(
    contrast_weight: float = ..., saturation_weight: float = ..., exposure_weight: float = ...
) -> MergeMertens: ...
...
def createTonemapReinhard(
    gamma: float = ..., intensity: float = ..., light_adapt: float = ..., color_adapt: float = ...
) -> TonemapReinhard: ...
...
@_typing.overload
def cvtColor(
    src: UMat, code: int, dst: UMat | None = ..., dstCn: int = ..., hint: AlgorithmHint = ...
) -> UMat: ...
@_typing.overload
...
@_typing.overload
def demosaicing(
    src: cv2.typing.MatLike, code: int, dst: cv2.typing.MatLike | None = ..., dstCn: int = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
...
@_typing.overload
def distanceTransform(
    src: UMat, distanceType: int, maskSize: int, dst: UMat | None = ..., dstType: int = ...
) -> UMat: ...
@_typing.overload
...
@_typing.overload
def divide(
    scale: float, src2: cv2.typing.MatLike, dst: cv2.typing.MatLike | None = ..., dtype: int = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
...
@_typing.overload
def edgePreservingFilter(
    src: UMat, dst: UMat | None = ..., flags: int = ..., sigma_s: float = ..., sigma_r: float = ...
) -> UMat: ...
@_typing.overload
def eigen(
    src: cv2.typing.MatLike,
...
@_typing.overload
def fillConvexPoly(
    img: UMat, points: UMat, color: cv2.typing.Scalar, lineType: int = ..., shift: int = ...
) -> UMat: ...
@_typing.overload
def fillPoly(
    img: cv2.typing.MatLike,
...
@_typing.overload
def filterSpeckles(
    img: UMat, newVal: float, maxSpeckleSize: int, maxDiff: float, buf: UMat | None = ...
) -> tuple[UMat, UMat]: ...
@_typing.overload
...
@_typing.overload
def findChessboardCorners(
    image: UMat, patternSize: cv2.typing.Size, corners: UMat | None = ..., flags: int = ...
) -> tuple[bool, UMat]: ...
@_typing.overload
...
@_typing.overload
def findContoursLinkRuns(
    image: UMat, contours: _typing.Sequence[UMat] | None = ..., hierarchy: UMat | None = ...
) -> tuple[_typing.Sequence[UMat], UMat]: ...
@_typing.overload
def findContoursLinkRuns(
    image: cv2.typing.MatLike, contours: _typing.Sequence[cv2.typing.MatLike] | None = ...
) -> _typing.Sequence[cv2.typing.MatLike]: ...
@_typing.overload
def findContoursLinkRuns(
...
@_typing.overload
def fitLine(
    points: UMat, distType: int, param: float, reps: float, aeps: float, line: UMat | None = ...
) -> UMat: ...
@_typing.overload
def flip(
...
@_typing.overload
def imencodemulti(
    ext: str, imgs: _typing.Sequence[cv2.typing.MatLike], params: _typing.Sequence[int] = ...
) -> tuple[bool, numpy.ndarray[_typing.Any, numpy.dtype[numpy.uint8]]]: ...
@_typing.overload
def imencodemulti(
...
@_typing.overload
def imreadmulti(
    filename: str, mats: _typing.Sequence[cv2.typing.MatLike] | None = ..., flags: int = ...
) -> tuple[bool, _typing.Sequence[cv2.typing.MatLike]]: ...
@_typing.overload
def imreadmulti(
    filename: str,
...
@_typing.overload
def imwritemulti(
    filename: str, img: _typing.Sequence[cv2.typing.MatLike], params: _typing.Sequence[int] = ...
) -> bool: ...
@_typing.overload
def imwritemulti(
...
@_typing.overload
def inpaint(
    src: UMat, inpaintMask: UMat, inpaintRadius: float, flags: int, dst: UMat | None = ...
) -> UMat: ...
@_typing.overload
def insertChannel(
...
@_typing.overload
def linearPolar(
    src: UMat, center: cv2.typing.Point2f, maxRadius: float, flags: int, dst: UMat | None = ...
) -> UMat: ...
@_typing.overload
...
@_typing.overload
def magnitude(
    x: cv2.typing.MatLike, y: cv2.typing.MatLike, magnitude: cv2.typing.MatLike | None = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
...
@_typing.overload
def matchShapes(
    contour1: cv2.typing.MatLike, contour2: cv2.typing.MatLike, method: int, parameter: float
) -> float: ...
@_typing.overload
...
@_typing.overload
def matchTemplate(
    image: UMat, templ: UMat, method: int, result: UMat | None = ..., mask: UMat | None = ...
) -> UMat: ...
@_typing.overload
def max(
    src1: cv2.typing.MatLike, src2: cv2.typing.MatLike, dst: cv2.typing.MatLike | None = ...
...
@_typing.overload
def meanStdDev(
    src: UMat, mean: UMat | None = ..., stddev: UMat | None = ..., mask: UMat | None = ...
) -> tuple[UMat, UMat]: ...
@_typing.overload
def medianBlur(
...
@_typing.overload
def mixChannels(
    src: _typing.Sequence[UMat], dst: _typing.Sequence[UMat], fromTo: _typing.Sequence[int]
) -> _typing.Sequence[UMat]: ...
@_typing.overload
...
@_typing.overload
def phaseCorrelate(
    src1: cv2.typing.MatLike, src2: cv2.typing.MatLike, window: cv2.typing.MatLike | None = ...
...
@_typing.overload
def preCornerDetect(
    src: cv2.typing.MatLike, ksize: int, dst: cv2.typing.MatLike | None = ..., borderType: int = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
def preCornerDetect(
...
@_typing.overload
def pyrDown(
    src: UMat, dst: UMat | None = ..., dstsize: cv2.typing.Size = ..., borderType: int = ...
) -> UMat: ...
@_typing.overload
...
@_typing.overload
def reduceArgMax(
    src: cv2.typing.MatLike, axis: int, dst: cv2.typing.MatLike | None = ..., lastIndex: bool = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
...
@_typing.overload
def seamlessClone(
    src: UMat, dst: UMat, mask: UMat, p: cv2.typing.Point, flags: int, blend: UMat | None = ...
) -> UMat: ...
@_typing.overload
def selectROI(
    windowName: str,
...
@_typing.overload
def selectROI(
    img: UMat, showCrosshair: bool = ..., fromCenter: bool = ..., printNotice: bool = ...
) -> cv2.typing.Rect: ...
@_typing.overload
def selectROIs(
    windowName: str,
...
@_typing.overload
def solveLP(
    Func: cv2.typing.MatLike, Constr: cv2.typing.MatLike, z: cv2.typing.MatLike | None = ...
) -> tuple[int, cv2.typing.MatLike]: ...
@_typing.overload
...
@_typing.overload
def solvePoly(
    coeffs: cv2.typing.MatLike, roots: cv2.typing.MatLike | None = ..., maxIters: int = ...
) -> tuple[float, cv2.typing.MatLike]: ...
@_typing.overload
def solvePoly(
...
@_typing.overload
def spatialGradient(
    src: UMat, dx: UMat | None = ..., dy: UMat | None = ..., ksize: int = ..., borderType: int = ...
) -> tuple[UMat, UMat]: ...
@_typing.overload
def split(
...
@_typing.overload
def transposeND(
    src: cv2.typing.MatLike, order: _typing.Sequence[int], dst: cv2.typing.MatLike | None = ...
) -> cv2.typing.MatLike: ...
@_typing.overload
...
def dnn_registerLayer(layerTypeName: str, layerClass: type[cv2.dnn.LayerProtocol]) -> None: ...
