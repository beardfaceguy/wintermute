...
from llama_index.core.prompts import BasePromptTemplate, ChatPromptTemplate, SelectorPromptTemplate
...
class PromptHelper(BaseComponent):
    ...
    def __init__(self, context_window: int = ..., num_output: int = ..., chunk_overlap_ratio: float = ..., chunk_size_limit: Optional[int] = ..., tokenizer: Optional[Callable[[str], List]] = ..., separator: str = ...) -> None:
        """Init params."""
        ...
    
    @classmethod
    def from_llm_metadata(cls, llm_metadata: LLMMetadata, chunk_overlap_ratio: float = ..., chunk_size_limit: Optional[int] = ..., tokenizer: Optional[Callable[[str], List]] = ..., separator: str = ...) -> PromptHelper:
        """
    ...
    def get_text_splitter_given_prompt(self, prompt: BasePromptTemplate, num_chunks: int = ..., padding: int = ..., llm: Optional[LLM] = ..., tools: Optional[List[BaseTool]] = ...) -> TokenTextSplitter:
        """
    ...
    def truncate(self, prompt: BasePromptTemplate, text_chunks: Sequence[str], padding: int = ..., llm: Optional[LLM] = ..., tools: Optional[List[BaseTool]] = ...) -> List[str]:
        """Truncate text chunks to fit available context window."""
        ...
    
    def repack(self, prompt: BasePromptTemplate, text_chunks: Sequence[str], padding: int = ..., llm: Optional[LLM] = ..., tools: Optional[List[BaseTool]] = ...) -> List[str]:
        """
