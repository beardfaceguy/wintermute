...
class AsyncCollection(CollectionCommon["AsyncServerAPI"]):
    async def add(
        self,
        ids: OneOrMany[ID],
        embeddings: OneOrMany[Embedding] | OneOrMany[PyEmbedding] | None = ...,
        metadatas: OneOrMany[Metadata] | None = ...,
        documents: OneOrMany[Document] | None = ...,
        images: OneOrMany[Image] | None = ...,
        uris: OneOrMany[URI] | None = ...,
    ) -> None:
    ...
    async def query(
        self,
        query_embeddings: OneOrMany[Embedding] | OneOrMany[PyEmbedding] | None = ...,
        query_texts: OneOrMany[Document] | None = ...,
        query_images: OneOrMany[Image] | None = ...,
        query_uris: OneOrMany[URI] | None = ...,
        ids: OneOrMany[ID] | None = ...,
        n_results: int = ...,
        where: Where | None = ...,
        where_document: WhereDocument | None = ...,
    ...
    async def modify(
        ...
        configuration: UpdateCollectionConfiguration | None = ...,
    ) -> None:
