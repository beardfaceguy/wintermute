...
class MimiModel(MimiPreTrainedModel):
    ...
    def encode(self, input_values: torch.Tensor, padding_mask: Optional[torch.Tensor] = ..., num_quantizers: Optional[float] = ..., encoder_past_key_values: Optional[Union[Cache, List[torch.FloatTensor]]] = ..., return_dict: Optional[bool] = ...) -> Union[Tuple[torch.Tensor, Optional[torch.Tensor]], MimiEncoderOutput]:
        """
