...
class ZambaHybridDynamicCache(DynamicCache):
    ...
    def from_legacy_cache(
        cls, past_key_values: tuple[tuple[torch.FloatTensor]] | None = ...
    ) -> DynamicCache: ...
...
class ZambaMambaMixer(nn.Module):
    ...
    def cuda_kernels_forward(
        self,
        hidden_states: torch.Tensor,
        cache_params: ZambaHybridDynamicCache = ...,
        attention_mask=...,
    ):  # -> Any:
        ...
    def slow_forward(
        self, input_states, cache_params: ZambaHybridDynamicCache = ..., attention_mask=...
    ):  # -> Any:
        ...
    def forward(
        self, hidden_states, cache_params: ZambaHybridDynamicCache = ..., attention_mask=...
    ):  # -> Any:
        ...
