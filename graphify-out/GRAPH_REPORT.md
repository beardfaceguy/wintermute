...
## Summary
- 5393 nodes · 9996 edges · 349 communities (286 shown, 63 thin omitted)
...
## Communities (349 total, 63 thin omitted)
...
Cohesion: 0.09
Nodes (24): AbstractEventLoop, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests., client(), event_loop(), mock_chat_processor(), mock_httpx_client() (+16 more)
...
Cohesion: 0.09
Nodes (23): md5_digest, size_bytes, md5_digest, size_bytes, files, num_speakers, md5_digest, size_bytes (+15 more)
...
Cohesion: 0.11
Nodes (18): train_total, arith_stabilizer_train_added, base_train, microstory_train_added, source, train_total, val_copied_from, val_total (+10 more)
...
Cohesion: 0.12
Nodes (11): Shared fixtures for titanProject tests., Trivial tokenizer that maps each character to its ordinal., str, dummy_tokenizer(), DummyTokenizer, Create a small on-disk token cache with 3 shards for testing., Sample message data for WebSocket tests., Create a small text file with known content for dataset tests. (+3 more)

### Community 86 - "Module Cluster 86"
Cohesion: 0.10
Nodes (20): md5_digest, size_bytes, md5_digest, size_bytes, size_bytes, md5_digest, size_bytes, de_DE-eva_k-x_low (+12 more)
...
Cohesion: 0.12
Nodes (17): logic_train_used, logic_val_used, oasst_train_used, openhermes_train_used, slimorca_train_used, slimorca_val_used, val_total, output_format (+9 more)
...
Cohesion: 0.17
Nodes (18): filters, allow_http, max_user_chars, oasst_max_fails_task, oasst_min_helpfulness, reject_role_markers, max_assistant_chars, max_digit_ratio (+10 more)
...
Cohesion: 0.12
Nodes (16): base_train, base_val, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview (+8 more)
...
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-ramona-low, aliases (+9 more)
...
Cohesion: 0.14
Nodes (14): ca_ES-upc_pau-x_low, aliases, key, name, num_speakers, quality, speaker_id_map, de_DE-karlsson-low (+6 more)

### Community 134 - "Module Cluster 134"
Cohesion: 0.25
Nodes (14): bool, int, main(), Run pytest with the given pattern., run_unit_tests(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments. (+6 more)
...
Cohesion: 0.17
Nodes (11): base_train_path, arith_boosters_path, arith_train_added, base_train, base_val_path, intro_boosters_path, intro_train_added, story_boosters_path (+3 more)
...
- **Why does `AsyncMock` connect `Module Cluster 29` to `Module Cluster 66`, `HuggingFace Model Utilities`, `Cython C Extensions`, `Module Cluster 49`, `PostgreSQL MCP Server`, `Module Cluster 52`, `Eval Benchmark Adapters`, `Module Cluster 57`, `Module Cluster 88`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 39` to `Module Cluster 33`, `Module Cluster 40`, `Module Cluster 45`, `SFT Fine-Tuning Pipeline`, `talkingHead FastAPI Backend`, `Module Cluster 117`, `Shared Config & Utilities`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `VoiceNotFoundError` connect `Module Cluster 71` to `Model Training Data`?**
