...
class EncodecModel(EncodecPreTrainedModel):
    ...
    def encode(self, input_values: torch.Tensor, padding_mask: Optional[torch.Tensor] = ..., bandwidth: Optional[float] = ..., return_dict: Optional[bool] = ...) -> Union[Tuple[torch.Tensor, Optional[torch.Tensor]], EncodecEncoderOutput]:
        """
