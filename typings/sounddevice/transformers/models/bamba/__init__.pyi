...
from transformers.models.mamba2.modeling_mamba2 import MambaRMSNormGated, pad_tensor_by_size, reshape_into_chunks, segment_sum
...
class BambaMixer(nn.Module):
    ...
    def cuda_kernels_forward(self, hidden_states: torch.Tensor, cache_params: Optional[HybridMambaAttentionDynamicCache] = ..., cache_position: Optional[torch.LongTensor] = ..., attention_mask: Optional[torch.Tensor] = ..., seq_idx: Optional[torch.IntTensor] = ...): # -> Any:
        ...
    
    def torch_forward(self, input_states, cache_params: Optional[HybridMambaAttentionDynamicCache] = ..., cache_position: Optional[torch.LongTensor] = ..., attention_mask: Optional[torch.Tensor] = ...): # -> Any:
        ...
    
    def forward(self, hidden_states, cache_params: Optional[HybridMambaAttentionDynamicCache] = ..., cache_position: Optional[torch.LongTensor] = ..., attention_mask: Optional[torch.Tensor] = ..., seq_idx: Optional[torch.IntTensor] = ..., **kwargs): # -> Any:
        ...
