...
class SchemaValidator:
    ...
    def validate_python(self, input: Any, *, strict: bool | None = ..., from_attributes: bool | None = ..., context: Any | None = ..., self_instance: Any | None = ..., allow_partial: bool | Literal['off', 'on', 'trailing-strings'] = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> Any:
        """
    ...
    def isinstance_python(self, input: Any, *, strict: bool | None = ..., from_attributes: bool | None = ..., context: Any | None = ..., self_instance: Any | None = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> bool:
        """
    ...
    def validate_json(self, input: str | bytes | bytearray, *, strict: bool | None = ..., context: Any | None = ..., self_instance: Any | None = ..., allow_partial: bool | Literal['off', 'on', 'trailing-strings'] = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> Any:
        """
    ...
    def validate_strings(self, input: _StringInput, *, strict: bool | None = ..., context: Any | None = ..., allow_partial: bool | Literal['off', 'on', 'trailing-strings'] = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> Any:
        """
    ...
    def validate_assignment(self, obj: Any, field_name: str, field_value: Any, *, strict: bool | None = ..., from_attributes: bool | None = ..., context: Any | None = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> dict[str, Any] | tuple[dict[str, Any], dict[str, Any] | None, set[str]]:
        """
    ...
    def get_default_value(self, *, strict: bool | None = ..., context: Any = ...) -> Some | None:
        """
...
class SchemaSerializer:
    ...
    def to_python(self, value: Any, *, mode: str | None = ..., include: _IncEx | None = ..., exclude: _IncEx | None = ..., by_alias: bool | None = ..., exclude_unset: bool = ..., exclude_defaults: bool = ..., exclude_none: bool = ..., round_trip: bool = ..., warnings: bool | Literal['none', 'warn', 'error'] = ..., fallback: Callable[[Any], Any] | None = ..., serialize_as_any: bool = ..., context: Any | None = ...) -> Any:
        """
    ...
    def to_json(self, value: Any, *, indent: int | None = ..., include: _IncEx | None = ..., exclude: _IncEx | None = ..., by_alias: bool | None = ..., exclude_unset: bool = ..., exclude_defaults: bool = ..., exclude_none: bool = ..., round_trip: bool = ..., warnings: bool | Literal['none', 'warn', 'error'] = ..., fallback: Callable[[Any], Any] | None = ..., serialize_as_any: bool = ..., context: Any | None = ...) -> bytes:
        """
...
def to_json(value: Any, *, indent: int | None = ..., include: _IncEx | None = ..., exclude: _IncEx | None = ..., by_alias: bool = ..., exclude_none: bool = ..., round_trip: bool = ..., timedelta_mode: Literal['iso8601', 'float'] = ..., bytes_mode: Literal['utf8', 'base64', 'hex'] = ..., inf_nan_mode: Literal['null', 'constants', 'strings'] = ..., serialize_unknown: bool = ..., fallback: Callable[[Any], Any] | None = ..., serialize_as_any: bool = ..., context: Any | None = ...) -> bytes:
    """
    Serialize a Python object to JSON including transforming and filtering data.
...
def from_json(data: str | bytes | bytearray, *, allow_inf_nan: bool = ..., cache_strings: bool | Literal['all', 'keys', 'none'] = ..., allow_partial: bool | Literal['off', 'on', 'trailing-strings'] = ...) -> Any:
    """
...
def to_jsonable_python(value: Any, *, include: _IncEx | None = ..., exclude: _IncEx | None = ..., by_alias: bool = ..., exclude_none: bool = ..., round_trip: bool = ..., timedelta_mode: Literal['iso8601', 'float'] = ..., bytes_mode: Literal['utf8', 'base64', 'hex'] = ..., inf_nan_mode: Literal['null', 'constants', 'strings'] = ..., serialize_unknown: bool = ..., fallback: Callable[[Any], Any] | None = ..., serialize_as_any: bool = ..., context: Any | None = ...) -> Any:
    """
...
class ValidationError(ValueError):
    ...
    """
    @classmethod
    def from_exception_data(cls, title: str, line_errors: list[InitErrorDetails], input_type: Literal['python', 'json'] = ..., hide_input: bool = ...) -> Self:
        """
    ...
    def errors(self, *, include_url: bool = ..., include_context: bool = ..., include_input: bool = ...) -> list[ErrorDetails]:
        """
    ...
    def json(self, *, indent: int | None = ..., include_url: bool = ..., include_context: bool = ..., include_input: bool = ...) -> str:
        """
...
class PydanticCustomError(ValueError):
    ...
    Example:
        ...
        ```
    """
    def __init__(self, error_type: LiteralString, message_template: LiteralString, context: dict[str, Any] | None = ...) -> None:
    ...
    def __new__(cls, error_type: LiteralString, message_template: LiteralString, context: dict[str, Any] | None = ...) -> Self:
        ...
...
class PydanticKnownError(ValueError):
    ...
    Example:
        ...
        ```
    """
    def __init__(self, error_type: ErrorType, context: dict[str, Any] | None = ...) -> None:
    ...
    def __new__(cls, error_type: ErrorType, context: dict[str, Any] | None = ...) -> Self:
        ...
...
class PydanticSerializationUnexpectedValue(ValueError):
    ...
    def __new__(cls, message: str | None = ...) -> Self:
        ...
...
class ArgsKwargs:
    ...
    def __new__(cls, args: tuple[Any, ...], kwargs: dict[str, Any] | None = ...) -> Self:
        ...
...
def validate_core_schema(schema: CoreSchema, *, strict: bool | None = ...) -> CoreSchema:
