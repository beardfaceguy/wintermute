...
class ColPaliProcessor(ProcessorMixin):
    ...
    def __call__(self, images: ImageInput = ..., text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = ..., audio=..., videos=..., **kwargs: Unpack[ColPaliProcessorKwargs]) -> BatchFeature:
        """
    ...
    def process_queries(self, text: Union[TextInput, List[TextInput]], **kwargs: Unpack[ColPaliProcessorKwargs]) -> BatchFeature:
        """
    ...
    def score_retrieval(self, query_embeddings: Union[torch.Tensor, List[torch.Tensor]], passage_embeddings: Union[torch.Tensor, List[torch.Tensor]], batch_size: int = ..., output_dtype: Optional[torch.dtype] = ..., output_device: Union[torch.device, str] = ...) -> torch.Tensor:
        """
