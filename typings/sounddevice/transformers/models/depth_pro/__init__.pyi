...
def reconstruct_feature_maps(hidden_state: torch.Tensor, batch_size: int, padding: int, output_size: Tuple[float, float]) -> torch.Tensor:
    """
...
class DepthProImageEncoder(nn.Module):
    ...
    def forward(self, pixel_values: torch.Tensor, head_mask: Optional[torch.Tensor] = ..., output_attentions: bool = ..., output_hidden_states: bool = ..., return_dict: bool = ...) -> Union[tuple, DepthProOutput]:
        ...
...
class DepthProFeatureUpsampleBlock(nn.Module):
    def __init__(self, config: DepthProConfig, input_dims: int, intermediate_dims: int, output_dims: int, n_upsample_layers: int, use_proj: bool = ..., bias: bool = ...) -> None:
        ...
...
class DepthProModel(DepthProPreTrainedModel):
    ...
    @auto_docstring
    def forward(self, pixel_values: torch.FloatTensor, head_mask: Optional[torch.FloatTensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...) -> Union[Tuple, DepthProOutput]:
        r"""
        Examples:
...
class DepthProFovModel(nn.Module):
    ...
    def forward(self, pixel_values: torch.Tensor, global_features: torch.Tensor, head_mask: Optional[torch.Tensor] = ...) -> torch.Tensor:
        ...
...
class DepthProForDepthEstimation(DepthProPreTrainedModel):
    ...
    @auto_docstring
    def forward(self, pixel_values: torch.FloatTensor, head_mask: Optional[torch.FloatTensor] = ..., labels: Optional[torch.LongTensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...) -> Union[Tuple[torch.Tensor], DepthProDepthEstimatorOutput]:
        r"""
