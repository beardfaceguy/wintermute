...
class TFSwinMaskedImageModelingOutput(ModelOutput):
    ...
    """
    loss: tf.Tensor | None = ...
    reconstruction: Optional[tf.Tensor] = ...
    hidden_states: Tuple[tf.Tensor, ...] | None = ...
    attentions: Tuple[tf.Tensor, ...] | None = ...
    reshaped_hidden_states: Tuple[tf.Tensor, ...] | None = ...
    @property
...
class TFSwinEmbeddings(keras.layers.Layer):
    ...
    def call(self, pixel_values: tf.Tensor, bool_masked_pos: Optional[bool] = ..., training: bool = ...) -> Tuple[tf.Tensor, Tuple[int, int]]:
        ...
...
class TFSwinDropPath(keras.layers.Layer):
    """Drop paths (Stochastic Depth) per sample (when applied in main path of residual blocks)."""
    def __init__(self, drop_prob: Optional[float] = ..., scale_by_keep: bool = ..., **kwargs) -> None:
        ...
...
class TFSwinLayer(keras.layers.Layer):
    def __init__(self, config, dim, input_resolution: Tuple[int, int], num_heads: int, drop_path_rate: float = ..., shift_size: int = ..., **kwargs) -> None:
        ...
