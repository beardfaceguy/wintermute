...
def nextCategory(
    string,
):  # -> tuple[Any | LiteralString, Any | LiteralString] | tuple[str | Any, ...]:
    """
...
def parsePrimitiveCategory(
    chunks, primitives, families, var
):  # -> tuple[CCGVar | Any, CCGVar | Any] | tuple[Any, Any] | tuple[PrimitiveCategory, Any]:
    """
...
def augParseCategory(
    line, primitives, families, var=...
):  # -> tuple[Any | CCGVar | PrimitiveCategory | FunctionalCategory, Any | CCGVar | None]:
    """
