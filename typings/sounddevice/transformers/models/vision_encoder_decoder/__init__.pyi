...
class VisionEncoderDecoderModel(PreTrainedModel, GenerationMixin):
    ...
    @classmethod
    def from_encoder_decoder_pretrained(cls, encoder_pretrained_model_name_or_path: Optional[str] = ..., decoder_pretrained_model_name_or_path: Optional[str] = ..., *model_args, **kwargs) -> PreTrainedModel:
        r"""
