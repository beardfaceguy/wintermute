...
from typing import Any, ClassVar, Protocol, Self, TypeVar, Union
...
class ConfigurationInternal(JSONSerializable["ConfigurationInternal"]):
    ...
    def __init__(self, parameters: list[ConfigurationParameter] | None = ...) -> None:
    ...
    def set_parameter(self, name: str, value: str | int | float | bool) -> None:
...
class CollectionConfigurationInterface(CollectionConfigurationInternal):
    ...
    def __init__(self, hnsw_configuration: HNSWConfigurationInternal | None) -> None:
