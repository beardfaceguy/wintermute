...
def base_solution_linear(
    c, a, b, t=...
) -> tuple[Any, Any] | tuple[Literal[0], Literal[0]] | tuple[None, None]: ...
...
def PQa(
    P_0, Q_0, D
) -> Generator[tuple[Any, Any, type[UndefinedFunction] | Any, Any, Any, Any], Any, NoReturn]: ...
def diop_bf_DN(
    D, N, t=...
) -> (
    list[tuple[Literal[0], Literal[0]]]
    | list[tuple[Literal[0], Any]]
    | list[tuple[Any, Any]]
    | list[Any]
): ...
def equivalent(u, v, r, s, D, N) -> bool: ...
def length(P, Q, D) -> int: ...
def transformation_to_DN(
    eq,
) -> tuple[Any, Any] | tuple[MutableDenseMatrix, MutableDenseMatrix] | None: ...
...
def parametrize_ternary_quadratic(
    eq,
) -> tuple[None, None, None] | tuple[Any, Any, Any] | tuple[Any, ...] | None: ...
...
def sum_of_three_squares(
    ...
    | tuple[Any, ...]
    | tuple[Any, Literal[0], Literal[0]]
    | None
): ...
def sum_of_four_squares(
    n,
) -> tuple[Literal[0], Literal[0], Literal[0], Literal[0]] | tuple[Any, ...]: ...
def power_representation(
    n, p, k, zeros=...
) -> Generator[
    tuple[Any, ...] | tuple[Literal[0], ...] | tuple[int] | tuple[Any] | tuple[int, int] | None,
    Any,
    None,
]: ...
