...
def dump_compiler_graph_state(
    gm, args, compiler_name, *, config_patches=..., accuracy=..., strict=...
):  # -> None:
    ...
def generate_compiler_repro_exported_program(
    exported_program, *, options: dict[str, str] | None = ..., stable_output=..., save_dir=...
):  # -> str:
    ...
...
def export_for_aoti_minifier(
    gm, tuple_inputs, strict=..., skip_export_error=...
