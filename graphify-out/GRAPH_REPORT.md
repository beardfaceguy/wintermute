...
## Summary
- 5379 nodes · 9968 edges · 353 communities (290 shown, 63 thin omitted)
...
Cohesion: 0.04
Nodes (71): BaseBenchmark, Run the benchmark against model and return a BenchmarkResult., _parse(), _build_test(), Build a simple assertion block from public test cases., _answer_matches(), Loose match: expected answer appears in response (case-insensitive)., _parse_answer() (+63 more)
...
Cohesion: 0.05
Nodes (65): language, da_DK-talesyntese-medium, aliases, key, language, name, num_speakers, quality (+57 more)
...
Cohesion: 0.05
Nodes (18): _parse(), _extract_answer(), _normalize(), GSM8K — Grade School Math Dataset: openai/gsm8k Metric:  accuracy (exact final n, Pull the final numeric answer out of a model response., str, BenchmarkResult, GenerateConfig (+10 more)
...
Cohesion: 0.07
Nodes (27): AnthropicBackend, HFLocalBackend, make_backend(), OpenAICompatBackend, Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID, target shortcuts for frontier providers (format: <provider>:<model>):       open (+19 more)
...
Cohesion: 0.06
Nodes (40): AbstractEventLoop, Any, TestClient, Pytest configuration and fixtures for talkingHead backend tests., async_session(), client(), event_loop(), mock_chat_processor() (+32 more)
...
Cohesion: 0.18
Nodes (32): ARCChallengeBenchmark, GPQADiamondBenchmark, GSM8KBenchmark, HellaSwagBenchmark, HumanEvalBenchmark, IFEvalBenchmark, LiveCodeBenchmark, LoCoMoBenchmark (+24 more)
...
Cohesion: 0.07
Nodes (27): size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, el_GR-rapunzelina-low, aliases, files (+19 more)
...
Cohesion: 0.08
Nodes (24): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes (+16 more)
...
Cohesion: 0.09
Nodes (22): agents, default_llm_port, default_model, max_iterations, temperature, mcp_servers, map_echo_port, map_list_port (+14 more)
...
Cohesion: 0.10
Nodes (13): str, Shared fixtures for titanProject tests., Trivial tokenizer that maps each character to its ordinal., dummy_tokenizer(), DummyTokenizer, Create a small on-disk token cache with 3 shards for testing., Sample message data for WebSocket tests., Create a small text file with known content for dataset tests. (+5 more)

### Community 80 - "Module Cluster 80"
Cohesion: 0.10
Nodes (21): ca_ES-upc_pau-x_low, aliases, key, name, num_speakers, quality, speaker_id_map, cs_CZ-jirka-medium (+13 more)

### Community 81 - "Module Cluster 81"
Cohesion: 0.12
Nodes (16): int, x: decoder input         h: encoder output, add_timing_signal_1d(), cat_timing_signal_1d(), fused_add_tanh_sigmoid_multiply(), generate_path(), get_timing_signal_1d(), init_weights() (+8 more)
...
Cohesion: 0.10
Nodes (20): md5_digest, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, en_GB-alan-medium (+12 more)
...
Cohesion: 0.12
Nodes (16): arith_stabilizer_train_added, microstory_train_added, source, train_total, val_copied_from, val_total, base_train, arith_stabilizer_train_added (+8 more)
...
Cohesion: 0.17
Nodes (18): filters, max_user_chars, allow_http, max_assistant_chars, max_digit_ratio, oasst_best_only, oasst_max_fails_task, oasst_max_spam (+10 more)
...
Cohesion: 0.14
Nodes (9): ConvFlow, ConvReluNorm, ElementwiseAffine, ResBlock1, ResBlock2, piecewise_rational_quadratic_transform(), rational_quadratic_spline(), searchsorted() (+1 more)
...
Cohesion: 0.13
Nodes (15): paths, val, output_format, train, seed, arith_boosters_path, arith_train_added, base_train (+7 more)
...
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, en_GB-jenny_dioco-medium, aliases (+9 more)
...
Cohesion: 0.25
Nodes (7): float, int, get_padding(), DDSConv, Dialted and Depth-Separable Convolution, ResidualCouplingLayer, WN
...
Cohesion: 0.25
Nodes (14): bool, main(), Run pytest with the given pattern., run_specific_test(), run_tests(), run_unit_tests(), Run integration tests only., Run a specific test file. (+6 more)
...
Cohesion: 0.15
Nodes (13): logic_train_used, logic_val_used, oasst_train_used, openhermes_train_used, openhermes_val_used, slimorca_train_used, slimorca_val_used, train_total (+5 more)
...
Cohesion: 0.17
Nodes (11): base_val, base_val_path, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview (+3 more)
...
Cohesion: 0.25
Nodes (6): Dataset, AdjDocs, eval_depths(), main(), Salvage test for #952 option 4: MQAR-in-text — is the text-recall failure caused, [filler] KEY VALUE [filler] KEY -> VALUE. KEY unique (absent from filler).
...
Cohesion: 0.25
Nodes (8): mcp_memory, default_db_url, embed_model, port, rag, device, live_data_dir, storage_dir
...
Cohesion: 0.25
Nodes (7): base_val, story_train_added, base_train, source, story_val_added, train_total, val_total
...
Cohesion: 0.33
Nodes (7): dag_retrieval, llm_timeout, frequency_penalty, max_tokens, temperature, top_p, inference
...
## Knowledge Gaps
- **1287 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1282 more)
...
- **Why does `AsyncMock` connect `talkingHead WebSocket & TTS` to `Module Cluster 160`, `Module Cluster 33`, `Module Cluster 37`, `PostgreSQL MCP Server`, `Module Cluster 51`, `Module Cluster 53`, `TTS Voice Subsystem`, `Module Cluster 87`, `Module Cluster 28`, `Module Cluster 30`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 41` to `Module Cluster 42`, `Module Cluster 46`, `MCP Memory Server`, `SFT Fine-Tuning Pipeline`, `talkingHead FastAPI Backend`, `SQL Agent & Test Harness`, `Module Cluster 119`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `VoiceNotFoundError` connect `Module Cluster 70` to `Module Cluster 26`?**
