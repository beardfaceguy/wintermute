...
## Summary
- 5361 nodes · 9905 edges · 354 communities (286 shown, 68 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1087 edges (avg confidence: 0.64)
...
3. `BenchmarkResult` - 116 edges
4. `phoneme_id_map` - 115 edges
5. `BaseBenchmark` - 109 edges
...
## Communities (354 total, 68 thin omitted)
...
Cohesion: 0.05
Nodes (59): _parse(), BaseBenchmark, Run the benchmark against model and return a BenchmarkResult., _parse(), _answer_matches(), Loose match: expected answer appears in response (case-insensitive)., max_per_tier: samples per difficulty tier (0-9)         tiers:        which tier, _parse() (+51 more)

### Community 3 - "MCP Agent Runner"
Cohesion: 0.05
Nodes (79): __pyx_array___getattr__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_12__setitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_8__getattr__(), __pyx_array___setitem__(), __Pyx_GetAttr(), __Pyx_GetAttr3(), __Pyx_GetAttr3Default(), __pyx_getprop___pyx_array_memview() (+71 more)
...
Cohesion: 0.06
Nodes (57): CYTHON_SMALL_CODE, PyInit_core(), __pyx_array___dealloc__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_4__dealloc__(), __pyx_bisect_code_objects(), __Pyx_BufFmt_CheckString(), __Pyx_BufFmt_DescribeTypeChar(), __Pyx_BufFmt_ExpectNumber() (+49 more)

### Community 8 - "Cython Core Runtime"
Cohesion: 0.05
Nodes (63): ca_ES-upc_ona-medium, aliases, key, language, name, num_speakers, quality, speaker_id_map (+55 more)
...
Cohesion: 0.06
Nodes (57): CYTHON_INLINE, PyThread_tss_alloc(), PyThread_tss_create(), PyThread_tss_delete(), PyThread_tss_free(), PyThread_tss_get(), PyThread_tss_is_created(), PyThread_tss_set() (+49 more)
...
Cohesion: 0.11
Nodes (43): CYTHON_UNUSED, assert_direct_dimensions(), __Pyx_AddTraceback(), __pyx_array_get_memview(), __pyx_array_new(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_2__getbuffer__(), __Pyx_decode_c_string(), __Pyx_GetException() (+35 more)
...
Cohesion: 0.07
Nodes (37): AbstractEventLoop, MagicMock, str, TestClient, Pytest configuration and fixtures for talkingHead backend tests., async_session(), client(), event_loop() (+29 more)
...
Cohesion: 0.08
Nodes (19): HumanEval Dataset: openai_humaneval Metric:  pass@1 (fraction of problems where, MBPP — Mostly Basic Python Problems Dataset: google-research-datasets/mbpp (sani, BenchmarkResult, GenerateConfig, ModelBackend, BenchmarkResult, GenerateConfig, ModelBackend (+11 more)
...
Cohesion: 0.06
Nodes (33): md5_digest, size_bytes, md5_digest, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest (+25 more)
...
Cohesion: 0.24
Nodes (30): BaseBenchmark, ARCChallengeBenchmark, GPQADiamondBenchmark, GSM8KBenchmark, HellaSwagBenchmark, HumanEvalBenchmark, IFEvalBenchmark, LiveCodeBenchmark (+22 more)

### Community 39 - "Module Cluster 39"
Cohesion: 0.09
Nodes (32): CYTHON_NCP_UNUSED, _copy_strided_to_strided(), __pyx_array___cinit__(), __pyx_array___getitem__(), __pyx_array___len__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_10__getitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_6__len__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array___cinit__() (+24 more)
...
Cohesion: 0.07
Nodes (29): counts, oasst_train_used, openhermes_train_used, openhermes_val_used, slimorca_train_used, slimorca_val_used, train_total, val_total (+21 more)
...
Cohesion: 0.14
Nodes (27): abs_py_ssize_t(), __pyx_f_11piper_train_4vits_15monotonic_align_4core_maximum_path_c(), __pyx_f_11piper_train_4vits_15monotonic_align_4core_maximum_path_each(), __pyx_fatalerror(), __pyx_get_array_memory_extents(), __pyx_get_best_slice_order(), __Pyx_INC_MEMVIEW(), __pyx_memoryview_broadcast_leading() (+19 more)
...
Cohesion: 0.07
Nodes (27): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, de_DE-pavoque-low, aliases (+19 more)
...
Cohesion: 0.08
Nodes (24): account_id, ami, ckpt_s3, code_bundle_s3, ecr_image, gpu_memory_utilization, hf_export_s3, instance_profile (+16 more)
...
Cohesion: 0.10
Nodes (22): ARC Challenge Benchmark Adapter, Base Benchmark Abstract Class, GPQA Diamond Benchmark Adapter, GSM8K Grade School Math Benchmark, HellaSwag Commonsense NLI Benchmark, HumanEval Coding Benchmark (pass@1), IFEval Instruction Following Benchmark, LiveCodeBench Competitive Programming Benchmark (+14 more)
...
Cohesion: 0.10
Nodes (20): agents, default_llm_port, default_model, max_iterations, temperature, mcp_servers, map_echo_port, map_list_port (+12 more)
...
Cohesion: 0.12
Nodes (11): str, Shared fixtures for titanProject tests., Trivial tokenizer that maps each character to its ordinal., dummy_tokenizer(), DummyTokenizer, Create a small on-disk token cache with 3 shards for testing., Sample text for testing., Create a small text file with known content for dataset tests. (+3 more)
...
Cohesion: 0.12
Nodes (17): arith_stabilizer_train_added, microstory_train_added, source, train_total, val_copied_from, val_total, base_train, self_intro_train_added (+9 more)
...
Cohesion: 0.11
Nodes (19): md5_digest, size_bytes, md5_digest, size_bytes, size_bytes, files, md5_digest, size_bytes (+11 more)
...
Cohesion: 0.15
Nodes (10): fused_add_tanh_sigmoid_multiply(), init_weights(), ConvFlow, ConvReluNorm, ElementwiseAffine, ResidualCouplingLayer, piecewise_rational_quadratic_transform(), rational_quadratic_spline() (+2 more)
...
Cohesion: 0.14
Nodes (16): dag_retrieval, llm_timeout, temperature, frequency_penalty, max_tokens, top_p, talkingHead, port (+8 more)
...
Cohesion: 0.25
Nodes (14): bool, str, Run pytest with the given pattern., run_integration_tests(), run_tests(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments. (+6 more)
...
Cohesion: 0.18
Nodes (3): _normalize(), Light normalization: strip whitespace, LaTeX commas, dollar signs., TestGSM8KExtractor
...
Cohesion: 0.18
Nodes (10): base_train_path, base_val, arith_boosters_path, arith_train_added, base_val_path, intro_boosters_path, intro_train_added, source (+2 more)
...
Cohesion: 0.24
Nodes (8): _extract_answer(), _normalize(), GSM8K — Grade School Math Dataset: openai/gsm8k Metric:  accuracy (exact final n, Pull the final numeric answer out of a model response., BenchmarkResult, GenerateConfig, ModelBackend, str
...
Cohesion: 0.25
Nodes (6): BenchmarkResult, _extract(), MATH — Competition Math Benchmark Dataset: TIGER-Lab/MATH-plus (train split, cap, r"""Return the content of the first \boxed{...}, matching nested braces.      A, GenerateConfig, ModelBackend
...
Cohesion: 0.25
Nodes (7): base_train, base_val, curated_train_added, curated_val_added, source, val_total, train_total

### Community 202 - "Module Cluster 202"
Cohesion: 0.25
Nodes (7): source, base_train, base_val, story_train_added, story_val_added, train_total, val_total
...
Cohesion: 0.29
Nodes (6): _build_test(), Build a simple assertion block from public test cases., BenchmarkResult, GenerateConfig, ModelBackend, str
...
## Knowledge Gaps
- **1301 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1296 more)
...
- **Why does `AsyncMock` connect `Module Cluster 26` to `DAG Query Retrieval`, `Cython C Extensions`, `Module Cluster 44`, `Module Cluster 83`, `Model Training Data`, `Shared Config & Utilities`, `Module Cluster 155`, `Module Cluster 29`, `Module Cluster 62`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 40` to `Piper TTS Tests`, `Module Cluster 41`, `C++ JSON Library (json.hpp)`, `Module Cluster 112`, `SFT Fine-Tuning Pipeline`, `Module Cluster 48`, `SQL Agent & Test Harness`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `PiperVoice` connect `Module Cluster 71` to `Module Cluster 134`, `Module Cluster 239`, `Module Cluster 113`, `Module Cluster 81`, `Module Cluster 124`, `Module Cluster 29`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Are the 97 inferred relationships involving `BenchmarkResult` (e.g. with `ARCChallengeBenchmark` and `BaseBenchmark`) actually correct?**
  _`BenchmarkResult` has 97 INFERRED edges - model-reasoned connections that need verification._
- **Are the 90 inferred relationships involving `BaseBenchmark` (e.g. with `ARCChallengeBenchmark` and `BenchmarkResult`) actually correct?**
  _`BaseBenchmark` has 90 INFERRED edges - model-reasoned connections that need verification._
