...
## Summary
- 5400 nodes · 10009 edges · 355 communities (295 shown, 60 thin omitted)
...
## Communities (355 total, 60 thin omitted)
...
Cohesion: 0.04
Nodes (65): _parse(), BaseBenchmark, Run the benchmark against model and return a BenchmarkResult., _parse(), _answer_matches(), LoCoMo — Long-Context Conversation Memory Dataset: snap-research/LoCoMo Metric:, Loose match: expected answer appears in response (case-insensitive)., _extract() (+57 more)
...
Cohesion: 0.05
Nodes (52): AgentRunner, Connect to all MCP servers and discover tools., Disconnect from all MCP servers., Call the LLM's chat/completions endpoint., Maps a tool name to its MCP server client., Connects MCP tool servers to an OpenAI-compatible LLM., ToolRef, _make_chat_response() (+44 more)
...
Cohesion: 0.08
Nodes (54): __Pyx_AddTraceback(), __pyx_array_get_memview(), __Pyx_CLineForTraceback(), __Pyx_div_long(), __Pyx_ErrFetchInState(), __Pyx_ErrRestoreInState(), __pyx_f_11piper_train_4vits_15monotonic_align_4core_maximum_path_c(), __pyx_f_11piper_train_4vits_15monotonic_align_4core_maximum_path_each() (+46 more)
...
Cohesion: 0.07
Nodes (24): AnthropicBackend, HFLocalBackend, make_backend(), OpenAICompatBackend, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID, target shortcuts for frontier providers (format: <provider>:<model>):       open, Human-readable identifier stored in results. (+16 more)
...
Cohesion: 0.07
Nodes (23): Any, Comment, build_example(), convert_dataset(), is_bot(), is_generic_body(), is_reviewable_comment(), main() (+15 more)
...
Cohesion: 0.08
Nodes (22): BenchmarkResult, GenerateConfig, ModelBackend, BenchmarkResult, GenerateConfig, ModelBackend, BenchmarkResult, GenerateConfig (+14 more)
...
Cohesion: 0.09
Nodes (19): ABC, ARC Challenge — AI2 Reasoning Challenge (hard subset) Dataset: allenai/ARC (ARC-, Base class all benchmark adapters inherit from., GPQA Diamond — Graduate-level Google-Proof Q&A Dataset: google-deepmind/gpqa (gp, HumanEval Dataset: openai_humaneval Metric:  pass@1 (fraction of problems where, _build_test(), LiveCodeBench — Code Generation (Lite) Dataset: livecodebench/code_generation_li, Build a simple assertion block from public test cases. (+11 more)
...
Cohesion: 0.08
Nodes (12): _check_instruction(), IFEval — Instruction Following Evaluation Dataset: google/IFEval Metric:  prompt, Route to less/greater verifier based on the 'relation' kwarg., Return True if the response satisfies the instruction., _v_word_count_greater(), _v_word_count_less(), _v_word_count_relation(), BenchmarkResult (+4 more)
...
Cohesion: 0.07
Nodes (28): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes (+20 more)

### Community 55 - "Module Cluster 55"
Cohesion: 0.08
Nodes (26): AbstractEventLoop, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests., client(), event_loop(), isolate_config_cache(), mock_chat_processor() (+18 more)
...
Cohesion: 0.11
Nodes (22): Any, async_session(), mock_piper_voice(), Create a temporary audio file for testing., Sample text for testing., Sample message data for WebSocket tests., Sample phonemes for testing., Create a temporary SQLite database for testing. (+14 more)

### Community 74 - "Module Cluster 74"
Cohesion: 0.13
Nodes (22): CYTHON_NCP_UNUSED, abs_py_ssize_t(), _copy_strided_to_strided(), __pyx_array___len__(), __pyx_array_new(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_6__len__(), __Pyx_decode_c_string(), __pyx_get_best_slice_order() (+14 more)
...
Cohesion: 0.10
Nodes (21): ca_ES-upc_pau-x_low, aliases, key, name, num_speakers, quality, speaker_id_map, num_speakers (+13 more)
...
Cohesion: 0.14
Nodes (14): _mcp_tool_to_openai(), Any, float, int, str, Register an MCP server (FastMCP instance or URL string)., Return all registered tools in OpenAI function-calling format., Dispatch a tool call to the appropriate MCP server. (+6 more)
...
Cohesion: 0.11
Nodes (17): base_train, base_val, curated_train_added, curated_val_added, source, train_total, val_total, arith_boosters_path (+9 more)
...
Cohesion: 0.17
Nodes (18): filters, allow_http, max_digit_ratio, oasst_best_only, oasst_max_fails_task, oasst_max_spam, reject_role_markers, filters (+10 more)
...
Cohesion: 0.12
Nodes (15): base_val, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview, train_total (+7 more)
...
Cohesion: 0.15
Nodes (15): codereview, host, paths, port, scheme, batch, health, review (+7 more)
...
Cohesion: 0.15
Nodes (12): arith_stabilizer_train_added, base_train, microstory_train_added, source, train_total, val_copied_from, val_total, base_train (+4 more)
...
Cohesion: 0.15
Nodes (13): counts, logic_val_used, slimorca_train_used, slimorca_val_used, train_total, val_total, logic_train_used, oasst_train_used (+5 more)
...
Cohesion: 0.17
Nodes (12): agents, default_llm_port, default_model, max_iterations, dag_retrieval, llm_timeout, temperature, frequency_penalty (+4 more)
...
Cohesion: 0.38
Nodes (5): output_format, paths, val, train, seed
...
Cohesion: 0.50
Nodes (3): Dataset preparation: source review data → chat-format JSONL for SFT., maximum_path(), Cython optimized version.     neg_cent: [b, t_t, t_s]     mask: [b, t_t, t_s]
...
- **Why does `datetime` connect `Module Cluster 38` to `Module Cluster 39`, `Freud Memory Auditor`, `Eval Harness Tests`, `Module Cluster 44`, `PostgreSQL MCP Server`, `Module Cluster 119`, `Module Cluster 30`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `PiperVoice` connect `Module Cluster 72` to `Module Cluster 129`, `Module Cluster 73`, `Module Cluster 140`, `Module Cluster 241`, `Module Cluster 55`, `Module Cluster 120`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `VitsModel` connect `Module Cluster 35` to `Module Cluster 120`, `Piper TTS Tests`, `Module Cluster 207`, `Module Cluster 63`?**
