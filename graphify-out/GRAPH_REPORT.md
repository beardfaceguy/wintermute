...
## Summary
- 5350 nodes · 9914 edges · 353 communities (287 shown, 66 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 1093 edges (avg confidence: 0.64)
...
3. `BenchmarkResult` - 117 edges
4. `phoneme_id_map` - 115 edges
5. `BaseBenchmark` - 115 edges
...
## Communities (353 total, 66 thin omitted)
...
Cohesion: 0.04
Nodes (64): ABC, _parse(), BaseBenchmark, Base class all benchmark adapters inherit from., _parse(), _build_test(), Build a simple assertion block from public test cases., _answer_matches() (+56 more)
...
Cohesion: 0.05
Nodes (65): ca_ES-upc_ona-medium, aliases, language, name, num_speakers, quality, ca_ES-upc_ona-x_low, aliases (+57 more)
...
Cohesion: 0.06
Nodes (44): AbstractEventLoop, bytes, MagicMock, str, TestClient, Pytest configuration and fixtures for talkingHead backend tests., async_session(), client() (+36 more)
...
Cohesion: 0.11
Nodes (19): AnthropicBackend, HFLocalBackend, OpenAICompatBackend, str, Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID, Human-readable identifier stored in results. (+11 more)
...
Cohesion: 0.11
Nodes (14): ARC Challenge — AI2 Reasoning Challenge (hard subset) Dataset: allenai/ARC (ARC-, GPQA Diamond — Graduate-level Google-Proof Q&A Dataset: google-deepmind/gpqa (gp, GSM8K — Grade School Math Dataset: openai/gsm8k Metric:  accuracy (exact final n, LiveCodeBench — Code Generation (Lite) Dataset: livecodebench/code_generation_li, LoCoMo — Long-Context Conversation Memory Dataset: snap-research/LoCoMo Metric:, MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac, OR-Bench — Over-Refusal Benchmark Dataset: bench-llm/or-bench Metric:  complianc, SWE-bench Verified Dataset: princeton-nlp/SWE-bench_Verified Metric:  resolve_ra (+6 more)
...
Cohesion: 0.13
Nodes (8): make_backend(), target shortcuts for frontier providers (format: <provider>:<model>):       open, Tests for eval/model.py — backend factory and provider shortcut parsing.  All te, make_backend() shortcut routing., Regression: empty content list should return '' not raise IndexError., TestAnthropicBackendEmptyResponse, TestGenerateConfig, TestMakeBackendFactory
...
Cohesion: 0.12
Nodes (17): logic_train_used, logic_val_used, oasst_train_used, openhermes_train_used, slimorca_train_used, val_total, output_format, paths (+9 more)
...
Cohesion: 0.13
Nodes (16): base_train, self_intro_train_added, source, train_total, val_copied_from, val_total, arith_stabilizer_train_added, base_train (+8 more)
...
Cohesion: 0.17
Nodes (18): filters, allow_http, max_assistant_chars, max_digit_ratio, max_user_chars, oasst_min_helpfulness, reject_role_markers, filters (+10 more)
...
Cohesion: 0.25
Nodes (11): bool, float, int, Path, str, Batch, PiperDataset, Dataset format:      * phoneme_ids (required)     * audio_norm_path (required) (+3 more)
...
Cohesion: 0.12
Nodes (17): key, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, de_DE-thorsten-medium, aliases (+9 more)

### Community 117 - "Module Cluster 117"
Cohesion: 0.12
Nodes (17): name, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, en_GB-aru-medium (+9 more)

### Community 118 - "Module Cluster 118"
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, el_GR-rapunzelina-low, aliases, files (+9 more)

### Community 119 - "Module Cluster 119"
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, en_GB-alan-medium, aliases (+9 more)
...
Cohesion: 0.25
Nodes (14): bool, int, str, Run pytest with the given pattern., Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments., Run integration tests. (+6 more)
...
Cohesion: 0.17
Nodes (11): base_val_path, arith_boosters_path, arith_train_added, base_train, base_train_path, intro_boosters_path, intro_train_added, story_boosters_path (+3 more)
...
Cohesion: 0.23
Nodes (7): ConvFlow, ConvReluNorm, ElementwiseAffine, piecewise_rational_quadratic_transform(), rational_quadratic_spline(), searchsorted(), unconstrained_rational_quadratic_spline()
...
Cohesion: 0.25
Nodes (8): ARC Challenge Benchmark Adapter, GPQA Diamond Benchmark Adapter, GSM8K Grade School Math Benchmark, HellaSwag Commonsense NLI Benchmark, MATH Competition Math Benchmark, MMLU Multitask Language Understanding Benchmark, WinoGrande Commonsense Pronoun Benchmark, Tests: MC Answer Parsers (GPQA/MMLU/ARC/HellaSwag/GSM8K/MATH)
...
Cohesion: 0.33
Nodes (4): BenchmarkResult, Run the benchmark against model and return a BenchmarkResult., GenerateConfig, ModelBackend
...
Cohesion: 0.50
Nodes (4): HumanEval Coding Benchmark (pass@1), LiveCodeBench Competitive Programming Benchmark, MBPP Python Programming Benchmark, pass@1 Metric for Code Benchmark Evaluation
...
Cohesion: 0.67
Nodes (3): OR-Bench Over-Refusal Benchmark, XSTest Exaggerated Safety Benchmark, Refusal Heuristic Detection via Phrase Matching
...
Cohesion: 0.67
Nodes (3): Test Fixtures: Config Cache, Mock Embeddings, Tests: Eval Model Backend Factory, Tests: Eval Results Store CRUD

## Knowledge Gaps
- **1295 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1290 more)
...
- **Why does `datetime` connect `Module Cluster 39` to `Module Cluster 40`, `Module Cluster 46`, `Module Cluster 114`, `PostgreSQL MCP Server`, `SQL Agent & Test Harness`, `talkingHead FastAPI Backend`, `Module Cluster 26`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `PiperVoice` connect `Module Cluster 73` to `talkingHead WebSocket & TTS`, `Module Cluster 66`, `Module Cluster 134`, `Module Cluster 126`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `VitsModel` connect `Module Cluster 60` to `Module Cluster 66`, `Freud Memory Auditor`, `Piper TTS Tests`, `Module Cluster 107`, `Module Cluster 204`, `Module Cluster 143`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Are the 98 inferred relationships involving `BenchmarkResult` (e.g. with `ARCChallengeBenchmark` and `GPQADiamondBenchmark`) actually correct?**
  _`BenchmarkResult` has 98 INFERRED edges - model-reasoned connections that need verification._
- **Are the 95 inferred relationships involving `BaseBenchmark` (e.g. with `ARCChallengeBenchmark` and `GPQADiamondBenchmark`) actually correct?**
  _`BaseBenchmark` has 95 INFERRED edges - model-reasoned connections that need verification._
