...
class PromptDepthAnythingNeck(nn.Module):
    ...
    * PromptDepthAnythingFeatureFusionStage.
    ...
    def forward(self, hidden_states: List[torch.Tensor], patch_height: Optional[int] = ..., patch_width: Optional[int] = ..., prompt_depth: Optional[torch.Tensor] = ...) -> List[torch.Tensor]:
        """
        Args:
...
class PromptDepthAnythingForDepthEstimation(PromptDepthAnythingPreTrainedModel):
    ...
    @auto_docstring
    def forward(self, pixel_values: torch.FloatTensor, prompt_depth: Optional[torch.FloatTensor] = ..., labels: Optional[torch.LongTensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...) -> Union[Tuple[torch.Tensor], DepthEstimatorOutput]:
        r"""
