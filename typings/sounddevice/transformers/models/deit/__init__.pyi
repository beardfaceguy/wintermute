...
class TFDeiTEmbeddings(keras.layers.Layer):
    ...
    def call(self, pixel_values: tf.Tensor, bool_masked_pos: tf.Tensor | None = ..., training: bool = ..., interpolate_pos_encoding: bool = ...) -> tf.Tensor:
        ...
...
class TFDeiTMainLayer(keras.layers.Layer):
    ...
    @unpack_inputs
    def call(self, pixel_values: tf.Tensor | None = ..., bool_masked_pos: tf.Tensor | None = ..., head_mask: tf.Tensor | None = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., interpolate_pos_encoding: bool = ..., training: bool = ...) -> Union[TFBaseModelOutputWithPooling, Tuple[tf.Tensor, ...]]:
        ...
...
class TFDeiTModel(TFDeiTPreTrainedModel):
    ...
    def call(self, pixel_values: tf.Tensor | None = ..., bool_masked_pos: tf.Tensor | None = ..., head_mask: tf.Tensor | None = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., interpolate_pos_encoding: bool = ..., training: bool = ...) -> Union[Tuple, TFBaseModelOutputWithPooling]:
        ...
...
class TFDeiTForMaskedImageModeling(TFDeiTPreTrainedModel):
    ...
    def call(self, pixel_values: tf.Tensor | None = ..., bool_masked_pos: tf.Tensor | None = ..., head_mask: tf.Tensor | None = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., interpolate_pos_encoding: bool = ..., training: bool = ...) -> Union[tuple, TFMaskedImageModelingOutput]:
        r"""
...
class TFDeiTForImageClassification(TFDeiTPreTrainedModel, TFSequenceClassificationLoss):
    ...
    def call(self, pixel_values: tf.Tensor | None = ..., head_mask: tf.Tensor | None = ..., labels: tf.Tensor | None = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., interpolate_pos_encoding: bool = ..., training: bool = ...) -> Union[tf.Tensor, TFImageClassifierOutput]:
        r"""
...
class TFDeiTForImageClassificationWithTeacher(TFDeiTPreTrainedModel):
    ...
    def call(self, pixel_values: tf.Tensor | None = ..., head_mask: tf.Tensor | None = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., interpolate_pos_encoding: bool = ..., training: bool = ...) -> Union[tuple, TFDeiTForImageClassificationWithTeacherOutput]:
        ...
...
__all__ = ["TFDeiTForImageClassification", "TFDeiTForImageClassificationWithTeacher", "TFDeiTForMaskedImageModeling", "TFDeiTModel", "TFDeiTPreTrainedModel"]
