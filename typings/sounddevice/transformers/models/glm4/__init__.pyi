...
class Glm4ForCausalLM(GlmForCausalLM):
    def forward(self, **super_kwargs: Unpack[KwargsForCausalLM]) -> Union[Tuple, CausalLMOutputWithPast]:
        r"""
...
__all__ = ["Glm4PreTrainedModel", "Glm4Model", "Glm4ForCausalLM", "Glm4ForSequenceClassification", "Glm4ForTokenClassification"]
