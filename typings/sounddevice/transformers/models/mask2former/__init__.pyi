...
class Mask2FormerPixelDecoderEncoderMultiscaleDeformableAttention(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, attention_mask: Optional[torch.Tensor] = ..., encoder_hidden_states=..., encoder_attention_mask=..., position_embeddings: Optional[torch.Tensor] = ..., reference_points=..., spatial_shapes_list=..., level_start_index=..., output_attentions: bool = ...): # -> tuple[Any, Tensor]:
        ...
...
class Mask2FormerPixelDecoderEncoderLayer(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, attention_mask: torch.Tensor, position_embeddings: Optional[torch.Tensor] = ..., reference_points=..., spatial_shapes_list=..., level_start_index=..., output_attentions: bool = ...): # -> tuple[Tensor, Any] | tuple[Tensor]:
        """
        Args:
...
class Mask2FormerPixelDecoderEncoderOnly(nn.Module):
    ...
    def forward(self, inputs_embeds=..., attention_mask=..., position_embeddings=..., spatial_shapes_list=..., level_start_index=..., valid_ratios=..., output_attentions=..., output_hidden_states=..., return_dict=...): # -> BaseModelOutput:
        r"""
        Args:
...
class Mask2FormerMaskPredictor(nn.Module):
    ...
    def forward(self, outputs: torch.Tensor, pixel_embeddings: torch.Tensor, attention_mask_target_size: Optional[int] = ...): # -> tuple[Tensor, Any]:
        ...
