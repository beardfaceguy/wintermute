...
## Summary
- 5359 nodes · 9949 edges · 353 communities (290 shown, 63 thin omitted)
...
## Communities (353 total, 63 thin omitted)
...
Cohesion: 0.05
Nodes (60): BaseBenchmark, _answer_matches(), Loose match: expected answer appears in response (case-insensitive)., _parse_answer(), MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac, subjects:         list of MMLU subject names, or None for all 57         max_per, _is_refusal(), BenchmarkResult (+52 more)
...
Cohesion: 0.05
Nodes (64): ca_ES-upc_ona-medium, aliases, key, language, num_speakers, quality, speaker_id_map, da_DK-talesyntese-medium (+56 more)

### Community 7 - "Freud Memory Auditor"
Cohesion: 0.05
Nodes (63): __pyx_array___getitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_10__getitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_12__setitem__(), __pyx_array___setitem__(), __Pyx_GetAttr3(), __Pyx_GetAttr3Default(), __pyx_getprop___pyx_array_memview(), __pyx_getprop___pyx_memoryview_base() (+55 more)
...
Cohesion: 0.08
Nodes (58): abs_py_ssize_t(), __Pyx_AddTraceback(), __pyx_array_get_memview(), __pyx_array_new(), __Pyx_CLineForTraceback(), __Pyx_decode_c_string(), __Pyx_div_long(), __Pyx_ErrFetchInState() (+50 more)
...
Cohesion: 0.05
Nodes (51): Allocator, compares_unordered, adl_serializer, boolean(), clear(), dump_integer(), get_error_message(), get_number_unsigned() (+43 more)

### Community 12 - "RAG Query Layer"
Cohesion: 0.04
Nodes (29): _parse(), _parse(), _extract_answer(), _normalize(), GSM8K — Grade School Math Dataset: openai/gsm8k Metric:  accuracy (exact final n, Pull the final numeric answer out of a model response., _extract(), _normalize() (+21 more)
...
Cohesion: 0.11
Nodes (38): back(), empty(), end_array(), end_object(), get_number_float(), get_token_string(), handle_value(), is_array() (+30 more)
...
Cohesion: 0.07
Nodes (25): AnthropicBackend, HFLocalBackend, make_backend(), OpenAICompatBackend, Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID, target shortcuts for frontier providers (format: <provider>:<model>):       open (+17 more)
...
Cohesion: 0.07
Nodes (16): Tests for SFT data format parsing in finetune_sft.py.  Covers all four supported, Some datasets use 'conversation' (singular) instead of 'conversations'., ShareGPT datasets use varying role names., output' should work as alias for 'response' (standard Alpaca key)., If both 'response' and 'output' exist, 'response' wins., Should accept 'content', 'value', and 'text' keys., TestAlpacaFormat, TestChatTextFormat (+8 more)
...
Cohesion: 0.11
Nodes (24): CausalLMOutputWithCrossAttentions, bool, int, str, Tensor, device, float, int (+16 more)

### Community 30 - "Module Cluster 30"
Cohesion: 0.10
Nodes (16): int, str, bool, int, str, FakeChatTokenizer, Extended tests for finetune_sft.py — covers functions NOT in test_sft_formats.py, Minimal tokenizer stub that supports apply_chat_template for testing. (+8 more)

### Community 31 - "Module Cluster 31"
Cohesion: 0.07
Nodes (26): AbstractEventLoop, str, Shared fixtures for titanProject tests., Trivial tokenizer that maps each character to its ordinal., MagicMock, TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests. (+18 more)

### Community 32 - "Module Cluster 32"
Cohesion: 0.09
Nodes (19): HumanEval Dataset: openai_humaneval Metric:  pass@1 (fraction of problems where, _build_test(), LiveCodeBench — Code Generation (Lite) Dataset: livecodebench/code_generation_li, Build a simple assertion block from public test cases., BenchmarkResult, GenerateConfig, ModelBackend, str (+11 more)

### Community 33 - "Module Cluster 33"
Cohesion: 0.07
Nodes (25): _cleanup(), _init_gloo(), Tests for distributed training utilities: DDP helpers, data sharding, grad accum, Only rank 0 should produce log output., total_tokens_seen should account for all GPUs., Verify the sync_context logic produces correct context managers., On the last accumulation micro-batch, gradients should sync (nullcontext)., On non-last micro-batches, no_sync should be used. (+17 more)
...
Cohesion: 0.16
Nodes (22): device, Path, str, _hf_tokenizer_to_adapter(), main(), Wrap a raw HuggingFace tokenizer into a TokenizerAdapter for the SFT data pipeli, main(), Unified training loop for Titans models.  Supports single-GPU, multi-GPU (DDP), (+14 more)
...
Cohesion: 0.10
Nodes (21): codereview, paths, port, frequency_penalty, temperature, top_p, batch, health (+13 more)
...
Cohesion: 0.15
Nodes (6): memmap, Tensor, Token cache shard-based slicing., A shard with num_tokens=0 must raise an error, not spin forever., TestTokenCache, TokenCache
...
Cohesion: 0.13
Nodes (15): int, add_timing_signal_1d(), cat_timing_signal_1d(), fused_add_tanh_sigmoid_multiply(), generate_path(), get_timing_signal_1d(), init_weights(), rand_gumbel() (+7 more)
...
Cohesion: 0.19
Nodes (14): bool, float, int, Path, str, TokenizerAdapter encode/decode contract., TestTokenizerAdapter, generate() (+6 more)

### Community 91 - "Module Cluster 91"
Cohesion: 0.15
Nodes (8): Tests for data.py: TokenCache, TextWindowDataset, cache utilities., Dataset indexing and window construction., Building the dataset twice with same params should reuse cache., Dataloader construction., TestBuildDataloader, TestTextWindowDataset, Disk-backed dataset that tokenizes the corpus once into a cache file and     sli, TextWindowDataset
...
Cohesion: 0.11
Nodes (19): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, files, size_bytes (+11 more)
...
Cohesion: 0.11
Nodes (19): speaker_id_map, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest (+11 more)
...
Cohesion: 0.13
Nodes (11): bool, Tensor, ConvFlow, ConvReluNorm, ElementwiseAffine, Flip, ResidualCouplingLayer, piecewise_rational_quadratic_transform() (+3 more)
...
Cohesion: 0.17
Nodes (18): oasst_best_only, oasst_max_fails_task, oasst_max_spam, oasst_min_helpfulness, reject_role_markers, filters, allow_http, max_assistant_chars (+10 more)
...
Cohesion: 0.14
Nodes (8): Tests for training utilities: LR schedules, path resolution, hashing, checkpoint, S3 tokenizer downloads must not collide when only the basename matches., Two S3 URIs with the same filename but different prefixes must         download, Path resolution logic., TestGetTokenizerS3PathCollision, TestResolvePath, TestSha256File, sha256_file()
...
Cohesion: 0.14
Nodes (14): de_DE-karlsson-low, key, name, num_speakers, quality, speaker_id_map, en_GB-alan-medium, aliases (+6 more)
...
Cohesion: 0.25
Nodes (14): bool, int, Run pytest with the given pattern., run_specific_test(), run_unit_tests(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments. (+6 more)
...
Cohesion: 0.15
Nodes (12): arith_stabilizer_train_added, microstory_train_added, train_total, val_copied_from, val_total, base_train, self_intro_train_added, source (+4 more)

### Community 144 - "Module Cluster 144"
Cohesion: 0.18
Nodes (8): bool, float, int, TestIsMain, TestReduceScalar, is_main(), All-reduce a scalar value (mean) across ranks., reduce_scalar()
...
Cohesion: 0.15
Nodes (13): logic_train_used, logic_val_used, oasst_train_used, openhermes_train_used, openhermes_val_used, slimorca_train_used, train_total, val_total (+5 more)
...
Cohesion: 0.20
Nodes (10): output_format, paths, train, val, seed, base_train, broader_story_train_added, source (+2 more)

### Community 165 - "Module Cluster 165"
Cohesion: 0.17
Nodes (11): arith_boosters_path, arith_train_added, base_train, base_train_path, base_val, intro_boosters_path, intro_train_added, source (+3 more)
...
Cohesion: 0.18
Nodes (10): base_train, base_val_path, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview (+2 more)
...
Cohesion: 0.25
Nodes (8): agents, default_llm_port, default_model, max_iterations, dag_retrieval, llm_timeout, max_tokens, temperature
...
Cohesion: 0.29
Nodes (6): source, base_val, base_train, story_train_added, story_val_added, train_total
...
Cohesion: 0.33
Nodes (4): DEBIAN_FRONTEND, PY, SCRIPTS, bootstrap.sh script
...
## Knowledge Gaps
- **1286 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1281 more)
...
- **Why does `AsyncMock` connect `Module Cluster 26` to `DAG Query Retrieval`, `Module Cluster 76`, `Module Cluster 46`, `Module Cluster 49`, `PostgreSQL MCP Server`, `Module Cluster 87`, `Module Cluster 27`, `Module Cluster 62`, `Module Cluster 31`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 38` to `Module Cluster 58`, `Module Cluster 39`, `Module Cluster 43`, `SFT Fine-Tuning Pipeline`, `talkingHead FastAPI Backend`, `TTS Voice Subsystem`, `Module Cluster 122`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `VoiceNotFoundError` connect `Module Cluster 72` to `C++ JSON Library (json.hpp)`?**
