...
class Qwen2AudioProcessor(ProcessorMixin):
    ...
    tokenizer_class = ...
    def __init__(self, feature_extractor=..., tokenizer=..., chat_template=..., audio_token=..., audio_bos_token=..., audio_eos_token=...) -> None:
        ...
    
    @deprecate_kwarg("audios", version="4.54.0", new_name="audio")
    def __call__(self, text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = ..., audio: Union[np.ndarray, List[np.ndarray]] = ..., audios=..., **kwargs: Unpack[Qwen2AudioProcessorKwargs]) -> BatchFeature:
        """
