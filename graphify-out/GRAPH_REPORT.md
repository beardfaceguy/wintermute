...
## Summary
- 5367 nodes · 9949 edges · 357 communities (295 shown, 62 thin omitted)
...
## Communities (357 total, 62 thin omitted)
...
Cohesion: 0.05
Nodes (57): _parse(), BaseBenchmark, Run the benchmark against model and return a BenchmarkResult., _parse(), _answer_matches(), Loose match: expected answer appears in response (case-insensitive)., max_samples: cap total problems (0 = all ~893k — use a cap in practice), max_per_tier: samples per difficulty tier (0-9)         tiers:        which tier (+49 more)

### Community 4 - "HuggingFace Model Utilities"
Cohesion: 0.04
Nodes (78): ca_ES-upc_ona-medium, aliases, key, language, num_speakers, quality, speaker_id_map, ca_ES-upc_pau-x_low (+70 more)
...
Cohesion: 0.06
Nodes (58): AuditFinding, AuditReport, check_contradictions_ann(), check_near_duplicates_ann(), FreudAuditor, main(), _neighbors_query(), _print_report() (+50 more)
...
Cohesion: 0.06
Nodes (52): CYTHON_SMALL_CODE, PyInit_core(), __pyx_array___dealloc__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_4__dealloc__(), __pyx_bisect_code_objects(), __Pyx_BufFmt_CheckString(), __Pyx_BufFmt_DescribeTypeChar(), __Pyx_BufFmt_ExpectNumber() (+44 more)

### Community 9 - "Piper TTS Tests"
Cohesion: 0.09
Nodes (59): check_low_quality(), _is_pair_owner(), Flag entries that are too short, empty, or garbled., Return True iff `entry` should own the pair (entry, neighbor) finding.      Olde, datetime, ExitStack, _enter_all(), _fresh() (+51 more)

### Community 10 - "Eval Harness Tests"
Cohesion: 0.06
Nodes (59): __pyx_array___getattr__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_12__setitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_8__getattr__(), __pyx_array___setitem__(), __Pyx_GetAttr(), __Pyx_GetAttr3(), __Pyx_GetAttr3Default(), __pyx_getprop___pyx_array_memview() (+51 more)
...
Cohesion: 0.06
Nodes (54): CYTHON_INLINE, PyThread_tss_alloc(), PyThread_tss_create(), PyThread_tss_delete(), PyThread_tss_free(), PyThread_tss_get(), PyThread_tss_is_created(), PyThread_tss_set() (+46 more)

### Community 17 - "SFT Fine-Tuning Pipeline"
Cohesion: 0.09
Nodes (50): _embed(), _ensure_hnsw_index(), _ensure_tables(), _entry_to_dict(), _get_embedder(), memory_add(), memory_flag(), memory_promote() (+42 more)

### Community 18 - "talkingHead FastAPI Backend"
Cohesion: 0.05
Nodes (16): _extract_answer(), _normalize(), GSM8K — Grade School Math Dataset: openai/gsm8k Metric:  accuracy (exact final n, Pull the final numeric answer out of a model response., BenchmarkResult, GenerateConfig, ModelBackend, str (+8 more)
...
Cohesion: 0.07
Nodes (25): AnthropicBackend, HFLocalBackend, make_backend(), OpenAICompatBackend, str, Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID (+17 more)
...
Cohesion: 0.09
Nodes (44): abs_py_ssize_t(), __pyx_array_get_memview(), __Pyx_div_long(), __pyx_f_11piper_train_4vits_15monotonic_align_4core_maximum_path_c(), __pyx_f_11piper_train_4vits_15monotonic_align_4core_maximum_path_each(), __pyx_fatalerror(), __pyx_fill_contig_strides_array(), __pyx_get_array_memory_extents() (+36 more)

### Community 24 - "Eval Benchmark Adapters"
Cohesion: 0.07
Nodes (25): _build_test(), LiveCodeBench — Code Generation (Lite) Dataset: livecodebench/code_generation_li, Build a simple assertion block from public test cases., MBPP — Mostly Basic Python Problems Dataset: google-research-datasets/mbpp (sani, BenchmarkResult, GenerateConfig, ModelBackend, BenchmarkResult (+17 more)
...
Cohesion: 0.11
Nodes (29): bool, float, int, object, str, device, int, str (+21 more)

### Community 28 - "Module Cluster 28"
Cohesion: 0.09
Nodes (19): Tests for model.py: model factory, forward pass shapes, config validation., ModelConfig dataclass defaults and construction., HFGPT2LM forward pass shape checks., Sanity check that model parameter counts scale as expected., build_model factory function., GPTLM forward pass shape and behavior checks., TestBuildModel, TestGPTLMForward (+11 more)
...
Cohesion: 0.09
Nodes (32): CYTHON_NCP_UNUSED, _copy_strided_to_strided(), __pyx_array___len__(), __pyx_array_new(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_6__len__(), __Pyx_decode_c_string(), __Pyx_div_Py_ssize_t(), __Pyx_GetItemInt_Fast() (+24 more)
...
Cohesion: 0.12
Nodes (32): __Pyx_AddTraceback(), __pyx_array___getitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_10__getitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array___cinit__(), __Pyx_CLineForTraceback(), __Pyx_ErrFetchInState(), __Pyx_ErrRestoreInState(), __Pyx_GetException() (+24 more)
...
Cohesion: 0.12
Nodes (29): _build_llm_prompt(), _clean_sql(), _generate_sql_from_hints(), main(), _parse_args(), preflight_check(), _print_summary(), Any (+21 more)
...
Cohesion: 0.09
Nodes (27): Any, async_session(), mock_piper_voice(), Create a temporary audio file for testing., Create a sample audio file for testing voice upload., Sample text for testing., Sample message data for WebSocket tests., Sample phonemes for testing. (+19 more)

### Community 52 - "Module Cluster 52"
Cohesion: 0.11
Nodes (15): ABC, ARC Challenge — AI2 Reasoning Challenge (hard subset) Dataset: allenai/ARC (ARC-, Base class all benchmark adapters inherit from., GPQA Diamond — Graduate-level Google-Proof Q&A Dataset: google-deepmind/gpqa (gp, HumanEval Dataset: openai_humaneval Metric:  pass@1 (fraction of problems where, LoCoMo — Long-Context Conversation Memory Dataset: snap-research/LoCoMo Metric:, MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac, OR-Bench — Over-Refusal Benchmark Dataset: bench-llm/or-bench Metric:  complianc (+7 more)

### Community 53 - "Module Cluster 53"
Cohesion: 0.08
Nodes (22): AbstractEventLoop, Shared fixtures for titanProject tests., TestClient, mock_whisper_model(), Pytest configuration and fixtures for talkingHead backend tests., client(), event_loop(), mock_chat_processor() (+14 more)
...
Cohesion: 0.08
Nodes (27): account_id, ami, ckpt_s3, code_bundle_s3, ecr_image, gpu_memory_utilization, hf_export_s3, instance_profile (+19 more)
...
Cohesion: 0.09
Nodes (25): mcp_memory, default_db_url, embed_model, port, mcp_servers, map_echo_port, map_list_port, postgres_default_url (+17 more)
...
Cohesion: 0.09
Nodes (23): ca_ES-upc_ona-x_low, aliases, key, language, name, num_speakers, quality, cs_CZ-jirka-medium (+15 more)

### Community 68 - "Module Cluster 68"
Cohesion: 0.09
Nodes (23): check_near_duplicates(), _cosine_sim(), Detect near-duplicate entries via embedding cosine similarity.      O(n^2) but f, Opposite direction vectors should have similarity -1.0., Zero vector should return 0.0 (avoid division by zero)., Two zero vectors should return 0.0., 45-degree vectors should give cos(45°) ≈ 0.7071., Vectors of different lengths should return 0.0, not silently truncate. (+15 more)
...
Cohesion: 0.09
Nodes (23): md5_digest, size_bytes, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, md5_digest (+15 more)
...
Cohesion: 0.12
Nodes (15): int, x: decoder input         h: encoder output, add_timing_signal_1d(), cat_timing_signal_1d(), fused_add_tanh_sigmoid_multiply(), generate_path(), get_timing_signal_1d(), rand_gumbel() (+7 more)
...
Cohesion: 0.14
Nodes (11): _make_entry(), Tests for the memory_flag tool., Build a mock MemoryEntry with sensible defaults., Tests for the _entry_to_dict helper (pure function, no mocking needed)., All fields are present and correctly typed., None tags become an empty dict., None trust_score becomes 0.0., None created_at becomes None in the dict. (+3 more)
...
Cohesion: 0.14
Nodes (12): bool, Tensor, init_weights(), ConvFlow, ConvReluNorm, ElementwiseAffine, Flip, ResidualCouplingLayer (+4 more)
...
Cohesion: 0.15
Nodes (18): __pyx_align_pointer(), __Pyx__ArgTypeTest(), __pyx_array___cinit__(), __Pyx_InBases(), __Pyx_IsSubtype(), __pyx_memoryview___cinit__(), __pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview___cinit__(), __pyx_MemviewEnum___init__() (+10 more)
...
Cohesion: 0.13
Nodes (10): CausalLMOutputWithCrossAttentions, bool, int, str, Tensor, PretrainedConfig, PreTrainedModel, Hugging Face compatibility shim for titans-pytorch checkpoints.  This provides: (+2 more)
...
Cohesion: 0.26
Nodes (13): ensure_voice_exists(), find_voice(), get_voices(), Utility for downloading Piper voices., Loads available voices from downloaded or embedded JSON file., VoiceNotFoundError, main(), load_state_dict() (+5 more)
...
Cohesion: 0.25
Nodes (14): bool, str, Run pytest with the given pattern., run_specific_test(), run_tests(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments. (+6 more)
...
Cohesion: 0.21
Nodes (9): Dataset, eval_depths(), load_filler(), main(), NeedleDocs, Long-context TEXT recall on the lucidrains MAC (Vikunja #952, option 4) — the pr, Keep only words that encode (with a leading space) to exactly one token., One buried-fact document per item. Answer = single value token at the last     p (+1 more)
...
Cohesion: 0.15
Nodes (12): base_train_path, arith_boosters_path, arith_train_added, base_train, base_val, base_val_path, intro_boosters_path, intro_train_added (+4 more)
...
Cohesion: 0.15
Nodes (8): sql_describe_table returns schema, table, row_count, columns, pk, fk., Tests for the sql_sample_rows tool., Limit below 1 is clamped to 1., Limit above 20 is clamped to 20., Successful call returns columns, rows, and row_count., Database errors are caught and returned as error dicts., Exceptions from _run_query produce error dicts., TestSqlSampleRows
...
Cohesion: 0.26
Nodes (11): Validate query results against the expected specification., validate_result(), Tests for agents/sql_agent.py — batch resilience and validation logic.  The sql_, row_count check passes when enough rows are returned., row_count check fails when too few rows., test_validate_columns_present_fail(), test_validate_columns_present_pass(), test_validate_handles_error_in_result() (+3 more)
...
Cohesion: 0.17
Nodes (12): agents, default_llm_port, default_model, max_iterations, temperature, dag_retrieval, llm_timeout, frequency_penalty (+4 more)
...
Cohesion: 0.26
Nodes (12): __Pyx_BufFmt_Init(), __pyx_check_strides(), __pyx_memoryview_check(), __pyx_memoryview_new(), __pyx_pw_11piper_train_4vits_15monotonic_align_4core_1maximum_path_c(), __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_float(), __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_int(), __Pyx_PyObject_to_MemoryviewSlice_dc_int() (+4 more)

### Community 159 - "Module Cluster 159"
Cohesion: 0.17
Nodes (12): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, files, md5_digest (+4 more)

### Community 160 - "Module Cluster 160"
Cohesion: 0.17
Nodes (12): logic_val_used, oasst_train_used, openhermes_train_used, openhermes_val_used, slimorca_train_used, slimorca_val_used, train_total, val_total (+4 more)
...
Cohesion: 0.22
Nodes (9): base_train, paths, train, seed, output_format, val, train_total, val_copied_from (+1 more)

### Community 167 - "Module Cluster 167"
Cohesion: 0.18
Nodes (10): base_train, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split, selected_preview, source (+2 more)

### Community 168 - "Module Cluster 168"
Cohesion: 0.18
Nodes (11): filters, max_digit_ratio, oasst_best_only, oasst_max_fails_task, oasst_min_helpfulness, allow_http, max_assistant_chars, max_user_chars (+3 more)
...
Cohesion: 0.25
Nodes (6): Tests for mcp_servers/mcp_postgres/server.py — read-only SQL MCP server.  All da, Tests for the sql_list_tables tool., sql_list_tables queries information_schema.tables correctly., Tests for the sql_describe_table tool., TestSqlDescribeTable, TestSqlListTables
...
Cohesion: 0.25
Nodes (7): arith_stabilizer_train_added, val_copied_from, base_train, broader_story_train_added, source, train_total, val_total
...
Cohesion: 0.32
Nodes (4): str, Trivial tokenizer that maps each character to its ordinal., dummy_tokenizer(), DummyTokenizer
...
Cohesion: 0.29
Nodes (6): curated_train_added, curated_val_added, source, train_total, base_val, val_total

### Community 227 - "Module Cluster 227"
Cohesion: 0.29
Nodes (6): arith_stabilizer_train_added, base_train, microstory_train_added, self_intro_train_added, source, train_total
...
Cohesion: 0.29
Nodes (7): filters, max_input_chars, max_instruction_chars, max_response_chars, max_response_newlines, min_response_chars, rejected_response_substrings
...
Cohesion: 0.50
Nodes (4): paths, batch, health, review
...
## Knowledge Gaps
- **1291 isolated node(s):** `start_backend_and_docker.sh script`, `include`, `exclude`, `extraPaths`, `reportMissingImports` (+1286 more)
...
- **Why does `AsyncMock` connect `PostgreSQL MCP Server` to `GPT-2 Pretraining Pipeline`, `Module Cluster 35`, `Module Cluster 106`, `Module Cluster 43`, `Module Cluster 44`, `Module Cluster 46`, `Model Training Data`, `Module Cluster 53`, `Module Cluster 156`, `Module Cluster 61`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `datetime` connect `Piper TTS Tests` to `Module Cluster 37`, `Cython C Extensions`, `Module Cluster 40`, `SFT Fine-Tuning Pipeline`, `Module Cluster 115`, `Module Cluster 255`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `VoiceNotFoundError` connect `Module Cluster 116` to `TTS Voice Subsystem`?**
