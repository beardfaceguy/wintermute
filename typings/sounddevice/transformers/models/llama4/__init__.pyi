...
class Llama4Processor(ProcessorMixin):
    ...
    tokenizer_class = ...
    def __init__(self, image_processor=..., tokenizer=..., patch_size: int = ..., pixel_shuffle_ratio: float = ..., fake_image_token=..., image_token=..., start_of_image_token=..., end_of_image_token=..., patch_token=..., tile_x_separator_token=..., tile_y_separator_token=..., chat_template=..., **kwargs) -> None:
        ...
    
    def __call__(self, images: Optional[ImageInput] = ..., text: Optional[Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]]] = ..., audio=..., videos=..., **kwargs: Unpack[Llama4ProcessorKwargs]) -> BatchFeature:
        """
