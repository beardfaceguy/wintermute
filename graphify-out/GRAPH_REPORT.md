...
## Summary
- 5363 nodes · 9951 edges · 349 communities (287 shown, 62 thin omitted)
...
## Communities (349 total, 62 thin omitted)
...
Cohesion: 0.05
Nodes (64): language, cs_CZ-jirka-medium, key, language, name, num_speakers, quality, speaker_id_map (+56 more)
...
Cohesion: 0.06
Nodes (56): __pyx_array___getattr__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_12__setitem__(), __pyx_array___pyx_pf_15View_dot_MemoryView_5array_8__getattr__(), __pyx_array___setitem__(), __Pyx_GetAttr(), __Pyx_GetAttr3(), __Pyx_GetAttr3Default(), __pyx_getprop___pyx_array_memview() (+48 more)
...
Cohesion: 0.07
Nodes (28): AnthropicBackend, HFLocalBackend, make_backend(), OpenAICompatBackend, Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, Claude models via the Anthropic SDK.     pip install anthropic      model exampl, Loads a HuggingFace model locally via transformers.      model_path: HF model ID, target shortcuts for frontier providers (format: <provider>:<model>):       open (+20 more)
...
Cohesion: 0.09
Nodes (49): _embed(), _ensure_hnsw_index(), _ensure_tables(), _entry_to_dict(), _get_embedder(), memory_add(), memory_flag(), memory_promote() (+41 more)
...
Cohesion: 0.07
Nodes (31): Base, Message, get_recent_messages(), prune_session_messages(), Delete oldest messages in ``session_id`` while the row count exceeds ``max_messa, store_message(), Message, WebSocket (+23 more)

### Community 21 - "Model Training Data"
Cohesion: 0.05
Nodes (22): _extract_answer(), _normalize(), Pull the final numeric answer out of a model response., _extract(), _normalize(), MATH — Competition Math Benchmark Dataset: TIGER-Lab/MATH-plus (train split, cap, Light normalization: strip whitespace, LaTeX commas, dollar signs., BenchmarkResult (+14 more)

### Community 22 - "TTS Voice Subsystem"
Cohesion: 0.08
Nodes (40): bool, device, int, object, str, str, Tests for model_training/titanProject/prompt_formats.py — prompt rendering and e, If ### Response: is missing, the function should not raise ValueError. (+32 more)
...
Cohesion: 0.08
Nodes (21): Tests for model.py: model factory, forward pass shapes, config validation., ModelConfig dataclass defaults and construction., HFGPT2LM forward pass shape checks., Sanity check that model parameter counts scale as expected., build_model factory function., GPTLM forward pass shape and behavior checks., TestBuildModel, TestGPTLMForward (+13 more)
...
Cohesion: 0.08
Nodes (27): AsyncMock, recall_recent_messages(), remember_message(), float, int, str, _make_mock_ws(), Extended tests for chat WebSocket endpoint — covers DAG deep search integration, (+19 more)

### Community 32 - "Module Cluster 32"
Cohesion: 0.10
Nodes (39): abs_py_ssize_t(), __Pyx_div_long(), __pyx_f_11piper_train_4vits_15monotonic_align_4core_maximum_path_c(), __pyx_f_11piper_train_4vits_15monotonic_align_4core_maximum_path_each(), __pyx_fatalerror(), __pyx_get_array_memory_extents(), __pyx_get_best_slice_order(), __Pyx_INC_MEMVIEW() (+31 more)
...
Cohesion: 0.14
Nodes (16): Batch, LongTensor, bool, float, int, Path, str, Batch (+8 more)
...
Cohesion: 0.10
Nodes (20): bool, float, int, Path, str, Tests for training utilities: LR schedules, path resolution, hashing, checkpoint, TokenizerAdapter encode/decode contract., S3 tokenizer downloads must not collide when only the basename matches. (+12 more)
...
Cohesion: 0.11
Nodes (24): bool, str, WebSocket, object, str, Wave_write, _make_mock_ws(), Lifecycle / resource-leak tests inspired by daimonos memory-leak prevention rule (+16 more)
...
Cohesion: 0.09
Nodes (18): Any, MagicMock, str, Unit tests for WebSocket functionality., Test chat endpoint with empty message., Test chat endpoint with invalid JSON., Test cases for WebSocket connection manager., Test chat endpoint exception handling. (+10 more)
...
Cohesion: 0.10
Nodes (16): ABC, ARC Challenge — AI2 Reasoning Challenge (hard subset) Dataset: allenai/ARC (ARC-, Base class all benchmark adapters inherit from., GPQA Diamond — Graduate-level Google-Proof Q&A Dataset: google-deepmind/gpqa (gp, GSM8K — Grade School Math Dataset: openai/gsm8k Metric:  accuracy (exact final n, LoCoMo — Long-Context Conversation Memory Dataset: snap-research/LoCoMo Metric:, MBPP — Mostly Basic Python Problems Dataset: google-research-datasets/mbpp (sani, MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac (+8 more)
...
Cohesion: 0.08
Nodes (23): Shared fixtures for titanProject tests., Any, async_session(), mock_piper_voice(), Create a small on-disk token cache with 3 shards for testing., Create a temporary audio file for testing., Sample text for testing., Sample phonemes for testing. (+15 more)
...
Cohesion: 0.07
Nodes (27): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, files, md5_digest (+19 more)
...
Cohesion: 0.09
Nodes (23): mcp_memory, default_db_url, embed_model, port, mcp_servers, map_echo_port, map_list_port, postgres_default_url (+15 more)
...
Cohesion: 0.14
Nodes (11): fused_add_tanh_sigmoid_multiply(), init_weights(), ConvFlow, ElementwiseAffine, ResBlock2, ResidualCouplingLayer, WN, piecewise_rational_quadratic_transform() (+3 more)
...
Cohesion: 0.11
Nodes (19): md5_digest, size_bytes, size_bytes, md5_digest, size_bytes, files, md5_digest, size_bytes (+11 more)
...
Cohesion: 0.13
Nodes (17): AbstractEventLoop, MagicMock, TestClient, Pytest configuration and fixtures for talkingHead backend tests., client(), event_loop(), mock_chat_processor(), mock_httpx_client() (+9 more)
...
Cohesion: 0.11
Nodes (18): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, ca_ES-upc_pau-x_low, aliases (+10 more)
...
Cohesion: 0.17
Nodes (18): allow_http, max_assistant_chars, oasst_best_only, oasst_max_fails_task, oasst_max_spam, oasst_min_helpfulness, filters, max_digit_ratio (+10 more)
...
Cohesion: 0.12
Nodes (17): codereview, paths, scheme, batch, health, review, talkingHead, port (+9 more)
...
Cohesion: 0.15
Nodes (17): __pyx_align_pointer(), __Pyx__ArgTypeTest(), __Pyx_InBases(), __Pyx_IsSubtype(), __pyx_memoryview___cinit__(), __pyx_memoryview___pyx_pf_15View_dot_MemoryView_10memoryview___cinit__(), __pyx_MemviewEnum___init__(), __pyx_MemviewEnum___pyx_pf_15View_dot_MemoryView_4Enum___init__() (+9 more)
...
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, el_GR-rapunzelina-low, aliases (+9 more)
...
Cohesion: 0.16
Nodes (13): int, add_timing_signal_1d(), cat_timing_signal_1d(), generate_path(), get_timing_signal_1d(), rand_gumbel(), rand_gumbel_like(), rand_slice_segments() (+5 more)

### Community 123 - "Module Cluster 123"
Cohesion: 0.22
Nodes (7): float, int, get_padding(), ConvReluNorm, DDSConv, Dialted and Depth-Separable Convolution, ResBlock1
...
Cohesion: 0.12
Nodes (15): arith_stabilizer_train_added, base_train, train_total, val_copied_from, val_total, base_val, hf_added, hf_categories (+7 more)

### Community 131 - "Module Cluster 131"
Cohesion: 0.12
Nodes (15): ca_ES-upc_ona-medium, aliases, key, name, num_speakers, quality, speaker_id_map, amused (+7 more)
...
Cohesion: 0.14
Nodes (13): self_intro_train_added, base_train, base_train, microstory_train_added, source, train_total, val_total, arith_stabilizer_train_added (+5 more)
...
Cohesion: 0.25
Nodes (14): bool, int, Run pytest with the given pattern., run_integration_tests(), run_specific_test(), run_unit_tests(), Run integration tests only., Run a specific test file. (+6 more)
...
Cohesion: 0.23
Nodes (6): MultiHeadAttention, x: decoder input         h: encoder output, x: [b, h, l, m]         y: [h or 1, m, d]         ret: [b, h, l, d], x: [b, h, l, 2*l-1]         ret: [b, h, l, l], x: [b, h, l, l]         ret: [b, h, l, 2*l-1], Bias for self-attention to encourage attention to close positions.         Args:
...
Cohesion: 0.20
Nodes (8): Trivial tokenizer that maps each character to its ordinal., str, dummy_tokenizer(), DummyTokenizer, Sample message data for WebSocket tests., Create a temporary SQLite database for testing., sample_message_data(), test_db()
...
Cohesion: 0.18
Nodes (11): logic_train_used, oasst_val_used, openhermes_train_used, openhermes_val_used, slimorca_train_used, train_total, val_total, counts (+3 more)
...
Cohesion: 0.29
Nodes (6): Dataset, evaluate(), main(), make_seq(), Stage-A associative-recall go/no-go on the TRUSTED backend (lucidrains/titans-py, RecallSeqs
...
Cohesion: 0.25
Nodes (7): base_train, curated_train_added, curated_val_added, val_total, train_total, source, base_val

### Community 204 - "Module Cluster 204"
Cohesion: 0.25
Nodes (7): val_total, base_train, base_val, source, story_train_added, story_val_added, train_total
...
Cohesion: 0.38
Nodes (5): train, seed, output_format, paths, val
...
Cohesion: 0.40
Nodes (5): bytes, Create a sample audio file for testing voice upload., Create sample audio data for testing., sample_audio_data(), sample_audio_file()
...
- **Why does `AsyncMock` connect `Module Cluster 31` to `HuggingFace Model Utilities`, `DAG Query Retrieval`, `Module Cluster 46`, `Module Cluster 48`, `Module Cluster 82`, `SQL Agent & Test Harness`, `Module Cluster 54`, `Eval Benchmark Adapters`, `Module Cluster 89`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 38` to `Module Cluster 39`, `Freud Memory Auditor`, `Piper TTS Tests`, `Module Cluster 43`, `talkingHead FastAPI Backend`, `PostgreSQL MCP Server`, `Module Cluster 116`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `VoiceNotFoundError` connect `Module Cluster 118` to `Module Cluster 28`?**
