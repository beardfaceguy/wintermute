...
class ChineseCLIPProcessor(ProcessorMixin):
    ...
    def __call__(self, text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = ..., images: ImageInput = ..., audio=..., videos=..., **kwargs: Unpack[ChineseClipProcessorKwargs]) -> BatchEncoding:
        """
    ...
    @property
    def feature_extractor_class(self): # -> tuple[Literal['ChineseCLIPImageProcessor'], Literal['ChineseCLIPImageProcessorFast']]:
        ...
