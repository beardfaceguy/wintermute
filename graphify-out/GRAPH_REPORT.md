...
## Summary
- 5365 nodes · 9944 edges · 348 communities (288 shown, 60 thin omitted)
...
## Communities (348 total, 60 thin omitted)
...
Cohesion: 0.05
Nodes (31): ABC, ARC Challenge — AI2 Reasoning Challenge (hard subset) Dataset: allenai/ARC (ARC-, Base class all benchmark adapters inherit from., GPQA Diamond — Graduate-level Google-Proof Q&A Dataset: google-deepmind/gpqa (gp, LoCoMo — Long-Context Conversation Memory Dataset: snap-research/LoCoMo Metric:, MMLU — Massive Multitask Language Understanding Dataset: cais/mmlu on HuggingFac, OR-Bench — Over-Refusal Benchmark Dataset: bench-llm/or-bench Metric:  complianc, SWE-bench Verified Dataset: princeton-nlp/SWE-bench_Verified Metric:  resolve_ra (+23 more)

### Community 6 - "Cython C Extensions"
Cohesion: 0.06
Nodes (32): bool, float, int, Path, str, Path, _download_s3_head(), _load_tokenizer() (+24 more)

### Community 7 - "Freud Memory Auditor"
Cohesion: 0.05
Nodes (64): ca_ES-upc_ona-medium, aliases, key, language, name, num_speakers, quality, speaker_id_map (+56 more)
...
Cohesion: 0.07
Nodes (28): Model backend abstraction for the eval harness.  Backends:   - OpenAICompatBacke, bool, Path, Module, Tests for model.py: model factory, forward pass shapes, config validation., ModelConfig dataclass defaults and construction., HFGPT2LM forward pass shape checks., Sanity check that model parameter counts scale as expected. (+20 more)
...
Cohesion: 0.08
Nodes (33): bool, device, float, int, Path, str, setup_distributed() fallback behavior without torchrun., cleanup should not raise when no process group is initialized. (+25 more)
...
Cohesion: 0.07
Nodes (23): HumanEval Dataset: openai_humaneval Metric:  pass@1 (fraction of problems where, _build_test(), LiveCodeBench — Code Generation (Lite) Dataset: livecodebench/code_generation_li, Build a simple assertion block from public test cases., MBPP — Mostly Basic Python Problems Dataset: google-research-datasets/mbpp (sani, BenchmarkResult, GenerateConfig, ModelBackend (+15 more)
...
Cohesion: 0.11
Nodes (15): DistributedSampler, DataLoader, int, str, TestBuildSFTDataloader, build_sft_dataloader(), cycle_batches(), _get_boundary_tokens() (+7 more)
...
Cohesion: 0.08
Nodes (26): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, num_speakers, de_DE-thorsten_emotional-medium (+18 more)
...
Cohesion: 0.12
Nodes (14): _parse_answer(), subjects:         list of MMLU subject names, or None for all 57         max_per, BenchmarkResult, GenerateConfig, int, ModelBackend, str, main() (+6 more)
...
Cohesion: 0.16
Nodes (18): cache_norm_audio(), # NOTE: audio is already in [-1, 1] coming from librosa, Returns the offset/duration of trimmed audio in seconds, trim_silence(), Detects speech/silence using Silero VAD.      https://github.com/snakers4/silero, SileroVoiceActivityDetector, bool, float (+10 more)

### Community 78 - "Module Cluster 78"
Cohesion: 0.12
Nodes (12): fused_add_tanh_sigmoid_multiply(), init_weights(), ConvFlow, ConvReluNorm, ElementwiseAffine, ResBlock1, ResBlock2, ResidualCouplingLayer (+4 more)
...
Cohesion: 0.10
Nodes (20): base_train, base_train_path, base_val_path, hf_added, hf_categories, hf_dataset_id, hf_slice_path, hf_split (+12 more)
...
Cohesion: 0.12
Nodes (17): arith_stabilizer_train_added, base_train, source, val_copied_from, val_total, arith_stabilizer_train_added, base_train, microstory_train_added (+9 more)
...
Cohesion: 0.22
Nodes (16): JoinableQueue, make_silence_detector(), batched(), get_text_casing(), ljspeech_dataset(), main(), mycroft_dataset(), PathEncoder (+8 more)

### Community 95 - "Module Cluster 95"
Cohesion: 0.13
Nodes (16): filters, max_assistant_chars, oasst_best_only, oasst_max_spam, oasst_min_helpfulness, reject_role_markers, seed, allow_http (+8 more)
...
Cohesion: 0.12
Nodes (18): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, files, md5_digest (+10 more)
...
Cohesion: 0.12
Nodes (17): isolate_config_cache(), mock_embed(), mock_embed_unique(), Root-level conftest.py for the Wintermute platform test suite.  Provides shared, Create a temporary audio file for testing., Sample phonemes for testing., Reset the shared config cache between tests so mutations don't leak., Write a minimal shared_api_config.json and patch config_loader to use it. (+9 more)
...
Cohesion: 0.12
Nodes (17): agents, default_llm_port, default_model, max_iterations, dag_retrieval, llm_timeout, temperature, frequency_penalty (+9 more)
...
Cohesion: 0.12
Nodes (17): md5_digest, size_bytes, md5_digest, size_bytes, md5_digest, size_bytes, en_GB-alan-low, files (+9 more)
...
Cohesion: 0.16
Nodes (14): TestClient, Pytest configuration and fixtures for talkingHead backend tests., client(), mock_chat_processor(), mock_httpx_client(), mock_websocket(), Mock the ChatProcessor for LLM tests., Mock httpx client for LLM API calls. (+6 more)

### Community 134 - "Module Cluster 134"
Cohesion: 0.25
Nodes (14): bool, main(), Run pytest with the given pattern., run_specific_test(), run_tests(), Run integration tests only., Run a specific test file., Main function to run tests based on command line arguments. (+6 more)
...
Cohesion: 0.15
Nodes (13): counts, logic_train_used, logic_val_used, oasst_val_used, openhermes_train_used, slimorca_val_used, train_total, val_total (+5 more)
...
Cohesion: 0.18
Nodes (12): codereview, host, paths, port, batch, health, review, talkingHead (+4 more)
...
Cohesion: 0.23
Nodes (8): Dataset, cycle(), evaluate(), LMWindows, load_tinystories_ids(), main(), Pretrain a small MAC-Titan on TinyStories using the ADOPTED backend lucidrains/t, Full-length (seq+1) contiguous windows; lucidrains shifts labels internally.
...
Cohesion: 0.20
Nodes (5): Shared fixtures for titanProject tests., Create a small on-disk token cache with 3 shards for testing., Create a small text file with known content for dataset tests., small_text_file(), token_cache_dir()

### Community 177 - "Module Cluster 177"
Cohesion: 0.24
Nodes (6): str, Trivial tokenizer that maps each character to its ordinal., dummy_tokenizer(), DummyTokenizer, Sample text for testing., sample_text()
...
Cohesion: 0.25
Nodes (7): de_DE-thorsten-low, aliases, key, name, num_speakers, quality, speaker_id_map
...
Cohesion: 0.29
Nodes (7): str, async_session(), Sample message data for WebSocket tests., Create a temporary SQLite database for testing., Create an async database session bound to the temp test DB.      The module-leve, sample_message_data(), test_db()
...
Cohesion: 0.40
Nodes (5): Any, mock_piper_voice(), Mock PiperVoice for testing., sample_piper_config(), Sample Piper configuration for testing.
...
Cohesion: 0.67
Nodes (3): AbstractEventLoop, event_loop(), Create an instance of the default event loop for the test session.
...
- **Why does `PiperVoice` connect `Module Cluster 73` to `Module Cluster 128`, `Module Cluster 68`, `Module Cluster 133`, `Module Cluster 234`, `Module Cluster 139`, `Module Cluster 235`, `Module Cluster 108`, `Module Cluster 177`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `AsyncMock` connect `Module Cluster 28` to `Module Cluster 32`, `Module Cluster 33`, `Module Cluster 161`, `Module Cluster 133`, `Module Cluster 37`, `Module Cluster 83`, `Module Cluster 52`, `TTS Voice Subsystem`, `Module Cluster 26`, `Module Cluster 61`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `datetime` connect `Module Cluster 39` to `Module Cluster 40`, `Module Cluster 44`, `PostgreSQL MCP Server`, `SQL Agent & Test Harness`, `Model Training Data`, `Module Cluster 118`, `talkingHead WebSocket & TTS`?**
