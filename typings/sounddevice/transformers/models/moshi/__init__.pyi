...
class MoshiDepthDecoder(MoshiPreTrainedModel, GenerationMixin):
    ...
    def forward(self, input_ids: Optional[torch.LongTensor] = ..., last_hidden_state: Optional[torch.LongTensor] = ..., attention_mask: Optional[torch.BoolTensor] = ..., past_key_values: Optional[Tuple[Tuple[torch.FloatTensor]]] = ..., inputs_embeds: Optional[torch.FloatTensor] = ..., use_cache: Optional[bool] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., position_ids: Optional[torch.LongTensor] = ..., labels: Optional[torch.LongTensor] = ..., cache_position: Optional[torch.LongTensor] = ...) -> Union[Tuple, BaseModelOutputWithPast]:
        """
        Args:
...
class MoshiForCausalLM(MoshiPreTrainedModel, GenerationMixin):
    ...
    @auto_docstring
    def forward(self, input_ids: Optional[torch.LongTensor] = ..., attention_mask: Optional[torch.Tensor] = ..., position_ids: Optional[torch.LongTensor] = ..., past_key_values: Optional[Union[Cache, List[torch.FloatTensor]]] = ..., inputs_embeds: Optional[torch.FloatTensor] = ..., use_cache: Optional[bool] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., cache_position: Optional[torch.LongTensor] = ..., labels: Optional[torch.LongTensor] = ..., logits_to_keep: Union[int, torch.Tensor] = ..., **kwargs) -> Union[Tuple, MoshiCausalLMOutputWithPast]:
        r"""
        labels (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*):
            Labels for computing the masked language modeling loss. Indices should either be in `[0, ...,
            config.vocab_size]` or -100 (see `input_ids` docstring). Tokens with indices set to `-100` are ignored
...
class MoshiForConditionalGeneration(MoshiPreTrainedModel, GenerationMixin):
    ...
    def prepare_inputs_for_generation(self, input_ids, past_key_values=..., attention_mask=..., inputs_embeds=..., cache_position=..., position_ids=..., use_cache=..., logits_to_keep=..., user_delay_pattern_mask=..., moshi_delay_pattern_mask=..., kwargs_depth_decoder=..., blank_user_audio_codes: Optional[torch.FloatTensor] = ..., **kwargs): # -> dict[str, Any]:
        ...
    ...
    def build_delay_pattern_mask(self, input_ids: torch.LongTensor, bos_token_id: int, pad_token_id: int, max_length: Optional[int] = ...): # -> tuple[LongTensor, Tensor]:
