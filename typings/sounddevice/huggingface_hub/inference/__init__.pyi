...
import numpy as np
from huggingface_hub.inference._common import ContentT, ModelStatus
...
class InferenceClient:
    ...
    def audio_to_audio(
        self, audio: ContentT, *, model: str | None = ...
    ...
    def tabular_classification(
        self, table: dict[str, Any], *, model: str | None = ...
    ) -> list[str]:
        """
    ...
    def text_generation(
        ...
        *,
        ...
        typical_p: float | None = ...,
        watermark: bool | None = ...,
    ) -> TextGenerationOutput | Iterable[TextGenerationStreamOutput]: ...
    def text_generation(
        self,
        prompt: str,
        *,
    ...
    @_deprecate_method(
        version="0.33.0",
        message="HF Inference API is getting revamped and will only support warm models in the future (no cold start allowed)."
        " Use `HfApi.list_models(..., inference_provider='...')` to list warm models per provider.",
    )
    def list_deployed_models(
        self, frameworks: None | str | Literal["all"] | list[str] = ...
    ) -> dict[str, list[str]]:
        """
    ...
    def get_model_status(self, model: str | None = ...) -> ModelStatus:
        """
