...
from ..clip.modeling_clip import CLIPAttention, CLIPEncoder, CLIPEncoderLayer, CLIPMLP, CLIPVisionEmbeddings, CLIPVisionModel, CLIPVisionTransformer
...
class MLCDVisionConfig(PretrainedConfig):
    ...
    model_type = ...
    base_config_key = ...
    def __init__(self, hidden_size=..., intermediate_size=..., num_hidden_layers=..., num_attention_heads=..., num_key_value_groups=..., num_channels=..., image_size=..., patch_size=..., hidden_act=..., layer_norm_eps=..., attention_dropout=..., initializer_range=..., initializer_factor=..., **kwargs) -> None:
        ...
...
class MLCDAttention(CLIPAttention):
    ...
    def forward(self, hidden_states: torch.Tensor, position_embeddings: Tuple[torch.Tensor, torch.Tensor], attention_mask: Optional[torch.Tensor] = ..., **kwargs: Unpack[FlashAttentionKwargs]) -> Tuple[torch.Tensor, Optional[torch.Tensor]]:
        ...
...
class MLCDEncoderLayer(CLIPEncoderLayer):
    ...
    def forward(self, hidden_states: torch.Tensor, position_embeddings: Tuple[torch.Tensor, torch.Tensor], attention_mask: Optional[torch.Tensor] = ..., output_attentions: Optional[bool] = ...) -> Tuple[torch.FloatTensor]:
        """
        Args:
...
class MLCDEncoder(CLIPEncoder):
    ...
    def forward(self, inputs_embeds: torch.FloatTensor, position_embeddings: Tuple[torch.Tensor, torch.Tensor], attention_mask: Optional[torch.Tensor] = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...) -> Union[Tuple, BaseModelOutput]:
        r"""
        Args:
