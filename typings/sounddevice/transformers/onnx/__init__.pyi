...
if not is_torch_available() and not is_tf_available():
    ...
def supported_features_mapping(*supported_features: str, onnx_config_cls: Optional[str] = ...) -> Dict[str, Callable[[PretrainedConfig], OnnxConfig]]:
    """
...
class FeaturesManager:
    ...
    @staticmethod
    def get_model_from_feature(feature: str, model: str, framework: Optional[str] = ..., cache_dir: Optional[str] = ...) -> Union[PreTrainedModel, TFPreTrainedModel]:
        """
