...
class FlaxBeitPreTrainedModel(FlaxPreTrainedModel):
    ...
    def __call__(self, pixel_values, bool_masked_pos=..., params: Optional[dict] = ..., dropout_rng: jax.random.PRNGKey = ..., train: bool = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ...):
        ...
...
__all__ = ["FlaxBeitForImageClassification", "FlaxBeitForMaskedImageModeling", "FlaxBeitModel", "FlaxBeitPreTrainedModel"]
